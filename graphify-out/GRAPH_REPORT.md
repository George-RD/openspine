...
## Corpus Check
- 214 files · ~148,410 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2627 nodes · 4428 edges · 291 communities (259 shown, 32 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 584 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f89eb2cf`
...
Cohesion: 0.12
Nodes (27): refuses_external_communication_without_containment(), AccountRole, ActorHint, Connector, EventEnvelope, EventType, InteractionMode, Lane (+19 more)

### Community 3 - "handle_owner_update"
Cohesion: 0.18
Nodes (24): dispatch_artifact_propose(), Option, Result, Value, artifact_propose_persists_and_sends_approval_button(), artifact_propose_rejects_duplicate_id_version(), artifact_propose_rejects_malformed_yaml(), artifact_propose_rejects_non_proposed_lifecycle() (+16 more)

### Community 4 - ".default"
Cohesion: 0.06
Nodes (66): AuditMeta, gate(), GateContext, GateOutcome, resolve(), resolve_approval_required(), Option, Timestamp (+58 more)
...
Cohesion: 0.09
Nodes (26): Bot, build_owner_envelope(), CallbackQueryUpdate, configured_owner_text_message_is_verified(), missing_sender_is_ignored(), non_text_update_from_owner_is_ignored(), owner_envelope_is_verified_with_owner_id_match_method(), owner_message_in_a_group_chat_is_ignored_not_routed() (+18 more)
...
Cohesion: 0.11
Nodes (16): canonical_catalog(), id(), action_id_qualifier_is_part_of_identity(), action_id_serializes_as_bare_string(), ActionCatalog, ActionId, DenialReason, Display (+8 more)
...
Cohesion: 0.15
Nodes (20): Result, run_benchmarks(), activate_approved_artifact(), create_approved_draft(), handle_draft_approval_callback(), Result, Ulid, AppState (+12 more)
...
Cohesion: 0.30
Nodes (35): artifact_ref(), email_event(), email_reply_drafter_agent(), email_route(), empty_session_policy(), global_policy(), main_assistant_agent(), owner_control_basic_pack() (+27 more)
...
Cohesion: 0.20
Nodes (10): Connection, Mutex, Option, Path, Result, String, Ulid, Vec (+2 more)
...
Cohesion: 0.18
Nodes (12): try_count_model_call_allows_exactly_one_concurrent_winner_at_max_one(), canonical_json(), CanonicalValue, digest_from_hash(), digest_of(), digest_of_bytes(), digest_of_bytes_hashes_raw_content_directly(), digest_of_is_a_pinned_golden_value() (+4 more)

### Community 46 - "Digest"
Cohesion: 0.11
Nodes (21): get_task(), Arc, HeaderMap, Json, Result, State, StatusCode, String (+13 more)
...
Cohesion: 0.11
Nodes (21): empty_session_policy(), handle_thread_selection(), Option, Result, Self, actor_hint_defaults_to_all_none(), DataClassification, allow_and_deny_lists_never_overlap_in_the_fixture() (+13 more)
...
Cohesion: 0.26
Nodes (10): lyra_ui_preview_sends_telegram_reply_to_grant_bound_chat(), lyra_ui_preview_truncates_long_body_to_utf16_limit(), truncated_preview_carries_no_approval_button_and_persists_no_action_request(), build_state(), repo_lyra_dir(), GmailConnector, Option, PathBuf (+2 more)
...
Cohesion: 0.12
Nodes (18): genesis_digest(), AuditEvent, genesis_hash(), round_trips_through_serde(), Option, String, Timestamp, Ulid (+10 more)
...
Cohesion: 0.23
Nodes (11): effect_defaults_to_allow_when_omitted(), owner_route(), round_trips_through_serde(), Route, route_can_be_a_deny_route(), RouteActorWhen, RouteEffect, RouteResolution (+3 more)
...
## Knowledge Gaps
- **1001 isolated node(s):** `autoresearch.sh script`, `name`, `private`, `@fission-ai/openspec`, `check-claims.sh script` (+996 more)
...
- **Why does `AppState` connect `AppState` to `ConnectorRegistry`, `handle_owner_update`, `artifact_propose.rs`, `.with_api_url`, `artifact_loader.rs`, `mod.rs`, `.put`, `add_column_if_missing`, `Delegation & containment`, `actions.rs`, `Digest`, `mod.rs`, `post_action`, `ActionId`, `AppState`, `.default`, `AuditMeta`, `AuditEvent`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `ArtifactRef` connect `ArtifactRef` to `event.rs`, `artifact_activation_tests.rs`, `.default`, `identity.rs`, `telegram.rs`, `.put`, `ProposedArtifact`, `Delegation & containment`, `ActionId`, `owner_event`, `Lifecycle`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `Route` connect `route.rs` to `compose_authority`, `event.rs`, `artifact_loader.rs`, `ProposedArtifact`, `owner_event`, `Lifecycle`?**

# Graph Report - openspine-wt129  (2026-08-14)

## Corpus Check
- 842 files · ~738,918 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12371 nodes · 19299 edges · 2158 communities (871 shown, 1287 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 2147 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `01b6c5d8`
...
2. `StoreError` - 202 edges
3. `OwnerSurfaceRef` - 153 edges
4. `TaskGrant` - 152 edges
5. `test_state()` - 133 edges
6. `Timestamp` - 118 edges
7. `handle_owner_update()` - 111 edges
8. `ActionId` - 105 edges
9. `owner_update()` - 98 edges
10. `test_state_with_telegram()` - 97 edges
...
- `format2_recovered_blob_reads_and_migrates_to_format3()` --calls--> `digest_of_bytes()`  [INFERRED]
  crates/openspine-kernel/src/artifact_store_format_tests.rs → crates/openspine-schemas/src/digest.rs
- `format2_post_rename_sync_failure_recovers_once_without_syncing_steady_state_reads()` --calls--> `digest_of_bytes()`  [INFERRED]
  crates/openspine-kernel/src/artifact_store_format_tests.rs → crates/openspine-schemas/src/digest.rs
- `clear_upgrade_pending_sync_failure_retains_marker_for_retry()` --calls--> `digest_of_bytes()`  [INFERRED]
  crates/openspine-kernel/src/artifact_store_format_tests.rs → crates/openspine-schemas/src/digest.rs
- `legacy_blobs_migrate_under_system_scope()` --calls--> `digest_of_bytes()`  [INFERRED]
  crates/openspine-kernel/src/artifact_store_migration_tests.rs → crates/openspine-schemas/src/digest.rs

## Import Cycles
- 2-file cycle: `crates/openspine-kernel/src/store/owner_review.rs -> crates/openspine-kernel/src/store/owner_review_schema.rs -> crates/openspine-kernel/src/store/owner_review.rs`
...
- 2-file cycle: `crates/openspine-kernel/src/pipeline/mod.rs -> crates/openspine-kernel/src/pipeline/timer_dispatch.rs -> crates/openspine-kernel/src/pipeline/mod.rs`
- 2-file cycle: `crates/openspine-kernel/src/pipeline/lanes.rs -> crates/openspine-kernel/src/pipeline/mod.rs -> crates/openspine-kernel/src/pipeline/lanes.rs`
- 2-file cycle: `crates/openspine-kernel/src/pipeline/message_notify.rs -> crates/openspine-kernel/src/pipeline/mod.rs -> crates/openspine-kernel/src/pipeline/message_notify.rs`
...
- 3-file cycle: `crates/openspine-kernel/src/pipeline/lanes.rs -> crates/openspine-kernel/src/pipeline/mod.rs -> crates/openspine-kernel/src/pipeline/timer_dispatch.rs -> crates/openspine-kernel/src/pipeline/lanes.rs`
- 3-file cycle: `crates/openspine-kernel/src/pipeline/lanes.rs -> crates/openspine-kernel/src/workflow.rs -> crates/openspine-kernel/src/pipeline/mod.rs -> crates/openspine-kernel/src/pipeline/lanes.rs`
...
- 4-file cycle: `crates/openspine-kernel/src/pipeline/lanes.rs -> crates/openspine-kernel/src/telegram.rs -> crates/openspine-kernel/src/workflow.rs -> crates/openspine-kernel/src/pipeline/mod.rs -> crates/openspine-kernel/src/pipeline/lanes.rs`
- 4-file cycle: `crates/openspine-kernel/src/pipeline/lanes.rs -> crates/openspine-kernel/src/workflow.rs -> crates/openspine-kernel/src/pipeline/mod.rs -> crates/openspine-kernel/src/pipeline/timer_dispatch.rs -> crates/openspine-kernel/src/pipeline/lanes.rs`
- 4-file cycle: `crates/openspine-kernel/src/api/actions.rs -> crates/openspine-kernel/src/pipeline/mod.rs -> crates/openspine-kernel/src/pipeline/lanes.rs -> crates/openspine-kernel/src/workflow.rs -> crates/openspine-kernel/src/api/actions.rs`
...
- 5-file cycle: `crates/openspine-kernel/src/api/actions.rs -> crates/openspine-kernel/src/pipeline/mod.rs -> crates/openspine-kernel/src/pipeline/lanes.rs -> crates/openspine-kernel/src/telegram.rs -> crates/openspine-kernel/src/workflow.rs -> crates/openspine-kernel/src/api/actions.rs`
- 5-file cycle: `crates/openspine-kernel/src/pipeline/lanes.rs -> crates/openspine-kernel/src/telegram.rs -> crates/openspine-kernel/src/workflow.rs -> crates/openspine-kernel/src/pipeline/mod.rs -> crates/openspine-kernel/src/pipeline/timer_dispatch.rs -> crates/openspine-kernel/src/pipeline/lanes.rs`
- 5-file cycle: `crates/openspine-kernel/src/api/actions.rs -> crates/openspine-kernel/src/pipeline/mod.rs -> crates/openspine-kernel/src/pipeline/timer_dispatch.rs -> crates/openspine-kernel/src/pipeline/lanes.rs -> crates/openspine-kernel/src/workflow.rs -> crates/openspine-kernel/src/api/actions.rs`

## Communities (2158 total, 1287 thin omitted)
...
### Community 1 - ".new"
Cohesion: 0.20
Nodes (19): digest_axis_stale(), ensure_schema(), epoch_nanos_to_timestamp(), EvalVerdict, insert_eval_verdict_conn(), map_row(), read_eval_row(), read_u32_col() (+11 more)

### Community 2 - "event.rs"
Cohesion: 0.20
Nodes (17): choose_provider(), complete_login(), ensure_codex_identity(), headless(), login_flow(), open_in_browser(), provider_entry(), run_provider_login() (+9 more)
...
### Community 4 - ".default"
Cohesion: 0.17
Nodes (10): parse_owner_surface(), ArtifactRef, Option, Result, String, Ulid, Store, DarkWindowSchedule (+2 more)

### Community 5 - "GmailConnector"
Cohesion: 0.07
Nodes (35): a_bound_listener_address_names_the_configuration_key(), a_held_data_root_lock_names_the_running_instance(), a_startup_failure_lists_every_blocking_check_not_only_the_first_remedy(), absent_key_material_names_the_variable_and_the_env_file(), an_absent_configuration_file_points_at_setup(), config_path(), config_remedy(), failure_report() (+27 more)

### Community 6 - "artifact_loader.rs"
Cohesion: 0.19
Nodes (18): batch_failure(), test_state_with_telegram(), connector_failure_batches_and_is_audited(), immediate_failure_cannot_enter_digest_lane(), digest_detail_corrupt_blob_surfaces_resource_without_leak(), digest_detail_immediate_success_outcome_audit_failure_is_delivery_unknown_and_no_retry(), digest_detail_missing_blob_surfaces_resource_without_leak(), digest_detail_not_found_is_truthful() (+10 more)

### Community 7 - "config.rs"
Cohesion: 0.06
Nodes (49): audit_count(), open_pending_count(), timer_count(), resolve_text(), retry_backoff(), retry_due_notifications(), Duration, Result (+41 more)

### Community 8 - "mod.rs"
Cohesion: 0.04
Nodes (47): Purpose, Requirement: A mutated approved plan MUST be refused at the gate, Requirement: Approval audit MUST avoid plaintext private payloads, Requirement: Approval MUST bind only what the owner was shown, Requirement: Approvals MUST expire, Requirement: Draft creation MUST remain approval-required, Requirement: Draft creation MUST require digest-bound approval, Requirement: Final email send MUST remain denied (+39 more)
...
### Community 10 - ".put"
Cohesion: 0.09
Nodes (46): mediate_and_dispatch_action(), suppressed_schedules_consume_no_budget(), varying_the_payload_cannot_amplify_owner_silence(), email_read_selected_thread_rejects_expired_token(), email_read_selected_thread_rejects_foreign_grant(), email_read_selected_thread_rejects_malformed_payload(), email_read_selected_thread_rejects_second_use(), email_read_selected_thread_returns_thread_via_mocked_gmail() (+38 more)

### Community 11 - "ProposedArtifact"
Cohesion: 0.10
Nodes (50): emit_preflight_failure(), Result, headless_build_envelope(), headless_grant_binding(), headless_preflight(), headless_route_guard(), HeadlessHookOutcome, ArtifactRef (+42 more)

### Community 12 - "client.rs"
Cohesion: 0.06
Nodes (5): scoped_rule_matches(), TargetRefKind, ResolvedActionContext, ResolvedActionContextError, target_kind_rank()

### Community 13 - "policy.rs"
Cohesion: 0.15
Nodes (20): dispatch_skill_context(), skill_context_rejects_unknown_grant_purpose(), skill_context_selects_only_grant_scoped_installed_matches(), task_class_from_grant_purpose(), CeremonyToken, oversized_skill_id_is_rejected_before_preview_rendering(), promotion_refuses_when_higher_installed_exists(), promotion_retires_lower_installed_version_atomically() (+12 more)

### Community 14 - "actions.rs"
Cohesion: 0.10
Nodes (40): adding_thread_binding_without_resealing_invalidates_mac(), caveat_reorder_or_remove_invalidates_mac(), child_derives_from_parent_tip_without_root_key(), effective_egress_class_intersects_every_caveat(), egress_class_tamper_invalidates_root_mac(), gate_specific_caveats_are_explicitly_supported_only_by_upgraded_verifier(), id_parent_and_action_list_tamper_fail(), identity_field_tamper_invalidates_mac() (+32 more)

### Community 15 - "ADDED Requirements"
Cohesion: 0.13
Nodes (17): build_raw_reply_message(), extract_body_text(), header_value(), parse_thread(), bounded_json_response(), CachedToken, GmailConnector, extract_email_address() (+9 more)

### Community 16 - "Requirements"
Cohesion: 0.07
Nodes (47): ApprovalStepInputs, ArtifactRef, bool, Digest, digest_inputs(), EntryBindingInputs, EntryTransitionInputs, GatedDepartureInputs (+39 more)

### Community 17 - "content.d.ts"
Cohesion: 0.12
Nodes (22): binding_matches_rejects_a_different_provenance_set(), binding_matches_rejects_a_different_requesting_grant(), carve_out_extends_covered_egress_without_new_policy(), check_egress(), ClassifiedBriefcaseItem, coverage_uses_provenance_even_when_generalized_text_is_public(), DisclosureCarveOut, DisclosureClass (+14 more)

### Community 19 - "action.rs"
Cohesion: 0.05
Nodes (37): first-run-onboarding Specification, Purpose, Requirement: Key material MUST load from an owner-only file beside the configuration, Requirement: Known startup failures MUST name their remedy, Requirement: Model roles MUST be bound only after successful verification, Requirement: `openspine setup` MUST perform real onboarding work, Requirement: Provider login MUST be offered only where the credential can be spent, Requirement: Readiness assessment MUST name every blocking gap and its remedy (+29 more)

### Community 20 - "StoreError"
Cohesion: 0.22
Nodes (20): ArtifactProposalReceipt, ArtifactProposePayload, Digest, String, Ulid, build_miner_owner_review(), dispatch_miner_evaluated_proposal(), dispatch_reflection_proposal() (+12 more)

### Community 21 - "post_action"
Cohesion: 0.09
Nodes (22): Result, Store, hydrate_task_grant(), Arc, ArtifactRef, AtomicBool, Connection, Digest (+14 more)

### Community 22 - "ApprovalRecord"
Cohesion: 0.27
Nodes (19): append_approval(), miner_tick_harness(), MinerTickHarness, resolved_email_context(), resolved_email_context_with_task_shape(), ArtifactRef, MockServer, Ulid (+11 more)
...
Cohesion: 0.29
Nodes (13): consult_scoped_rule(), dispatch_scoped_effect(), resolve_scoped_admission(), ArtifactRef, Box, Option, Result, String (+5 more)

### Community 25 - "AppState"
Cohesion: 0.17
Nodes (22): Dir, Dirent, dup_fd(), libc_close(), libc_closedir(), libc_dup(), libc_dup_checked(), libc_errno_location() (+14 more)

### Community 26 - ".sweep_expired_grants"
Cohesion: 0.16
Nodes (26): ApprovalObservation, AuditTrailEntry, classification_within(), CorrectionObservation, EvalProbe, is_prohibition_shaped(), MinerBriefcase, OrdinaryMinerGrant (+18 more)

### Community 27 - "Lifecycle"
Cohesion: 0.15
Nodes (14): AccountRole, ActorHint, ChannelTrust, Connector, EventType, InteractionMode, legacy_without_thread_id_defaults_to_none(), round_trips_through_serde() (+6 more)

### Community 28 - "Requirements"
Cohesion: 0.35
Nodes (11): changed_compatibility_digest_makes_verdict_stale(), changed_descriptor_implementation_or_policy_version_makes_verdict_stale(), changed_reviewed_scope_or_evidence_digest_makes_verdict_stale(), digest(), full_epochs(), recorded_epoch_whose_live_value_disappeared_is_stale(), stale_axes_names_every_mismatching_axis(), unrecorded_epoch_axis_is_not_compared() (+3 more)

### Community 29 - "OpenSpine Agent-OS Design Log"
Cohesion: 0.09
Nodes (26): artifact_ref(), briefcase(), commission(), identity_addressing_serializes_one_message_per_conversation(), key(), restart_caps_hold_under_flaky_connector(), ArtifactRef, Result (+18 more)
...
Cohesion: 0.07
Nodes (66): activation_with_mutated_payload_is_denied(), approve_callback_update(), approved_artifact_activates_into_registry_and_overlay(), model_swap_ceremony_switches_real_generate_provider(), mount_send_message_ok(), MockServer, TelegramConnector, Ulid (+58 more)
...
Cohesion: 0.07
Nodes (30): detail_pages(), handle_command(), handle_detail_command(), record_unavailable(), render_page(), resolve_detail(), Result, String (+22 more)

### Community 40 - "Requirements"
Cohesion: 0.04
Nodes (47): Purpose, Requirement: A wired generic capability MUST have positive-effect and fallback/control owner-path tests, Requirement: Authority-sensitive changes MUST be explicitly marked, Requirement: Completed OpenSpec changes MUST be archived, Requirement: Decision-log consistency MUST be preserved, Requirement: Each OpenSpec change MUST state affected layer, Requirement: Issue numbers MUST be blockers, never runtime evidence, Requirement: OpenSpec artifacts MUST NOT be treated as live runtime authority (+39 more)
...
Cohesion: 0.12
Nodes (23): audit_action_count(), commissioned_worker_reports_and_master_relays_through_real_shell(), dispatch_state(), parent_briefcase(), parent_grant_for_commission(), root_pipeline_shell_does_not_report_worker_result(), Briefcase, PathBuf (+15 more)

### Community 43 - "properties"
Cohesion: 0.13
Nodes (35): try_count_model_call_allows_exactly_one_concurrent_winner_at_max_one(), conversation_history_continues_across_grants_in_same_channel_and_workflow(), find_task_grant_by_token_rejects_the_raw_hash_value(), persisted_grant_json_contains_no_task_token(), sample_grant(), task_grant_round_trips_by_token(), record_worker_result(), classified_empty_output_channel_denial() (+27 more)

### Community 44 - "ADDED Requirements"
Cohesion: 0.09
Nodes (69): activation_path_refuses_a_stale_verdict(), proposed_manifest(), StandingRuleManifest, a_new_thread_participant_restores_ordinary_approval_before_effect(), corrupt_persisted_binding_fails_closed_as_invalid_scope(), mutated_compatibility_epoch_restores_ordinary_approval_before_effect(), mutated_scope_dimension_restores_ordinary_approval_before_effect(), delivery_unknown_retains_reservation_and_leaves_fence_open() (+61 more)

### Community 45 - "digest.rs"
Cohesion: 0.21
Nodes (27): digest_of_bytes(), active_v2_survives_stale_approved_v1_recovery(), approved_dangling_recovery_quarantines_and_requests_reconfirm(), commit_before_publish_crash_republishes_exact_active_ref(), fixture(), insert_active_proposal(), insert_approved_proposal(), insert_proposal() (+19 more)

### Community 46 - "Digest"
Cohesion: 0.06
Nodes (30): model-provider-oauth-onboarding Specification, Purpose, Requirement: A stored credential MUST allow re-binding without a new authorization, Requirement: Background OAuth refresher MUST renew access tokens before expiration, Requirement: Definitive OAuth refresh failures MUST surface through failure queue, Requirement: Interactive setup wizard MUST execute OAuth PKCE authorization, Requirement: Model gateway MUST resolve live OAuth access tokens from vault, Requirement: OAuth credentials MUST be encrypted in SecretStore vault (+22 more)
...
Cohesion: 0.28
Nodes (15): HeadlessHookRequest, Vec, run_headless_hook(), webhook_minted_headless_draft_refuses_before_any_write(), headless_owner_route_binds_owner_persona_before_grant(), install_headless_route(), invalid_webhook_is_dropped_with_rejection_audit_and_no_grant(), production_owner_route_binds_seeded_persona() (+7 more)
...
### Community 50 - "mod.rs"
Cohesion: 0.18
Nodes (14): generic_overlay_loader_excludes_persona_and_base_loader_rejects_fixture(), kind_table_accepts_personas(), kind_table_excludes_templates(), kind_table_round_trips_all_eight_kinds(), loads_every_real_fixture_without_error(), malformed_fixture_fails_to_load(), missing_directory_is_not_an_error(), non_yaml_files_are_ignored() (+6 more)

### Community 51 - "ADDED Requirements"
Cohesion: 0.07
Nodes (28): 1. New composition from existing bricks: yes, 2. New privileged brick or connector: not safely, 3. Learn new workflows from repeated experience: only partly, AutoGPT's dry run is useful, but not an authority proof, AutoGPT versus OpenSpine, Blocks are the trusted computing base, Credentials enter block execution, Does AutoGPT "self-build capability"? (+20 more)

### Community 52 - "ADDED Requirements"
Cohesion: 0.08
Nodes (24): 1. The cautious agent power user, 2. The agent product builder, 3. The capable-agent sceptic, Category line, Competitive position, Copy rules, Core offer, Current-proof line (+16 more)

### Community 53 - "Requirements"
Cohesion: 0.12
Nodes (17): allow_response(), Cli, main(), owner_reply_action(), owner_reply_action_selects_exactly_one_granted_channel(), run(), should_report_worker_result(), task_view() (+9 more)

### Community 54 - "Requirements"
Cohesion: 0.23
Nodes (17): a_spoofed_closing_marker_in_the_content_does_not_escape_the_boundary(), build_prompt(), build_prompt_carries_system_preamble_and_conversation_through(), build_prompt_with_untrusted_context(), GatewayTierMap, PromptMessage, PromptRole, PromptTemplate (+9 more)

### Community 55 - "Requirements"
Cohesion: 0.14
Nodes (33): ActionRequestBody, ActionResponseBody, cleanup_pre_effect_reservations(), dispatch_lyra_preview(), dispatch_read_selected_thread(), FailureSurface, guard_connector_dispatch(), mediate_and_dispatch_action_headless() (+25 more)

### Community 56 - "owner_event"
Cohesion: 0.06
Nodes (34): ADDED Requirements, MODIFIED Requirements, Requirement: A digest-bound decision MAY be submitted with a short digest token, Requirement: Decision intents MUST map onto the digest-bound decision sets, Requirement: Decision refusals MUST be typed and enumerated, Requirement: Narrow MUST create a new immutable review digest, Requirement: Owner review MUST be channel-neutral and digest-bound, Requirement: Owner review MUST expose post-use receipts (+26 more)

### Community 57 - ".default"
Cohesion: 0.13
Nodes (20): Formatter, Result, ActionDescriptor, ActionImplementationDescriptor, ActionImplementationId, ActionSemantics, BudgetWindowBounds, DarkWindowPolicy (+12 more)
...
Cohesion: 0.18
Nodes (12): encrypt_digest_detail(), FailureClass, notify_immediate_failure(), record_callback_ack(), record_connector_outcome(), record_connector_outcome_or_batch(), ArtifactStore, Option (+4 more)
...
Cohesion: 0.07
Nodes (27): Purpose, reflection-miner Specification, Requirement: AD-135 digest corrections MUST enter the persona proposal lifecycle, Requirement: Briefcase context MUST be scoped and provenance-bound, Requirement: Consolidation MUST be lifecycle-safe, Requirement: Corrections MUST use positive instruction rewrites, Requirement: Miner admission MUST use an ordinary bounded grant, Requirement: Miner budgets MUST be durably reserved by the kernel (+19 more)
...
Cohesion: 0.08
Nodes (25): ADDED Requirements, MODIFIED Requirements, Requirement: Bound-context drift MUST restore ordinary approval before any effect, Requirement: Exactly one compatible scoped rule MUST match before any budget moves, Requirement: Quota and rate are independent atomic boundaries, Requirement: Scope-matched admission MUST map the effect outcome onto the reservation, Requirement: Standing rules MUST bind a reviewed scope, Scenario: A declaration axis changes (+17 more)

### Community 70 - "Proposal: Define OpenSpine development process"
Cohesion: 0.22
Nodes (13): SkillRow, a_consumed_token_cannot_be_consumed_twice(), a_token_expiring_on_an_exact_second_is_live_one_nanosecond_earlier(), a_token_expiring_on_an_exact_second_is_refused_one_nanosecond_later(), consume(), selection(), find_live_skill_context_selection(), insert_skill_context_selection() (+5 more)

### Community 71 - "MODIFIED Requirements"
Cohesion: 0.11
Nodes (62): AgentLimits, AgentManifest, main_assistant_agent(), main_assistant_denies_broad_email_access(), MemoryScope, ModelPolicy, OutputChannels, Persistence (+54 more)
...
Cohesion: 0.25
Nodes (4): dark_window_allow_eligible(), dark_window_allow_eligible_actions(), required_scope_dimensions_for(), delegation_descriptors()
...
Cohesion: 0.15
Nodes (21): OwnerReviewRow, ArtifactRef, Digest, Option, Result, String, Ulid, ensure_column() (+13 more)

### Community 79 - "OpenSpine kernel↔shell HTTP contract"
Cohesion: 0.13
Nodes (17): ensure_schema(), lifecycle_name(), lineage_from_json(), lineage_to_json(), parse_lifecycle(), ProposedArtifact, Connection, Option (+9 more)

### Community 80 - "Ok"
Cohesion: 0.09
Nodes (46): handle_terminal_message(), Result, inspect_is_read_only_and_writes_no_disposition(), narrow_persists_a_distinct_record_and_leaves_the_original_bytes_untouched(), persist(), rendered_copy_never_claims_readiness_without_a_registered_executor(), OwnerReviewRequest, String (+38 more)
...
Cohesion: 0.22
Nodes (18): ActionHandler, ActionHandlerRegistry, handle_artifact_nominate(), handle_artifact_propose(), handle_artifact_revoke(), handle_lyra_preview(), handle_plan_propose(), handle_read_selected_thread() (+10 more)
...
Cohesion: 0.09
Nodes (49): active_rule(), allowed_pending_is_recoverable_until_consumed(), claimed_fired_pending_is_surfaced_once_not_redispatched(), deny_default_never_dispatches_and_is_terminal(), fired_allow_token_is_digest_bound_and_one_use(), fired_allow_token_rejects_different_fingerprint(), owner_resolution_before_fire_controls_claim(), payload() (+41 more)
...
Cohesion: 0.17
Nodes (15): approval_required_to_approval_required_transition_is_rejected(), ApprovalSemantics, declarative_machine_requires_initial_state(), duplicate_step_id_across_states_is_rejected(), EscalationPoint, mermaid_event_delimiters_are_rejected(), mermaid_ids_are_injective_and_empty_ids_are_rejected(), renders_mermaid_and_resolves_declared_tier() (+7 more)

### Community 92 - "Agent-OS change sequence (2026-07-07, AD canon)"
Cohesion: 0.06
Nodes (48): OverlayControl, cleanup_install(), cleanup_path(), continuity_path(), exists(), inspect_install(), install_or_recover(), InstallState (+40 more)
...
Cohesion: 0.19
Nodes (3): BundleName, valid_transition(), OverlayControl

### Community 100 - "Design: Authority composition"
Cohesion: 0.22
Nodes (11): OverlayControl, check_continuity_alignment(), ensure_data_root_dir(), marker_path(), read_generation_marker(), write_generation_marker(), newer_ledger(), validate_counterparty_id() (+3 more)

### Community 101 - "Tasks: Backfill implemented capability specs"
Cohesion: 0.22
Nodes (15): disclosure_policy_does_not_revoke_existing_egress_standing_rule(), disclosure_policy_recovers_carve_outs_from_store(), enforcement_allows_after_owner_answer(), forum_request(), owner_answer_persists_as_standing_rule_with_carve_outs(), owner_disclosure_answer_creates_policy_and_clears_pending(), per_egress_revocation_is_independent(), provenance() (+7 more)
...
Cohesion: 0.08
Nodes (23): model-gateway Specification, Purpose, Requirement: Codex OAuth grants MUST be spent through the ChatGPT backend Responses transport, Requirement: Conversation state MUST store only role and artifact digest, Requirement: Private-context model calls MUST be constructed kernel-side, Requirement: Prompt templates MUST come from the kernel registry, never from shell input, Requirement: Provider credentials MUST never reach the shell, Requirement: Reasoning-tier provider routing MUST be owner-configurable and fail closed (+15 more)

### Community 104 - "OpenSpine conventions"
Cohesion: 0.40
Nodes (22): a_disabled_oauth_credential_blocks(), a_malformed_artifact_key_blocks_with_the_expected_shape(), a_set_provider_key_passes(), a_stale_package_directory_blocks_and_names_a_replacement(), a_stored_oauth_credential_passes_and_names_the_account(), an_absent_grant_key_blocks_rather_than_warns(), an_oauth_provider_without_a_credential_blocks_and_names_the_login(), an_unset_provider_key_blocks_and_names_the_variable() (+14 more)
...
Cohesion: 0.19
Nodes (22): context_input(), descriptor(), digest(), evidence_for(), explicit_owner_request_evidence(), implementation(), limits(), manifest() (+14 more)
...
Cohesion: 0.18
Nodes (17): PromptTemplate, orphan_higher_persona_cannot_hide_row_backed_lower_version(), artifact_identity_pairs(), artifact_version(), ArtifactKindSpec, ArtifactRegistry, ArtifactSource, exclude_identity_pairs() (+9 more)
...
Cohesion: 0.06
Nodes (65): append_overlay_finalization_audits(), bind_clock_and_finalize_overlay(), bind_kernel_listener(), build_provider_pool(), Cli, Commands, commit_post_bind_clock(), finalize_overlay_after_bind() (+57 more)

### Community 117 - "D-063 — Model-swap activation uses a serialized staged recovery protocol"
Cohesion: 0.19
Nodes (13): an_environment_supplied_key_is_carried_into_the_file_unchanged(), an_existing_key_file_is_left_alone(), artifact_key_of(), generated_keys_satisfy_the_artifact_key_shape(), key_entries(), prompt_supplied_values_cannot_corrupt_or_inject_yaml(), starter(), StarterConfig (+5 more)

### Community 118 - "Kernel foundation"
Cohesion: 0.20
Nodes (21): a_set_variable_is_retained_over_the_file(), absent_env_file_is_not_an_error(), EnvFileError, generated_key_file_is_never_readable_by_other_accounts(), group_readable_env_file_is_refused_with_its_mode(), is_identifier(), load_adjacent(), Loaded (+13 more)
...
Cohesion: 0.09
Nodes (22): Audience, Available proof, Claim discipline, Competitive posture, Core product promise, Current adopter qualification: technical self-hoster, Current alpha truth, Decision records (+14 more)
...
Cohesion: 0.17
Nodes (19): a_blocked_install_is_told_what_is_missing_every_start(), a_corrupt_marker_reads_as_incomplete(), a_ready_install_greets_once_then_stays_quiet(), blocked(), blocked_notice(), completion_round_trips_through_the_data_directory(), first_start(), FirstStart (+11 more)

### Community 124 - "mod.rs"
Cohesion: 0.19
Nodes (17): Authorization, begin(), begin_with_client_id(), default_port(), finish(), parse_authorization_paste(), a_bare_pasted_code_uses_the_authorization_state(), a_pasted_code_carrying_its_state_is_split_and_both_are_sent() (+9 more)
...
Cohesion: 0.10
Nodes (20): ADDED Requirements, Requirement: Communication dark-window Allow MUST be forbidden, Requirement: Compatibility drift or unavailable resolution MUST require re-review, Requirement: Delegation evidence classes MUST remain distinct, Requirement: Owner review MUST be channel-neutral and digest-bound, Requirement: Responsibility MUST remain a reference view rather than live authority, Requirement: Reusable delegation MUST validate independent action and implementation declarations, Requirement: Reviewed scope matching MUST be protocol-neutral and fail closed (+12 more)

### Community 128 - "D-004 — Every effectful action goes through `gate()`"
Cohesion: 0.10
Nodes (20): authority-equivalence-matcher Specification, Purpose, Requirement: Class construction is sealed to the kernel composition path, Requirement: Class identity equals the composed authority tuple, Requirement: Kernel computes authority-equivalence classes deterministically from declared action lists, Requirement: Production route/composition callsites resolve ambiguous ties through authority-equivalence classes, Requirement: The matcher picks only within one class; a cross-class pick is structurally impossible, Requirements (+12 more)

### Community 129 - "D-005 — Private-data shell must be contained"
Cohesion: 0.24
Nodes (32): commit_disposition(), commit_lifecycle(), dispatch_narrowed_miner_proposal(), load_owner_review_for_surface(), MinerEvaluationApproval, mint_owner_activation_grant(), OwnerReviewDecisionError, OwnerReviewDecisionOutcome (+24 more)
...
Cohesion: 0.11
Nodes (36): bind_email_identity(), email_counterparty_resolves_to_bound_identity_when_address_is_bound(), email_counterparty_stays_unresolved_when_address_is_unbound(), minimal_grant(), mint_topup_grant(), post_topup(), Response, SocketAddr (+28 more)

### Community 134 - "D-024 — OpenSpec is the development/change-management layer, not the runtime"
Cohesion: 0.17
Nodes (9): oauth_tokens_stored_encrypted_in_secret_store(), OAuthIdentityMetadata, OAuthTokens, secret_introduction_and_rotation_are_decryptable(), secret_store_oauth_keys_are_isolated_per_provider(), SecretStore, SecretStoreError, seed_is_idempotent_and_slot_validation_is_strict() (+1 more)
...
Cohesion: 0.13
Nodes (22): action_for(), arm(), capture(), Option, Result, CaptureOutcome, kind_prefix(), owner_grant() (+14 more)
...
Cohesion: 0.10
Nodes (19): digest-bound-draft-approval Specification Delta, MODIFIED Requirements, Requirement: The kernel MUST re-derive digests from artifact-store bytes at approval-effect time, Scenario: Approved admission sources converge on one executor, Scenario: Confirmed creation is executed exactly once in evidence, Scenario: Delivery is unknown after a provider write attempt, Scenario: Delivery-unknown retains the reserved budget and the fence, Scenario: Exact stored plan bytes are approved (+11 more)
...
Cohesion: 0.10
Nodes (19): MODIFIED Requirements, Requirement: Compatibility drift or unavailable resolution MUST require re-review, Requirement: Delegation evidence classes MUST remain distinct, Requirement: Reviewed scope matching MUST be protocol-neutral and fail closed, Requirement: Trusted action context MUST be resolved by the kernel, responsibility-contract Specification Delta, Scenario: Approvals across two targets are not one pattern, Scenario: Compatibility epoch and scope key move independently (+11 more)

### Community 142 - "Skills & workflows"
Cohesion: 0.18
Nodes (19): ConnectorImplementationScope, reviewed_scope_digest_of(), reviewed_scope_values_of(), ReviewedActionScope, ReviewedScopeError, ReviewedScopeValue, ReviewedTargetScope, BTreeMap (+11 more)

### Community 143 - "Reflection & product surface"
Cohesion: 0.14
Nodes (31): connector_for_action(), refuse(), resume_standing_rule_revalidated(), ResumeOutcome, ResumeRefusal, Error, Option, Result (+23 more)
...
Cohesion: 0.17
Nodes (14): BriefcaseAudit, ensure_schema(), ArtifactRef, Briefcase, Connection, E, F, Option (+6 more)

### Community 147 - "model_swap.rs"
Cohesion: 0.17
Nodes (24): ConversationClaimGuard, ConversationClaimGuard<'a>, handle_worker_commission(), handle_worker_failed(), handle_worker_report_result(), ArtifactRef, Drop, HandlerFuture (+16 more)

### Community 148 - "D-040 — Pending (pre-approval) `ActionRequest`s are persisted in a new `action_requests` table"
Cohesion: 0.10
Nodes (38): BuildEnvelopeFn, ArtifactRef, Option, Result, Vec, run_pipeline(), run_pipeline_with_envelope(), headless_lane() (+30 more)
...
Cohesion: 0.12
Nodes (10): action_request_consume_is_single_use(), action_request_round_trips_by_id(), approval_round_trips_by_action_request_id(), most_recent_approval_wins_when_multiple_exist_for_one_request(), opening_a_pre_existing_db_without_the_used_column_is_migrated_in_place(), Ulid, sample_action_request(), sample_approval() (+2 more)
...
Cohesion: 0.19
Nodes (19): resolve_ambiguous_route(), resolve_tied_routes(), RouteAuthoritySources, ActionCatalog, AgentManifest, ArtifactId, Box, CapabilityPack (+11 more)
...
Cohesion: 0.14
Nodes (34): dependency_fingerprint(), accepted_digest_tamper_invalidates(), base_namespace_is_not_treated_as_learned(), dangling_learned_route_is_orphaned_and_excluded(), erased(), exclude_erased_covers_registered_kinds_and_exact_version_model_swaps(), insert_agent(), insert_pack() (+26 more)
...
Cohesion: 0.11
Nodes (18): ADDED Requirements, model-provider-oauth-onboarding delta, MODIFIED Requirements, Requirement: A stored credential MUST allow re-binding without a new authorization, Requirement: Interactive setup wizard MUST execute OAuth PKCE authorization, Requirement: OAuth login MUST support headless and remote SSH fallbacks, Requirement: OpenAI Codex login MUST derive the ChatGPT account identity from the access token, Scenario: A legacy transport entry is cut over on binding (+10 more)
...
Cohesion: 0.16
Nodes (23): BoundaryBehavior, OwnerReviewDecision, OwnerReviewEvaluationBinding, OwnerReviewEvaluationEpochs, OwnerReviewRequest, OwnerReviewRequestError, OwnerReviewRequestInput, ProposalKind (+15 more)
...
Cohesion: 0.31
Nodes (17): catalog_with(), communication_delegation_rejects_action_only_scope_and_allow_defaults(), communication_scope_floor_covers_external_services_and_counterparties(), compatibility_epoch_and_scope_key_move_independently(), context_input(), descriptor(), digest(), implementation() (+9 more)
...
Cohesion: 0.11
Nodes (18): Approved landing direction, Architecture support already present, Badge, Claim guardrails, Current proof placement, Evaluation correction, Executive decision, Guardrail line (+10 more)
...
Cohesion: 0.08
Nodes (24): ADDED Requirements, Artifact lifecycle, MODIFIED Requirements, Requirement: Authority-bearing proposals require overlay evaluation before approval, Requirement: Gate summary copy MUST state only what executed cases prove, Requirement: Overlay evaluation MUST NOT grant or activate authority, Scenario: A non-delegable action cannot carry a standing rule, Scenario: A passing evaluation changes no runtime authority (+16 more)

### Community 176 - "D-034 — `email.create_draft` is the one canonical action id; the qualified PRD §10.2 spelling is dropped"
Cohesion: 0.18
Nodes (10): a_failed_response_carries_the_upstream_message(), a_terminal_event_with_failed_status_is_rejected_despite_deltas(), an_incomplete_terminal_without_text_fails_with_its_reason(), completed_output_text(), generate_codex_responses(), prompt(), request_body(), text_from_sse() (+2 more)
...
Cohesion: 0.08
Nodes (24): ADDED Requirements, openspine-development-process Specification Delta, Requirement: A wired generic capability MUST have positive-effect and fallback/control owner-path tests, Requirement: Issue numbers MUST be blockers, never runtime evidence, Requirement: Portability MUST NOT be marked verified without second-protocol evidence, Requirement: The capability map MUST record a landed-substrate and blocker structure, Requirement: The capability-map schema MUST migrate explicitly and idempotently, Requirement: The checked capability map MUST separate generic capability, selected proof, and portability evidence (+16 more)

### Community 179 - "D-019 — Implement minimal slice first, not full agent OS"
Cohesion: 0.07
Nodes (33): map_slice_row(), dependency_wake_requires_all_dependencies_and_unblocks_task(), ref_of(), Store, all_slice_categories_are_owner_scoped(), anchored_slice_includes_not_yet_due_focal_task_and_honors_limit_one(), insert_task_rejects_prepopulated_timer_ids(), master_slice_is_bounded_and_excludes_task_detail() (+25 more)

### Community 180 - "why-openspine.md"
Cohesion: 0.18
Nodes (26): admitted(), briefcase(), classification_ceiling_is_derived_from_pack_not_caller(), consolidation_is_a_proposal_not_an_immediate_prune_or_merge(), consolidation_rejects_targets_absent_from_briefcase(), correction_never_appends_a_prohibition_artifact(), correction_rejects_prohibition_shaped_instruction(), correction_rewrites_instruction_and_negative_constraint_becomes_probe() (+18 more)
...
Cohesion: 0.24
Nodes (9): BundleManifest, decode_hex_32(), hex(), hex_nibble(), ManifestBody, sign_manifest(), valid_continuity_id(), validate_body() (+1 more)
...
Cohesion: 0.11
Nodes (17): Consequences, Consequences, Consequences, D-112 — Exactly one terminal outcome per worker dispatch, D-115 — Persona binding is additive, no-fallback, and structurally contained, D-138 — Miner and lifecycle artifact budgets are independent, Decision, Decision (+9 more)
...
Cohesion: 0.12
Nodes (17): Build and run the checks, Current trade-offs, Documentation, How Lyra grows through delegation, License, Local terminal conversation, OpenSpine, Proof you can run (+9 more)

### Community 191 - "architecture.md"
Cohesion: 0.17
Nodes (20): build_owner_envelope(), CallbackQueryUpdate, DisclosureAnswer, parse_approve_callback(), parse_approve_plan_callback(), parse_bind_command(), parse_digest_detail_command(), parse_digest_namespace() (+12 more)

### Community 192 - "decisions.md"
Cohesion: 0.09
Nodes (21): lineage-and-eval-store Specification, Purpose, Requirement: Artifacts MUST carry a generation/lineage model distinct from content version, Requirement: Eval-verdict vocabulary MUST remain open and fitness/evidence optional, Requirement: Eval verdicts MUST bind their evaluation epochs and stale when any changes, Requirement: Eval verdicts MUST land in an indexed table, not the audit chain, Requirement: Unknown lineage MUST NOT be rewritten as root, Requirements (+13 more)

### Community 193 - "quickstart.md"
Cohesion: 0.10
Nodes (20): MODIFIED Requirements, Requirement: The kernel MUST re-derive digests from artifact-store bytes at approval-effect time, Scenario: Approved admission sources converge on one executor, Scenario: Confirmed creation is executed exactly once in evidence, Scenario: Delivery is unknown after a provider write attempt, Scenario: Delivery is unknown and retry is fenced, Scenario: Delivery-unknown retains the reserved budget and the fence, Scenario: Exact request after explicit resolution may proceed (+12 more)

### Community 194 - "roadmap.md"
Cohesion: 0.24
Nodes (15): agent_manifests_round_trip(), artifacts_dir(), email_grant_pack_excludes_read_inbox_and_send(), every_fixture_file_is_covered_by_a_test(), global_policy_round_trips_and_denies_send(), owner_control_pack_round_trips(), owner_email_selected_thread_route_is_expressible_declaratively(), owner_telegram_route_is_expressible_declaratively() (+7 more)
...
Cohesion: 0.24
Nodes (11): miner_proposal_denied_verdict_refuses_without_review_or_activation(), miner_proposal_mismatched_verdict_refuses_without_review_or_activation(), miner_proposal_missing_verdict_refuses_without_review_or_activation(), miner_proposal_non_review_required_refuses_without_review_or_activation(), miner_proposal_stale_verdict_refuses_without_review_or_activation(), run_dispatch_control(), apply_dispatch_test_mutation(), DispatchTestMutation (+3 more)

### Community 197 - "editUrl"
Cohesion: 0.12
Nodes (14): 1. Create a Google Cloud OAuth client, 2. Obtain a refresh token, 3. Add the `gmail` block to `openspine.yaml`, 4. Select a thread with `/draft <thread_id>`, 5. Containment requirements, Bare metal, Docker Compose, Gmail selected-thread drafting setup (+6 more)

### Community 198 - "head"
Cohesion: 0.20
Nodes (5): Authority boundary, Build, Configure Onyx and LFM2.5, Direct terminal chat, Run
...
Cohesion: 0.12
Nodes (15): MODIFIED Requirements, Requirement: The kernel MUST re-derive digests from artifact-store bytes at approval-effect time, Scenario: Approved admission sources converge on one executor, Scenario: Confirmed creation is executed exactly once in evidence, Scenario: Delivery is unknown after a provider write attempt, Scenario: Exact stored plan bytes are approved, Scenario: Payload bytes changed after approval, Scenario: Post-attempt failure is not reported as success (+7 more)

### Community 202 - "proposal.rs"
Cohesion: 0.12
Nodes (15): MODIFIED Requirements, Requirement: ActionCatalog MUST enumerate every trusted-path carve-out around gate(), Requirement: Unspecified actions MUST be denied, Scenario: Agent requests unknown action, Scenario: An unregistered effectful action fails closed, Scenario: Catalogued effectful action has no executor, Scenario: Declared non-effect read retains the stub boundary, Scenario: Each enumerated entry has a dedicated test (+7 more)
...
Cohesion: 0.18
Nodes (11): add-channel-neutral-responsibility-review, bound-dark-window-exceptions, compose-whole-responsibilities, define-responsibility-contract, make-reusable-authority-evaluation-proposal-specific, mine-and-match-reusable-authority-by-scope, Progressive delegation contract and proofs, prove-progressive-delegation-portability (+3 more)
...
Cohesion: 0.31
Nodes (14): access_token_account_id(), account_id_decoding_tolerates_padding_and_rejects_garbage(), build_authorization_url(), codex_authorization_url_matches_registered_client_contract(), codex_exchange_extracts_chatgpt_account_id_from_access_token(), codex_exchange_refuses_a_token_with_no_account_id(), codex_refresh_reissues_access_token_and_identity(), exchange_code() (+6 more)

### Community 209 - "README.md"
Cohesion: 0.13
Nodes (9): configured_owner_text_message_is_verified(), missing_sender_is_ignored(), non_text_update_from_owner_is_ignored(), owner_message_in_a_group_chat_is_ignored_not_routed(), Option, unknown_telegram_user_is_ignored_not_routed(), update(), VerifiedUpdate (+1 more)
...
Cohesion: 0.16
Nodes (10): ArtifactRef, Option, Result, Ulid, Vec, Store, DependencyWake, parse_ulid() (+2 more)
...
Cohesion: 0.08
Nodes (30): consult_standing_rule_gate(), Option, Result, Store, String, StandingRuleGateOutcome, PendingScheduleCtx, ArtifactRef (+22 more)

### Community 220 - "SKILL.md"
Cohesion: 0.13
Nodes (14): MODIFIED Requirements, Requirement: Dark-window defaults are durable and replay-safe, Scenario: Allow default grants one waiver, Scenario: Deny default grants no waiver, Scenario: Failed effects release reservations, Scenario: Fired missing executor cancels and re-arms the token, Scenario: Fired token is digest-bound and one-use, Scenario: Invalid persisted recovery data fails closed (+6 more)
...
Cohesion: 0.13
Nodes (14): ADDED Requirements, gate-action-api Specification Delta, MODIFIED Requirements, Requirement: Scope-matched admission MUST supply only a kernel-resolved request to the executor, Requirement: Unspecified actions MUST be denied, Scenario: Agent requests unknown action, Scenario: Catalogued effectful action has no executor, Scenario: Declared non-effect read retains the stub boundary (+6 more)
...
Cohesion: 0.13
Nodes (14): Brief, Decision, Deterministic comparison, Frozen landing baseline, Landing candidate, Limitations, Mechanism reader, OpenSpine paired copy evaluation (+6 more)

### Community 252 - "opsx-propose.md"
Cohesion: 0.13
Nodes (14): dependencies, astro, @astrojs/starlight, sharp, name, scripts, astro, build (+6 more)
...
Cohesion: 0.27
Nodes (13): counterparty_deferral_text_is_canonical(), grant_with_thread(), no_thread_id_resolves_to_master(), owner_escalation_message(), owner_message_carries_action_and_reason_code(), resolve_by_thread_id_returns_bound_grant(), resolve_grant_for_thread(), route_escalation() (+5 more)

### Community 255 - "SKILL.md"
Cohesion: 0.18
Nodes (17): handoff_complete(), Arc, run(), kernel_notify_grant(), notify_owner_required(), notify_owner_required_outcome(), notify_owner_surface_required(), notify_owner_with_digest() (+9 more)

### Community 268 - "content-assets.mjs"
Cohesion: 0.24
Nodes (23): benign_body(), containment_gate_denies_denied_action_regardless_of_malicious_skill(), make_skill(), malicious_body(), matcher_can_inject_but_never_install(), mined_provenance_lands_pending_and_review_denies_malicious_body(), mined_provenance_promotes_when_review_passes(), owner_can_reject_pending_mined_skill() (+15 more)

### Community 269 - "content-modules.mjs"
Cohesion: 0.22
Nodes (16): admit_spend(), breach_message(), counted_model_generate(), guard_connector(), guard_connector_for(), prior_day_recovery_message_is_truthful(), prompt(), recover_pending_breach_alerts() (+8 more)

### Community 270 - "types.d.ts"
Cohesion: 0.11
Nodes (19): Requirement: Activated artifacts MUST survive a kernel restart, Requirement: Artifact id and version MUST be unique across fixtures, overlay, and pending proposals, Requirement: Digest/brief format MUST remain a learnable default, Requirement: Learned artifacts MUST carry durable exchange provenance, Requirement: Only active artifacts MUST participate in authority composition, Requirement: Overlay version cutover MUST be highest-only and monotonic, Requirement: Persona artifacts MUST never enter kernel authority, Requirement: Proposed artifacts MUST follow the lifecycle chain with illegal transitions rejected (+11 more)

### Community 274 - "SKILL.md"
Cohesion: 0.45
Nodes (13): a_401_spends_a_concurrently_refreshed_token_instead_of_refreshing_again(), an_in_stream_failure_echoing_secrets_is_scrubbed(), codex_client(), codex_error_bodies_never_echo_the_bearer_or_account_id(), codex_generate_falls_back_to_completed_output_when_no_deltas_arrive(), codex_generate_maps_response_failed_to_a_provider_error(), codex_generate_refuses_when_no_account_id_is_stored(), codex_generate_retries_once_after_a_401_via_inline_refresh() (+5 more)

### Community 275 - "opsx-explore.md"
Cohesion: 0.17
Nodes (13): EffectExecutorRegistry, HashMap, Option, Self, build_state_at(), full_export_restore_e2e_regression_under_newer_base(), mint_composed_owner_grant(), mode() (+5 more)

### Community 276 - "opsx-apply.md"
Cohesion: 0.24
Nodes (13): accepted_dependency_fingerprint_migration_is_idempotent(), accepted_dependency_fingerprint_round_trips(), activation_cannot_replace_erased_identity_with_other_scope(), base_namespace_cannot_be_recorded_as_learned(), learned_artifact_round_trip_preserves_typed_provenance(), mark_reconfirmation_required_excludes_erased_rows(), owner_accepted_is_durable_across_round_trip(), owner_reconfirmation_cannot_replace_erased_identity_with_other_scope() (+5 more)
...
Cohesion: 0.12
Nodes (31): expired_pending_test(), mismatched_chat_pending_test(), mount_unused_provider(), production_intake_rotate_connector_call_integration(), provider_pointed_at(), MockServer, different_bot_token_rotation_starts_fresh_namespace(), mount_unused_provider() (+23 more)

### Community 279 - "SKILL.md"
Cohesion: 0.11
Nodes (17): ADDED Requirements, direct-terminal-chat Specification Delta, MODIFIED Requirements, Requirement: Local terminal messages SHALL use the governed owner pipeline, Requirement: Owner decision code SHALL use a typed owner-surface reference, not a naked chat integer, Requirement: The terminal surface SHALL present owner review as an authenticated presentation/input adapter, Scenario: A non-owner terminal principal submits a decision, Scenario: Existing Telegram grants remain valid (+9 more)
...
Cohesion: 0.14
Nodes (13): Binding the exception to the reviewed context, Communication `Allow` gains enforcing code, Currently unreachable in production, Design: Bound dark-window exceptions, Exception accounting is not quota accounting, Lifecycle staleness, Nonterminal, not "unresolved-and-unfired", Note on D-107's wording (+5 more)
...
Cohesion: 0.14
Nodes (12): Color roles, Composition, Direction, Documentation, Motion, OpenSpine design system, Quality floor, Responsive behavior (+4 more)
...
Cohesion: 0.20
Nodes (16): allow_reply(), allow_result(), deny_on_model_generate_exits_ok(), deny_on_primary_action_exits_ok_no_reply_attempt(), deny_response(), export_command_sends_exact_payload(), export_with_extra_args_replies_usage(), export_without_name_replies_usage_and_calls_nothing() (+8 more)

### Community 291 - "artifact_propose.rs"
Cohesion: 0.11
Nodes (17): Authority and containment, Available through Lyra today, Capability map, Deliberate current limits, Direct local terminal conversation, Durable work and delegation, Governed learning and growth, [Install OpenSpine as an assistant system](https://github.com/George-RD/openspine/issues/117) (+9 more)
...
Cohesion: 0.19
Nodes (16): briefcase(), get_task(), get_task_emits_empty_output_channels_for_worker_grant(), Arc, HeaderMap, Json, Option, Result (+8 more)
...
Cohesion: 0.36
Nodes (8): a_refresh_carries_the_first_party_client_headers(), oauth_refresher_handles_definitive_failure_and_enqueues_notification(), oauth_refresher_renews_token_within_skew_window(), oauth_refresher_retains_credential_on_transient_network_failure(), oauth_refresher_single_flights_concurrent_refreshes(), OAuthRefresher, parse_expires_at(), registered_anthropic_client()
...
Cohesion: 0.15
Nodes (12): ADDED Requirements, model-gateway delta, Requirement: Codex OAuth grants MUST be spent through the ChatGPT backend Responses transport, Requirement: Reasoning-tier provider routing MUST be owner-configurable and fail closed, Scenario: A declared tier reaches its routed provider, Scenario: A routed provider spends its own credential, Scenario: A tier route to an unknown provider refuses startup, Scenario: Codex generate round trip (+4 more)

### Community 303 - "get_task"
Cohesion: 0.23
Nodes (8): reject_stale_eval_verdicts_conn(), Connection, Option, Result, StandingRuleManifest, Store, Self, VerdictEpochs
...
Cohesion: 0.28
Nodes (3): ConnectorCallError, ConnectorProbePermit, ConnectorRuntime

### Community 309 - "effect_paths.rs"
Cohesion: 0.26
Nodes (15): deny_limit_exceeded(), GenerateRequestBody, GenerateResponseBody, post_model_generate(), Arc, HeaderMap, Json, Option (+7 more)

### Community 310 - "Overlay & key model"
Cohesion: 0.12
Nodes (20): DisclosureReservation, action_for_egress(), action_for_scope(), cancel_reservations(), collect_nested_strings(), prepared_query_mints_consumes_once_and_verifies_digest(), DisclosureError, enforce_disclosure_egress() (+12 more)

### Community 311 - "retry_worker.rs"
Cohesion: 0.34
Nodes (15): a_tier_routed_oauth_provider_spends_its_own_credential(), email_reply_drafter_grant(), email_reply_drafter_template_wraps_untrusted_context_on_the_wire(), grant_with_limits(), max_artifacts_of_one_denies_the_second_call_with_a_single_provider_hit(), max_model_calls_of_one_denies_the_second_call_with_a_single_provider_hit(), post_model_generate(), JoinHandle (+7 more)

### Community 312 - "D-014 — Bootstrap/setup secrets bypass shell/model context"
Cohesion: 0.15
Nodes (12): Capability cannot quietly widen itself, How responsibility is meant to grow, Model-driven effects cross one gate, One poisoned email, One task has one permission result, The autonomy gap, The four commitments, The model does not own the keys (+4 more)

### Community 313 - "editUrl"
Cohesion: 0.19
Nodes (13): audit_append_failure_fails_notification_before_connector_effect(), audit_readonly_failure_fails_notification_before_connector_effect(), disk_full_audit_append_aborts_before_connector_effect(), notify_send_failure_records_attempt_failure_and_dead_letter(), parse_audit_event(), Value, shadow_grant_effect_suppressed_skips_effect_handler(), test_path_1_notify_owner_gated_and_audited() (+5 more)

### Community 314 - "Proposal: Implement identity store and principal"
Cohesion: 0.14
Nodes (28): bounded_text(), load_checkpoint(), relay_one(), RelayOutcome, resolve_relay_context(), Option, Result, String (+20 more)
...
### Community 326 - "Error"
Cohesion: 0.11
Nodes (31): route_yaml(), String, batched_failure_details(), committed_usage_count(), draft_created_event(), headless_and_non_headless_approval_converge_on_gmail_executor(), headless_refusal_appends_no_dispatched_audit(), reserved_usage_count() (+23 more)
...
### Community 329 - "standing_rule_timer.rs"
Cohesion: 0.38
Nodes (12): a_failed_token_refresh_surfaces_as_an_error(), a_non_404_api_error_is_not_treated_as_missing(), connector(), fetch_thread_extracts_text_and_skips_attachments(), gmail_token_refresh_only_within_skew_window(), gmail_token_refreshes_near_expiry(), mount_token_endpoint(), rotated_vault_credentials_bypass_live_access_token_cache() (+4 more)
...
### Community 331 - "Tasks: Define OpenSpine development process"
Cohesion: 0.17
...
Cohesion: 0.17
Nodes (11): Design: First-run onboarding, Key decisions, Problem, Readiness drives the notice, not the marker alone, Rejected alternatives, Remedies are matched on the failure, not guessed at the call site, Shape, The environment lookup is injected (+3 more)
...
### Community 334 - "Ulid"
Cohesion: 0.17
Nodes (11): Authority, containment, audit, failure modes, Design: Mine and match reusable authority by scope, Drift restores approval before the effect, never after, `EffectOutcome` → reservation, Known limitation: silent thread participants, Matching: exactly one, before any budget moves, Rejected alternatives, `ResolvedActionContext` is reused, not rebuilt (+3 more)
...
Cohesion: 0.17
Nodes (11): local-onyx-inference Specification, Purpose, Requirement: LFM2.5-1.2B SHALL be the terminal default, Requirement: Onyx credentials SHALL remain outside configuration files, Requirement: Onyx inference SHALL use the scoped chat API, Requirement: OpenSpine context SHALL be ephemeral in Onyx, Requirements, Scenario: A terminal turn has prior history (+3 more)
...
Cohesion: 0.35
Nodes (15): PromotionDenial, get_skill(), recent_promotion_decisions_for_test(), owner_decide_promotion(), reject_mined_skill(), benign_body(), make_mined_skill(), malicious_body() (+7 more)

### Community 340 - "D-033 — Action identifiers are exact-match dotted strings; unverified senders are audited and ignored"
Cohesion: 0.18
Nodes (14): ArtifactRef, Connection, Digest, Option, Result, Ulid, Store, Result (+6 more)

### Community 341 - "MockServer"
Cohesion: 0.33
Nodes (6): Digest, Mutex, Result, Vec, telegram_chat_id(), TelegramConnector

### Community 342 - "Timestamp"
Cohesion: 0.33
Nodes (9): anthropic_client_parses_the_reply_text(), declared_high_tier_selects_high_provider_endpoint(), gateway_injects_oauth_bearer_token_from_vault(), gateway_recovers_from_transient_401_via_inline_token_refresh(), malformed_response_is_missing_content_not_a_panic(), onyx_client_uses_scoped_chat_api_and_parses_answer(), openai_compat_client_parses_the_reply_text(), prompt() (+1 more)

### Community 343 - "Value"
Cohesion: 0.13
Nodes (15): Requirement: Authority-bearing proposals require overlay evaluation before approval, Scenario: A non-delegable action cannot carry a standing rule, Scenario: Ambiguously overlapping or widening proposal is refused, Scenario: An effectful action cannot carry an unscoped standing rule, Scenario: An evaluation that executed no cases cannot pass as replay, Scenario: An uncatalogued action cannot carry a standing rule, Scenario: Generic lifecycle bypass is rejected, Scenario: Missing model-swap evaluation blocks approval (+7 more)

### Community 344 - "Arc"
Cohesion: 0.47
Nodes (9): digest(), email_context(), scoped_consult_admits_exactly_one_matching_rule_and_reserves_budget(), scoped_consult_ambiguous_overlap_fails_closed_with_no_budget(), scoped_consult_corrupt_binding_fails_closed_as_invalid_scope(), scoped_consult_declaration_drift_stops_matching_before_budget(), scoped_consult_disjoint_scoped_rules_match_only_their_own_context(), scoped_consult_zero_matches_falls_back_with_no_budget() (+1 more)

### Community 345 - "HeaderMap"
Cohesion: 0.24
Nodes (13): confirm(), prompt(), bootstrap(), choose_model(), encrypted_state_in(), ensure_key_material(), open_vault(), OpenVault (+5 more)
...
### Community 361 - "Value"
Cohesion: 0.18
Nodes (10): ADDED Requirements, Direct terminal chat, Requirement: Conversation continuity SHALL be scoped by channel and workflow, Requirement: Local terminal messages SHALL use the governed owner pipeline, Requirement: Terminal mode SHALL NOT require Telegram credentials, Requirement: Terminal reply authority SHALL be channel-specific, Scenario: Clean local smoke test has no Telegram token, Scenario: Owner sends a freeform terminal message (+2 more)
...
Cohesion: 0.18
Nodes (10): ADDED Requirements, Local Onyx inference, Requirement: LFM2.5-1.2B SHALL be the terminal default, Requirement: Onyx credentials SHALL remain outside configuration files, Requirement: Onyx inference SHALL use the scoped chat API, Requirement: OpenSpine context SHALL be ephemeral in Onyx, Scenario: A terminal turn has prior history, Scenario: Operator configures Onyx (+2 more)

### Community 364 - "HeaderMap"
Cohesion: 0.18
Nodes (10): 1. Catalog the closed non-effect boundary, 2. Describe implementation readiness, 3. Extract the Gmail executor, 4. Converge both approved admission sources, 5. Fail closed at dispatch, 6. Preserve reservation and evidence semantics, 7. Add behavior-focused test families, 8. Record the admission-source boundary (+2 more)

### Community 365 - "connectors_tests.rs"
Cohesion: 0.18
Nodes (10): 1. Make the exception allowance reviewable data, 2. Enforce the cap atomically in the scheduling transaction, 3. Report suppression as an ordinary approval, 4. Bind the pending exception to the reviewed context, 5. Account for exceptions separately from quota, 6. Stale open exceptions on every lifecycle change, 7. Give the communication Allow prohibition enforcing code, 8. Test the boundaries (+2 more)

### Community 366 - "Option"
Cohesion: 0.27
Nodes (13): activate_or_install_legacy_allow(), consult_and_reserve_atomic_budget_saturates_after_max_uses(), consult_and_reserve_cancel_leaves_headroom_unchanged(), consult_and_reserve_is_atomic_wrt_version_reactivation(), install_legacy_allow_dark_window_rule(), manifest(), manifest_validate_rejects_non_positive_windows(), reservation_identity() (+5 more)
...
### Community 368 - "State"
Cohesion: 0.33
Nodes (6): Agent-OS change sequence (2026-07-07, AD canon), Event substrate, implement-durable-workflow-replay, implement-event-bus-subscriptions, implement-task-board, Loop execution contract (AD-145)
...
### Community 372 - "Vec"
Cohesion: 0.20
Nodes (4): DelegationEvidence, DelegationEvidenceError, DelegationEvidenceKind, OwnerApprovalEvidence
...
Cohesion: 0.42
Nodes (5): CallbackError, CallbackServer, oauth_loopback_callback_server_receives_code_and_validates_state(), parse_query(), url_decode()

### Community 380 - "Option"
Cohesion: 0.51
Nodes (9): cmd_freeform(), cmd_overlay_bundle(), cmd_propose(), cmd_setup(), cmd_status(), run(), run_with_reply_action(), send_reply() (+1 more)
...
Cohesion: 0.20
Nodes (9): Dark windows, Design, Drift and removal, Evidence and proposal truthfulness, Existing behavior, Owner review, Resolved context and reviewed scope, Responsibility is a reference view (+1 more)

### Community 408 - "Json"
Cohesion: 0.20
Nodes (9): Acceptance Criteria, Authority sensitivity, Change: Implement first-run onboarding and a working setup wizard, Dependencies, Layer, Out of Scope, Prerequisite this change surfaces, What Changes (+1 more)

### Community 409 - "Result"
Cohesion: 0.20
Nodes (9): 1. Add the reviewed-scope key to the resolved context, 2. Bind a reviewed scope to the standing-rule manifest, 3. Construct the resolved context at the kernel boundary, 4. Match exactly one compatible scoped rule, 5. Restore ordinary approval on drift, 6. Reach the shared executor and map the outcome, 7. Test the boundaries, 8. Document and record (authority-sensitive) (+1 more)

### Community 418 - "Response"
Cohesion: 0.20
Nodes (10): Candidate, Deterministic comparison, Frozen baseline, Mechanism reader, Paired copy evaluation, Reader panel, Right-fit sceptic, Rubric (+2 more)

### Community 419 - "record_worker_commissioned"
Cohesion: 0.08
Nodes (25): 10x challenge, 1/10 challenge, Adversarial review and gate, Business strategist, Copy implications, Current market context, Direct reader evidence, Executive finding (+17 more)

### Community 420 - "D-028 — Canonical artifact format is YAML+serde; digests are `sha256:` over canonical JSON"
Cohesion: 0.14
Nodes (13): Authority, containment, audit, failure modes, Blanket authority needs its own licence, Dark-window cases against the substrate that exists, Design: Make reusable-authority evaluation proposal-specific and evidence-backed, Epoch binding and read-time staleness, Every standing rule gets the authority axes, Judge before replay, Keep the promotion boundary, replace the evidence (+5 more)

### Community 421 - "ArtifactId"
Cohesion: 0.24
Nodes (10): derive_narrowed_scope(), handle_owner_review_command(), parse_intent(), Error, Option, OwnerReviewRequest, Result, ReviewedActionScope (+2 more)

### Community 422 - "CapabilityPack"
Cohesion: 0.15
Nodes (12): Purpose, Requirement: Bound-context drift MUST restore ordinary approval before any effect, Requirement: Drift requires re-review, Requirement: Remaining budget is visible, Requirements, Scenario: A declaration axis changes, Scenario: An instance dimension changes, Scenario: Repeated saturation retires live consultation (+4 more)
...
Cohesion: 0.22
Nodes (8): 1. Treat the terminal as a distinct verified owner channel, 2. Keep the existing kernel and shell boundary, 3. Use Onyx through its scoped chat API, 4. Establish a model hierarchy without silent failover, 5. Scope conversational history to channel and workflow, Decisions, Design: direct terminal chat with Onyx LFM2.5, Trade-offs

### Community 438 - "Self"
Cohesion: 0.22
Nodes (8): Acceptance Criteria, Authority sensitivity, Change: Define the protocol-neutral responsibility contract, Dependencies, Layer, Out of Scope, What Changes, Why

### Community 439 - "String"
Cohesion: 0.22
Nodes (8): Admission-source convergence, Audit, idempotency, and verification surface, Deny-by-default dispatch and the closed stub allowlist, Design: Unify approved and delegated effect execution, `EffectPathClass` cannot classify an action id, Existing descriptor axis is the readiness contract, One executor with a truthful outcome, Out of Scope
...
### Community 442 - "Error"
Cohesion: 0.15
Nodes (13): Requirement: Dark-window defaults are durable and replay-safe, Scenario: Allow default grants one waiver, Scenario: Deny default grants no waiver, Scenario: Failed effects release reservations, Scenario: Fired missing executor cancels and re-arms the token, Scenario: Fired token is digest-bound and one-use, Scenario: Invalid persisted recovery data fails closed, Scenario: Missing executor cancels an ordinary consult reservation (+5 more)

### Community 443 - "Option"
Cohesion: 0.22
Nodes (9): 1. The previous copy implied bring-your-own assistant support, 2. The product vision is ahead of the default user experience, 3. The planned package interface was not on the visible roadmap, 4. Richer onboarding is deferred by architecture sequence, but onboarding is now the main value leak, 5. The public roadmap had factual drift, 6. Advanced kernel capability is not the same as an end-user feature, 7. Universal single-gate language overstated the current trusted-path model, 8. Agent-proposed skill language was ahead of the shipped Lyra path (+1 more)
...
Cohesion: 0.32
Nodes (10): deny_unknown_fields_rejects_capability_pack_id(), EntityType, Identifier, IdentifierKind, IdentifierVerificationMethod, Identity, identity_json_has_no_authority_field(), Relationship (+2 more)

### Community 446 - "Result"
Cohesion: 0.46
Nodes (7): a_client_built_for_oauth_reads_the_vault_whatever_the_entry_said(), a_stale_vault_token_never_overrides_a_configured_api_key(), an_api_key_equal_to_the_old_sentinel_is_still_an_api_key(), an_api_key_request_carries_no_oauth_client_surface(), an_oauth_request_carries_the_full_first_party_client_contract(), an_oauth_request_prepends_the_client_block_without_altering_the_preamble(), prompt()

### Community 447 - "Self"
Cohesion: 0.26
Nodes (9): column_names(), legacy_grant_without_an_owner_surface_fails_closed(), open_at_pre_129_schema(), BTreeSet, Connection, Path, String, versioned_rebuilds_preserve_every_pre_existing_column() (+1 more)
...
### Community 461 - "compose_authority"
Cohesion: 0.25
...
### Community 462 - "Value"
Cohesion: 0.32
Nodes (11): causal_containment_through_skill_context_dispatch(), make_skill(), malicious_body(), poisoned_skill_counterparty_denial_surfaces_via_escalation(), String, CeremonyError, install_mined_skill(), install_seed_skill() (+3 more)

### Community 463 - "Option"
Cohesion: 0.32
Nodes (8): OwnerApprovalAuditMetadata, OwnerApprovalScopeArtifact, ArtifactRef, Digest, Option, ReviewedActionScope, Self, Ulid
...
### Community 468 - "Ulid"
Cohesion: 0.40
Nodes (5): Phase 0: product and audience, Primary audience, Product, Secondary audience, Wrong-fit audience today
...
### Community 473 - "Error"
Cohesion: 0.25
Nodes (7): Acceptance Criteria, Authority sensitivity, Change: Ground the terminal assistant in the setup surface, Layer, Out of Scope, What Changes, Why

### Community 474 - "Result"
Cohesion: 0.25
Nodes (7): Account identity, Authorization, Decisions, Design: OpenAI Codex OAuth provider transport and tier routing, Inference transport, Risks, Wire contract (verified against pi's working implementation and the first-party client)

### Community 475 - "Self"
Cohesion: 0.25
Nodes (7): ADDED Requirements, direct-terminal-chat Delta, Requirement: An explicit local login command SHALL trigger provider OAuth, Requirement: Chat SHALL release its runtime before login starts, Scenario: Lifetime lock is reacquirable at login time, Scenario: One-shot chat never interprets login, Scenario: Owner triggers login from chat

### Community 476 - "String"
Cohesion: 0.25
Nodes (7): Acceptance Criteria, Bound dark-window exceptions, Dependencies, Invariant, Out of Scope, Problem/Context, Proposed Solution

### Community 477 - "Value"
Cohesion: 0.25
Nodes (7): MODIFIED Requirements, Requirement: Communication dark-window Allow MUST be forbidden, Responsibility contract, Scenario: A Deny default stays permitted, Scenario: A stored ineligible Allow rule is retired on open, Scenario: Activation refuses an Allow default for an ineligible action, Scenario: Draft action declares bounded Allow

### Community 478 - "Vec"
Cohesion: 0.25
Nodes (7): Acceptance Criteria, Dependencies, Invariant, Mine and match reusable authority by scope, Out of Scope, Problem/Context, Proposed Solution

### Community 479 - "Result"
Cohesion: 0.25
Nodes (8): Approved copy direction, Badge, Competitive bridge, Current-proof line, Headline, Primary action, Recognition line, Supporting copy

### Community 480 - "Global daily spend kill switch"
Cohesion: 0.25
Nodes (8): Current adopter qualification, Maya: the curious adopter, Personas, Phase 0: discovery and personas, Primary reader, Priya: the agent builder, Sam: the cautious power user, Secondary reader

### Community 481 - "Result"
Cohesion: 0.25
Nodes (8): Authority rail, Buttons, Claim ledger, Core components, Gate ledger, Instrument panel, OpenSpine mark, Policy layers and task grant

### Community 483 - "Timestamp"
Cohesion: 0.17
Nodes (11): 10. Document and record (authority-sensitive), 1. Rebase onto main after #128 archives, then re-derive deltas, 2. Persist the canonical review object, content-addressed and digest-bound, 3. Add a typed review lifecycle and principal-bound decision intents, 4. Narrow produces a new immutable digest, 5. Add an owner surface reference contract, 6. Add a renderer abstraction with Telegram and terminal implementations, 7. Add paused state and revalidated resume (+3 more)
...
### Community 485 - "Box"
Cohesion: 0.48
Nodes (4): every_transmitted_codex_element_participates_in_the_digest(), fingerprint_material(), fingerprint_parts(), oauth_fingerprint_digest()

### Community 486 - "Result"
Cohesion: 0.21
Nodes (5): DarkWindowConfig, DarkWindowDefault, required_scope_digest_of(), reviewed_scope_binding_derives_digest_from_values_and_validates(), StandingRuleManifest

### Community 489 - "Timestamp"
Cohesion: 0.22
Nodes (23): commissioned_grant_for_receipt(), CommissionReceipt, ensure_schema(), mark_worker_stranded_notified(), pending_worker_dispatches(), record_worker_commissioned(), ArtifactRef, Briefcase (+15 more)
...
### Community 497 - "Path"
Cohesion: 0.47
Nodes (3): migrateCandidateToProof(), migrateCapabilityMap(), VALID_STATES
...
Cohesion: 0.17
Nodes (11): ADDED Requirements, Lineage and eval store, MODIFIED Requirements, Requirement: Eval-verdict vocabulary MUST remain open and fitness/evidence optional, Requirement: Eval verdicts MUST bind their evaluation epochs and stale when any changes, Scenario: A case-executing verdict carries a reproducible ledger, Scenario: A changed compatibility epoch stales the verdict, Scenario: A changed reviewed scope or evidence set stales the verdict (+3 more)
...
### Community 532 - "F"
Cohesion: 0.29
Nodes (6): AD-135 persona route, Authority and scheduling, Design: Reflection miner worker boundary, Explicit boundaries, Output classes and positive steering, Scoped context and provenance

### Community 533 - "Formatter"
Cohesion: 0.29
Nodes (6): Acceptance Criteria, Add OpenAI Codex OAuth provider transport and tier routing, Dependencies, Out of Scope, Problem/Context, Proposed Solution

### Community 534 - "Into"
Cohesion: 0.29
Nodes (6): 1. Codex OAuth flow corrections, 2. ChatGPT backend Responses transport, 3. Login enablement and switching, 4. Tier routing configuration, 5. Examples, docs, verification (authority-sensitive: model provider access), Tasks
...
Cohesion: 0.29
Nodes (6): Acceptance Criteria, Dependencies, Out of Scope, Problem/Context, Proposed Solution, Unify approved and delegated effect execution

### Community 540 - "Vec"
Cohesion: 0.29
Nodes (6): MODIFIED Requirements, Requirement: Reusable delegation MUST validate independent action and implementation declarations, responsibility-contract Specification, Scenario: Descriptor and registered executor establish readiness, Scenario: Descriptor exists but executor is not registered, Scenario: Semantic descriptor exists but executor does not
...
### Community 543 - "Option"
Cohesion: 0.22
Nodes (15): run_preflight_verification_ping(), a_first_login_without_a_refresh_token_is_refused_and_stores_nothing(), a_pasted_authorization_code_completes_the_login_and_stores_the_credential(), a_probe_failure_never_echoes_a_vault_token(), a_probe_failure_redacts_even_a_short_api_key(), a_relogin_without_a_refresh_token_keeps_the_stored_one(), binding_an_unconfigured_provider_appends_it_with_the_named_model(), exchange_without_refresh_token() (+7 more)

### Community 546 - "Policy"
Cohesion: 0.33
Nodes (6): Change Log, Consequences, D-172 — A new guard ships only with a filled three-column reachability census, Decision, Rationale, Would change if
...
### Community 549 - "Requirement: ActionCatalog MUST enumerate every trusted-path carve-out around gate"
Cohesion: 0.33
...
### Community 552 - "Error"
Cohesion: 0.17
Nodes (11): Authority, containment, audit, and failure modes, Corrected current records, Design: separate generic capability, selected proof, and portability evidence, Migration, Renderer, The v2 schema shape, Trade-offs and rejected alternatives, Validator truth rules (TDD) (+3 more)
...
### Community 559 - "Self"
Cohesion: 0.33
Nodes (6): Consequences, D-145 — Gateway bearer token resolution with automatic 401 retry recovery, Decision, Rationale, Trade-offs, Would change if

### Community 560 - "String"
Cohesion: 0.33
Nodes (6): Consequences, D-146 — Protocol-neutral reviewed responsibility contract above standing rules, Decision, Rationale, Trade-offs, Would change if

### Community 561 - "String"
Cohesion: 0.33
Nodes (6): Consequences, D-150 — Platform comparisons settle build-versus-borrow: study and reproduce, never adopt or fork, Decision, Rationale, Trade-offs, Would change if
...
### Community 568 - "Value"
Cohesion: 0.17
Nodes (11): lyra-package Specification, Purpose, Requirement: Installation remains declarative, Requirement: Lyra is a named default package, Requirement: Memory is typed and scoped, Requirement: Personality carries no authority, Requirements, Scenario: Editing personality guidance (+3 more)

### Community 569 - "D-034 — `email.create_draft` is the one canonical action id; the qualified PRD §10.2 spelling is dropped"
Cohesion: 0.24
Nodes (12): canonical_catalog(), ActionCatalog, approval_narrowing_allowlist_is_explicit_and_fails_closed(), counterparty_classification_is_kernel_owned_and_fails_closed(), email_draft_has_a_reviewed_descriptor_and_a_registered_implementation(), every_delegation_descriptor_names_a_catalogued_action(), handler_registry_requires_explicit_classification(), non_delegable_catalog_is_exactly_the_root_only_set() (+4 more)

### Community 570 - "Result"
Cohesion: 0.29
Nodes (7): Requirement: ActionCatalog MUST enumerate every trusted-path carve-out around gate(), Scenario: An unregistered effectful action fails closed, Scenario: Each enumerated entry has a dedicated test, Scenario: Model activation is classified, Scenario: Model golden-set execution is classified, Scenario: Only declared non-effect reads may use the stub, Scenario: The carve-out set is finite and enumerated

### Community 571 - "Option"
Cohesion: 0.29
Nodes (7): Requirement: Unspecified actions MUST be denied, Scenario: Agent requests unknown action, Scenario: Catalogued effectful action has no executor, Scenario: Declared non-effect read retains the stub boundary, Scenario: Registered effectful paths cannot return success stubs, Scenario: Scope-matched admission does not widen the dispatch boundary, Scenario: Unknown ids are not stub-eligible
...
Cohesion: 0.21
Nodes (14): ActivationCommit, epoch_digests_match(), epoch_versions_match(), OwnerReviewApprovalCommit, ArtifactRef, Digest, Option, Result (+6 more)
...
### Community 576 - "Box"
Cohesion: 0.22
Nodes (10): concurrent_pending_claims_have_one_winner(), draft_request_fingerprint(), ensure_schema(), pending_request_fingerprint_migrates_and_fences_by_identity(), Connection, Digest, Result, String (+2 more)

### Community 577 - "Requirement: Dark-window defaults are durable and replay-safe"
Cohesion: 0.31
...
Cohesion: 0.18
Nodes (10): ADDED Requirements, Lyra package, Requirement: Installation remains declarative, Requirement: Lyra is a named default package, Requirement: Memory is typed and scoped, Requirement: Personality carries no authority, Scenario: Editing personality guidance, Scenario: Inspecting the source package (+2 more)
...
### Community 581 - "Ulid"
Cohesion: 0.20
Nodes (10): Requirement: A digest-bound decision MAY be submitted with a short digest token, Requirement: Decision refusals MUST be typed and enumerated, Requirement: Proposal copy MUST NOT outrun evidence, scope, or executor readiness, Requirement: Responsibility MUST remain a reference view rather than live authority, Requirements, Scenario: A callback token that does not match the stored digest, Scenario: Active responsibility executes another task, Scenario: Copy claims readiness without a registered executor (+2 more)
...
Cohesion: 0.20
Nodes (9): Declarative model, How Lyra is meant to grow, Installation direction, Local terminal conversation, Lyra, Package and runtime, Personality versus memory versus authority, Selected Gmail draft (+1 more)

### Community 589 - "Vec"
Cohesion: 0.20
Nodes (9): 1. Pin the current ceremony before replacing it, 2. Assemble a kernel-derived evaluation input, 3. Replace the judge with real structural checks, 4. Make replay execute cases, 5. Bind epochs and stale at read time, 6. Render owner copy from the ledger, 7. Prove the boundary end to end on the real path, 8. Document and record (authority-sensitive) (+1 more)

### Community 591 - "Option"
Cohesion: 0.60
Nodes (4): every_transmitted_element_participates_in_the_digest(), fingerprint_material(), fingerprint_parts(), oauth_fingerprint_digest()

### Community 592 - "Self"
Cohesion: 0.61
Nodes (8): a_differently_typed_value_on_a_shared_dimension_is_not_widening(), a_disagreeing_shared_dimension_is_disjoint_not_widening(), a_proposal_constraining_fewer_dimensions_widens_the_incumbent(), a_proposal_constraining_more_dimensions_does_not_widen(), an_identical_scope_does_not_widen(), dimensions(), instance(), workflow()

### Community 594 - "Timestamp"
Cohesion: 0.60
Nodes (5): build_authorization_url(), exchange_code(), oauth_login_fallback_accepts_manual_authorization_code_input(), refresh_token(), spec()

### Community 595 - "provenance"
Cohesion: 0.53
Nodes (4): build_authorization_url(), exchange_code(), refresh_token(), spec()

### Community 596 - "ArtifactId"
Cohesion: 0.35
Nodes (6): Bot, Arc, Self, String, TelegramBotState, Url
...
Cohesion: 0.33
Nodes (5): Acceptance Criteria, Dependencies, Problem/Context, Proposal: Implement the reflection miner, Proposed Solution

### Community 608 - "Requirement: Digest/brief format MUST remain a learnable default"
Cohesion: 0.33
Nodes (5): Add direct terminal chat with Onyx LFM2.5 inference, Change, Non-goals, Security boundary, Why

### Community 609 - "Result"
Cohesion: 0.46
Nodes (7): approve_callback(), approve_via_telegram_against(), MockServer, Ulid, state_with_callback_ack(), telegram_approval_from_a_foreign_chat_is_refused_without_burning_the_request(), telegram_cannot_approve_a_grant_bound_to_the_terminal_surface()

### Community 610 - "String"
Cohesion: 0.46
Nodes (7): artifact_ref(), owner_review_decision_audit_records_principal_and_intent(), owner_review_illegal_transition_is_refused(), owner_review_legal_transition_applies_and_is_idempotent(), owner_review_revoked_reachable_from_any_non_terminal_state(), owner_review_row_persists_and_round_trips(), ArtifactRef

### Community 612 - "opsx-archive.md"
Cohesion: 0.35
Nodes (10): a_digest_token_that_does_not_prefix_the_stored_digest_is_refused(), an_approval_receipt_reports_the_lifecycle_outcome_and_no_effect(), edit_is_refused_as_requiring_a_replacement_review(), kernel_refuses_a_widened_narrow_regardless_of_the_delta_parser(), persist(), OwnerReviewRequest, String, UnboundedReceiver (+2 more)
...
Cohesion: 0.32
Nodes (6): OwnerReviewNarrowError, OwnerReviewRequest, Result, ReviewedActionScope, Self, Ulid
...
Cohesion: 0.33
Nodes (6): Requirement: Approval-required decisions MUST not execute immediately, Requirement: Kernel-originated owner notifications are a trusted, audited path, Requirements, Scenario: Draft creation requires approval, Scenario: Kernel-origin action needs no approval but is audited, Scenario: Kernel sends a courtesy notice
...
### Community 637 - "Error"
Cohesion: 0.25
Nodes (7): Acceptance Criteria, Add channel-neutral responsibility review and lifecycle controls, Dependencies, Invariant, Out of Scope, Problem/Context, Proposed Solution
...
### Community 641 - "Value"
Cohesion: 0.25
Nodes (8): Requirement: Resume MUST revalidate compatibility before reactivating, Scenario: Concurrent resume taps are replay-safe, Scenario: Resume reactivates a still-current reviewed version, Scenario: Resume refuses a corrupt scope binding, Scenario: Resume refuses a drifted reviewed scope, Scenario: Resume refuses a superseded rule, Scenario: Resume refuses an expired rule, Scenario: Resume refuses an unavailable executor or connector

### Community 642 - "Vec"
Cohesion: 0.25
Nodes (7): a_widened_candidate_is_not_a_strict_narrowing(), narrower_or_equal(), ReviewedActionScope, ReviewedScopeNarrowError, BTreeMap, Result, Self
...
Cohesion: 0.07
Nodes (49): EffectOutcome, create_approved_draft(), gmail_create_draft_executor(), Result, handle_draft_approval_callback(), Result, Ulid, activate_approved_artifact() (+41 more)
...
### Community 663 - "ArtifactId"
Cohesion: 0.25
Nodes (7): Acceptance Criteria, Dependencies, Invariant, Make reusable-authority evaluation proposal-specific and evidence-backed, Out of Scope, Problem/Context, Proposed Solution
...
### Community 677 - "Requirement: Activated artifacts MUST survive a kernel restart"
Cohesion: 0.40
...
### Community 678 - "Ulid"
Cohesion: 0.13
Nodes (7): Store, WorkerRelayClaim, ConsumerError, IdempotentConsumer, LedgerEntry, PersistedConsumerState, Store

### Community 679 - "ArtifactId"
Cohesion: 0.40
Nodes (5): Consequences, D-092 — Nerve admission and replay are kernel-owned boundaries, Decision, Rationale, Would change if

### Community 680 - "String"
Cohesion: 0.40
...
### Community 719 - "briefcase_tests.rs"
Cohesion: 0.40
...
### Community 720 - "S"
Cohesion: 0.25
Nodes (7): Ok, HasherWriter<'a>, atomic_write(), cleanup_temp(), remove_durable(), sync_dir(), Write

### Community 721 - "Self"
Cohesion: 0.13
Nodes (14): ADDED Requirements, MODIFIED Requirements, Requirement: Erased counterparties MUST not retain scoped authority, Requirement: Exactly one compatible scoped rule MUST match before any budget moves, Requirement: Pending Gmail writes MUST fence retries before budget reservation, Scenario: Ambiguous overlap fails closed, Scenario: Delivery-unknown retry is fenced, Scenario: Erasure is checked before scoped reservation (+6 more)

### Community 722 - "String"
Cohesion: 0.40
...
### Community 724 - "Option"
Cohesion: 0.40
Nodes (5): Consequences, D-006 — Identity is not authority, Decision, Rationale, Would change if

### Community 733 - "ArtifactId"
Cohesion: 0.35
Nodes (7): counterparty_resolves_identity_but_no_principal(), handle_owner_bind(), IdentityResolver, IdentityResolver<'a>, local_cli_path_resolves_owner_device_and_principal(), owner_verified_path_resolves_owner_principal_and_relationship(), unknown_resolves_to_relationship_unknown_confidence_0_and_no_write()

### Community 734 - "Option"
Cohesion: 0.14
Nodes (13): 1. Use the SQLite erasure marker, with early checks and transactional enforcement, 2. Sweep owner-review and miner-produced rules through one generic scope representation, 3. Persist typed approval context and construct the existing evidence contract, 4. Make the pending-write fence a pre-reservation read, 5. Return a scoped responsibility receipt without confusing it with review lifecycle, 6. Make non-delegability catalog data, 7. Capability-map sequencing is a release gate, 8. Origination and existing owner-review transition boundaries (+5 more)

### Community 740 - "Option"
Cohesion: 0.40
...
### Community 754 - "EffectExecutorRegistry"
Cohesion: 0.40
...
### Community 759 - "route_ambiguity.rs"
Cohesion: 0.40
...
### Community 766 - "artifact_propose.rs"
Cohesion: 0.33
Nodes (3): Result, Vec, Store

### Community 767 - "SKILL.md"
Cohesion: 0.40
Nodes (5): Consequences, D-139 — Consolidation remains scoped proposed maintenance, Decision, Rationale, Would change if

### Community 768 - "SKILL.md"
Cohesion: 0.40
Nodes (5): Consequences, D-162 — Dark-window Allow eligibility is an explicit empty allowlist, enforced at activation and swept, Decision, Rationale, Would change if

### Community 769 - "SKILL.md"
Cohesion: 0.40
Nodes (5): Consequences, D-163 — Reusable-authority replay means executed cases derived from the proposal, Decision, Rationale, Would change if

### Community 770 - "opsx-apply.md"
Cohesion: 0.40
Nodes (5): Consequences, D-140 — Scheduled reflection grants compose from active artifacts, Decision, Rationale, Would change if

### Community 774 - "docs.schema.json"
Cohesion: 0.40
Nodes (5): Consequences, D-007 — Task grant is the final runtime authority, Decision, Rationale, Would change if

### Community 775 - "MockServer"
Cohesion: 0.40
Nodes (5): Consequences, D-147 — Codex OAuth spendability via the ChatGPT backend Responses transport, Decision, Rationale, Would change if

### Community 776 - "Store"
Cohesion: 0.40
Nodes (5): Consequences, D-148 — Owner-authored reasoning-tier provider routing, Decision, Rationale, Would change if

### Community 777 - "Duration"
Cohesion: 0.40
Nodes (5): Consequences, D-149 — Stored-credential re-bind, canonical-transport cutover, and vault-scoped refresh single-flight, Decision, Rationale, Would change if

### Community 778 - "pack.rs"
Cohesion: 0.40
Nodes (5): Consequences, D-151 — Composed responsibilities are authored above, and compiled onto, kernel objects, Decision, Rationale, Would change if

### Community 779 - "Vec"
Cohesion: 0.40
Nodes (5): Consequences, D-152 — Capability author is a contained proposer, separate from the evidence miner, Decision, Rationale, Would change if

### Community 780 - "MockServer"
Cohesion: 0.40
Nodes (5): Consequences, D-153 — "Both admission sources" means approval and the headless approved lane; scoped standing-rule admission stays #128, Decision, Rationale, Would change if

### Community 781 - "audit_support.rs"
Cohesion: 0.40
Nodes (5): Consequences, D-154 — Order-compared `TEXT` timestamp columns use one fixed-width canonical rendering, Decision, Rationale, Would change if

### Community 782 - "Connection"
Cohesion: 0.40
Nodes (5): Consequences, D-155 — Separate the reviewed-scope key from the compatibility drift epoch, Decision, Rationale, Would change if

### Community 787 - "Ulid"
Cohesion: 0.40
Nodes (5): Consequences, D-156 — Ambiguous scoped matches fail closed, Decision, Rationale, Would change if

### Community 788 - "Vec"
Cohesion: 0.40
Nodes (5): Consequences, D-157 — Map effect outcomes conservatively to standing-rule reservations, Decision, Rationale, Would change if

### Community 789 - "Result"
Cohesion: 0.40
Nodes (5): Consequences, D-011 — Approval must be digest-bound, Decision, Rationale, Would change if

### Community 790 - "Requirement: Digest/brief format MUST remain a learnable default"
Cohesion: 0.40
Nodes (5): Consequences, D-012 — Audit stores private payloads by encrypted/hash reference, Decision, Rationale, Would change if

### Community 791 - "digest_store.rs"
Cohesion: 0.40
Nodes (5): Consequences, D-164 — Evaluation verdicts bind their epochs and stale at read time, Decision, Rationale, Would change if

### Community 792 - "Option"
Cohesion: 0.10
Nodes (29): CompatibilityStatus, dependency_fingerprint_allows(), ensure_closure_triggers(), ensure_schema(), LearnedArtifact, LearnedArtifactErasure, LearnedArtifactIdentity, migrate_provenance_column() (+21 more)
...
### Community 826 - "Ulid"
Cohesion: 0.40
Nodes (4): Default character, Lyra, Memory model, Operating posture

### Community 827 - "Value"
Cohesion: 0.60
Nodes (4): client_id_for(), get_provider_spec(), OAuthProviderSpec, TokenResponse

### Community 828 - "Option"
Cohesion: 0.29
Nodes (7): Requirement: Owner review MUST be channel-neutral and digest-bound, Scenario: A decision is recorded against the reviewed digest, Scenario: A non-owner principal submits a decision, Scenario: A surface submits a decision outside the stored object, Scenario: An approvable review is too long for the channel, Scenario: Persisted review bytes are altered, Scenario: Review is rendered on another owner surface

### Community 829 - "Result"
Cohesion: 0.29
Nodes (7): Requirement: Owner review MUST have a typed lifecycle with validated transitions, Scenario: A pending review is approved, Scenario: A pending review is narrowed, Scenario: A pending review is rejected, Scenario: A review is revoked, Scenario: An expired review receives a decision, Scenario: An illegal lifecycle transition is attempted

### Community 830 - "Self"
Cohesion: 0.48
Nodes (5): ResponsibilityAssessment, ResponsibilityCompatibilityBinding, ResponsibilityDriftReason, ResponsibilityManifest, ResponsibilityStatus

### Community 831 - "String"
Cohesion: 0.29
Nodes (6): Acceptance Criteria, Dependencies, Out of Scope, Problem/Context, Proposed Solution, Separate generic capability, selected proof, and portability evidence in the checked roadmap

### Community 834 - "Mine and match reusable authority by scope"
Cohesion: 0.40
Nodes (4): Approach, Design: Backfill implemented capability specs, Dev-process restoration, Forward-looking requirement

### Community 835 - "Option"
Cohesion: 0.40
Nodes (4): Alternatives considered, Approach, Design: Artifact lifecycle slice, Key decisions

### Community 836 - "dispatch_artifact_nominate"
Cohesion: 0.27
Nodes (7): Router, shell_binary(), terminal_owner_status_reaches_device_through_real_shell(), post_webhook(), webhook_routes(), WebhookIngestBody, WebhookIngestResponse

### Community 837 - "Option"
Cohesion: 0.40
Nodes (4): Canon and audited sites, Design, Routing, Storage

### Community 838 - "HandlerFuture"
Cohesion: 0.40
Nodes (4): Authority-sensitive decisions, Design: Base/overlay compatibility, Failure behavior, Lifecycle state machine

### Community 839 - "TelegramConnector"
Cohesion: 0.40
...
### Community 868 - "OpenSpine layperson-first offer rerun"
Cohesion: 0.40
Nodes (4): MODIFIED Requirements, Requirement: OpenSpine core runtime objects MUST have explicit schemas, Scenario: Runtime object is added, Spec: Core runtime schemas

### Community 869 - "Lyra"
Cohesion: 0.40
Nodes (4): ADDED Requirements, kernel-registries Specification, Requirement: Reusable-delegation readiness MUST be an explicit catalog axis, Scenario: Known action lacks reusable implementation

### Community 870 - "Change: Implement first-run onboarding and a working setup wizard"
Cohesion: 0.40
Nodes (4): 1. Contract-first tests, 2. Schemas and pure functions, 3. Architecture records, 4. Verification

### Community 871 - "Decisions"
Cohesion: 0.40
Nodes (4): ADDED Requirements, direct-terminal-chat Delta, Requirement: The terminal assistant SHALL route setup to the CLI and refuse credential intake, Scenario: Shipped template grounds the setup surface

### Community 872 - "Option"
Cohesion: 0.40
Nodes (4): first-run-onboarding Delta, MODIFIED Requirements, Requirement: The chat loop MUST expose help and status commands, Scenario: Owner asks for help

### Community 873 - "Result"
Cohesion: 0.40
Nodes (4): 1. Local command surface, 2. Chat teardown handoff, 3. Verification, Tasks

### Community 874 - "String"
Cohesion: 0.33
Nodes (6): Requirement: Outstanding dark-window exceptions MUST be atomically bounded per reviewed rule, Scenario: A distinct request at the cap changes nothing, Scenario: A resolved exception frees its slot, Scenario: Concurrent requests cannot cross the final slot, Scenario: Many distinct requests yield one exception, Scenario: Repeating one request consumes no second slot

### Community 879 - "Duration"
Cohesion: 0.40
...
### Community 880 - "Result"
Cohesion: 0.19
Nodes (22): BundleNamePayload, foreign_principal_is_rejected(), handle_overlay_export(), handle_overlay_restore(), invoked_action_must_match_handler(), malformed_and_unknown_payload_fields_fail(), map_control_error(), mint_grant() (+14 more)
...
### Community 882 - "String"
Cohesion: 0.33
Nodes (6): Requirement: Pending dark-window exceptions MUST be staled by every lifecycle change, Scenario: A drifted context cannot spend a pre-drift waiver, Scenario: A superseded version leaves nothing fireable, Scenario: Drift stales open exceptions, Scenario: Recovery does not re-open terminal slots, Scenario: Revocation stales open exceptions

### Community 883 - "Vec"
Cohesion: 0.33
Nodes (6): Requirement: Standing rules are reviewed composition inputs, Scenario: A new version supersedes a paused rule, Scenario: Duplicate pause or revoke is replay-safe, Scenario: Paused rule is absent from live consultation, Scenario: Reviewed rule becomes a live input, Scenario: Revoked or expired rule is absent

### Community 884 - "Display"
Cohesion: 0.40
Nodes (4): devDependencies, @fission-ai/openspec, name, private

### Community 885 - "Error"
Cohesion: 0.40
Nodes (5): Bonuses, scarcity, and urgency, Final offer statement, Offer name, Phase 5: enhancement, Risk reversal

### Community 886 - "Formatter"
Cohesion: 0.40
Nodes (4): Crate map, The kernel/shell trust boundary, The pipeline, Why this is a personal AI system, not only a library

### Community 887 - "HashMap"
Cohesion: 0.22
Nodes (4): corrupt_scoped_target_with_valid_flat_source_fails_migration(), legacy_blob_with_tag_colliding_nonce_still_migrates(), legacy_blobs_migrate_under_system_scope(), legacy_migration_recovers_from_crash_between_write_and_cleanup()

### Community 888 - "propose.md"
Cohesion: 0.33
Nodes (5): Current installation, Lyra agent package, Memory and personality, Mental model, Package contents

### Community 889 - "SKILL.md"
Cohesion: 0.25
...
### Community 890 - "SKILL.md"
Cohesion: 0.33
Nodes (5): Compatibility, Design, Identity and memory, Nix-like mental model, Package boundary
...
### Community 914 - "index.astro"
Cohesion: 0.22
Nodes (7): ./AudienceExplainer.astro, ../components/AuthorityTrace.astro, ../components/LyraScenario.astro, base, canonical, header, ../styles/landing.css

### Community 915 - "Path"
Cohesion: 0.50
Nodes (3): 1. Schema and deterministic gate, 2. Persistence and standing-rule envelope, 3. Owner escalation and verification

### Community 916 - "PathBuf"
Cohesion: 0.33
Nodes (5): 1. Author the version 2 schema, migration, and corrected records, 2. Extend the validator with the new truth rules (TDD), 3. Update the renderer and regenerate the roadmap, 4. Verify, Tasks

### Community 917 - "opsx-propose.md"
Cohesion: 0.50
...
### Community 925 - "Requirement: Approval records MUST bind reviewed payloads and targets"
Cohesion: 0.50
...
### Community 926 - "SKILL.md"
Cohesion: 0.50
Nodes (4): Requirement: Scope-matched admission MUST supply only a kernel-resolved request to the executor, Scenario: Scope-matched admission hands over kernel-resolved values, Scenario: Shell cannot supply an executor-bound value, Scenario: Unconstructible context never reaches the executor

### Community 927 - "Requirement: Selection-token validation MUST occur inside gate() for token-requiring actions"
Cohesion: 0.50
Nodes (4): Requirement: Selection-token validation MUST occur inside gate() for token-requiring actions, Scenario: Consumption stays at dispatch, Scenario: Gate denies a missing, foreign, wrong-type, or expired token, Scenario: Gate validates a bound, live, unexpired token

### Community 928 - "Requirement: Shadow-mode grants MUST return a non-executable decision"
Cohesion: 0.50
Nodes (4): Requirement: Shadow-mode grants MUST return a non-executable decision, Scenario: Dispatch does not execute on effect_suppressed, Scenario: Shadow allow becomes effect_suppressed, Scenario: Shadow deny remains deny

### Community 929 - "Requirement: A fired dark-window exception MUST be accounted as an exception, not as quota"
Cohesion: 0.40
Nodes (5): Requirement: Communication dark-window Allow MUST be forbidden, Scenario: A Deny default stays permitted, Scenario: A stored ineligible Allow rule is retired on open, Scenario: Activation refuses an Allow default for an ineligible action, Scenario: Draft action declares bounded Allow

### Community 930 - "Result"
Cohesion: 0.40
Nodes (5): Requirement: Delegation evidence classes MUST remain distinct, Scenario: Approvals across two targets are not one pattern, Scenario: Non-pattern evidence is rendered, Scenario: One or duplicate approval is offered as a pattern, Scenario: Repeated approvals belong to a different context class

### Community 931 - "String"
Cohesion: 0.40
Nodes (5): Requirement: Reviewed scope matching MUST be protocol-neutral and fail closed, Scenario: Compatibility epoch and scope key move independently, Scenario: Declaration change moves only the compatibility epoch, Scenario: Persisted reviewed scope binding is corrupt, Scenario: Synthetic connector context changes

### Community 932 - "Result"
Cohesion: 0.40
Nodes (5): Requirement: Exactly one compatible scoped rule MUST match before any budget moves, Scenario: Ambiguous overlap fails closed, Scenario: Exactly one rule matches, Scenario: No rule matches the resolved scope, Scenario: Two accounts cannot form one pattern

### Community 935 - "Json"
Cohesion: 0.40
Nodes (5): Requirement: Quota and rate are independent atomic boundaries, Scenario: Concurrent admission cannot overspend, Scenario: Quota reaches its hard cap, Scenario: Rate reaches its hard cap, Scenario: Saturating one scoped rule does not spend another

### Community 939 - "Duration"
Cohesion: 0.40
...
### Community 943 - "TimerHandle"
Cohesion: 0.40
Nodes (5): Consequences, D-165 — Owner-facing evaluation copy is rendered from stored verdicts, Decision, Rationale, Would change if

### Community 944 - "editUrl"
Cohesion: 0.40
Nodes (4): Gate, Gotchas, openspine, Where to look

### Community 945 - "Option"
Cohesion: 0.40
...
### Community 946 - "Result"
Cohesion: 0.43
Nodes (4): Option, Ulid, Vec, Store
...
### Community 948 - "Store"
Cohesion: 0.38
Nodes (4): empty_session_policy(), Constraints, Policy, SessionPolicy

### Community 949 - "String"
Cohesion: 0.38
Nodes (5): Digest, Result, StandingRuleManifest, Ulid, Store

### Community 952 - "tree.rs"
Cohesion: 0.15
Nodes (28): atomic_rename_noreplace(), Cleanup, create_dir(), create_temp_dir(), ensure_absent(), io_err(), is_eloop(), mutation_or_io() (+20 more)

### Community 954 - "ADDED Requirements"
Cohesion: 0.33
Nodes (3): legacy_owner_review_binding_digest_is_stable_for_schema_additions(), legacy_owner_review_fixture(), OwnerReviewRequest

### Community 955 - "Delegation & containment"
Cohesion: 0.83
Nodes (3): forbid(), require(), check-omp-ceremony.sh script

### Community 956 - "SKILL.md"
Cohesion: 0.50
Nodes (3): Build and prove it works, Configure a real server, Talk to Lyra

### Community 957 - "content-assets.mjs"
Cohesion: 0.50
Nodes (3): exclude, extends, include

### Community 959 - "ArtifactRef"
Cohesion: 0.50
Nodes (3): Deviations, Discovered edge cases, Questions for review

### Community 970 - "Vec"
Cohesion: 0.50
Nodes (4): Requirement: Decision intents MUST map onto the digest-bound decision sets, Scenario: A decision intent is gated by the reviewed decision set, Scenario: A lifecycle intent is gated by the reviewed control set, Scenario: Inspect is read-only and causes no transition

### Community 971 - "Option"
Cohesion: 0.50
Nodes (4): Requirement: Reusable delegation MUST validate independent action and implementation declarations, Scenario: Descriptor and registered executor establish readiness, Scenario: Descriptor exists but executor is not registered, Scenario: Semantic descriptor exists but executor does not

### Community 972 - "Result"
Cohesion: 0.50
Nodes (4): Requirement: Trusted action context MUST be resolved by the kernel, Scenario: Counterparty is unresolved, Scenario: Kernel constructs the context before consulting reusable input, Scenario: Opaque shell payload cannot become a resolved context
...
### Community 979 - "Value"
Cohesion: 0.38
Nodes (10): compose_scheduled_grant(), derive_repeated_approval_observation(), find_active_grant_by_route(), reflection_miner_tick(), ArtifactRef, Duration, Option, Result (+2 more)
...
Cohesion: 0.18
Nodes (10): 1. Rebase and re-derive before implementation, 2. Erased-counterparty admission and sweep, 3. Typed approval evidence and miner cutover, 4. Pending-write retry fence, 5. Responsibility receipt and catalog boundary, 6. Reachability census and mutation killers, 7. Specs, verification, capability sequencing, residuals, Miner grouping mutation evidence (captured before restoring production) (+2 more)

### Community 982 - "Result"
Cohesion: 0.11
Nodes (33): DispatchError, Error, ArtifactNominatePayload, dispatch_artifact_nominate(), Option, Result, String, Value (+25 more)

### Community 983 - "String"
Cohesion: 0.33
Nodes (5): concurrent_lifecycle_intents_write_one_transition_audit(), Store, T, Vec, run_pair()

### Community 985 - "Vec"
Cohesion: 0.67
Nodes (3): Requirement: Compatibility drift or unavailable resolution MUST require re-review, Scenario: Connector instance disappears, Scenario: Drift is observed before the effect, not after

### Community 986 - "Option"
Cohesion: 0.67
Nodes (3): Requirement: Narrow MUST create a new immutable review digest, Scenario: A narrowed review is confused with the original, Scenario: Narrow narrows one reviewed dimension

### Community 987 - "Connection"
Cohesion: 0.67
Nodes (3): Requirement: Owner review MUST expose post-use receipts, Scenario: Receipt describes only the committed lifecycle outcome, Scenario: Receipt for a replayed decision claims no new effect

### Community 990 - "Failure surfacing & operations"
Cohesion: 0.67
...
### Community 992 - "Vec"
Cohesion: 0.31
Nodes (7): a_held_lock_degrades_to_a_reportable_vault_rather_than_an_error(), a_new_data_root_reports_no_encrypted_state(), a_populated_data_root_is_detected_so_no_new_artifact_key_is_minted(), an_empty_vault_directory_reports_no_encrypted_state(), an_existing_kernel_database_is_detected(), config_with_data_dir(), refresh_leaves_an_unavailable_vault_unavailable_without_a_configuration()

### Community 994 - "TelegramConnector"
Cohesion: 0.67
...
Cohesion: 0.67
Nodes (3): Requirement: Every effectful action MUST pass through gate(), Scenario: Agent requests external read, Scenario: Every carve-out is mediated or enumerated

### Community 1034 - "provenance"
Cohesion: 0.67
...
### Community 1035 - "head"
Cohesion: 0.67
Nodes (3): Requirement: Gate decisions MUST use task grant precedence, Scenario: Action appears in allowed and approval-required lists, Scenario: Action appears in allowed and denied lists

### Community 1036 - "Requirement: Compatibility MUST fail closed for dangling learned references"
Cohesion: 0.67
...
### Community 1038 - "State"
Cohesion: 0.67
Nodes (3): Requirement: Overlay evaluation MUST NOT grant or activate authority, Scenario: A passing evaluation changes no runtime authority, Scenario: Replay causes no external effect

### Community 1039 - "StatusCode"
Cohesion: 0.67
...
### Community 1063 - "String"
Cohesion: 0.06
Nodes (32): id(), ArtifactRef, Option, Result, String, Ulid, Store, ActionCatalog (+24 more)

### Community 1087 - "Requirement: Worker supervision MUST reset authority on failure (AD-100)"
Cohesion: 0.42
Nodes (8): approve_callback(), learned_route(), nomination_owner_tap_persists_nominated_status_and_audit(), nomination_rejects_persona_kind_without_compatible_learned_artifact(), nomination_requires_explicit_depersonalized_assertion(), MockServer, Ulid, telegram_ok()

### Community 1123 - "ArtifactRef"
Cohesion: 0.60
Nodes (5): load_keyed(), load_registry_into(), ArtifactLoadError, load_registry_into(), load_yaml_dir()

### Community 1157 - "Duration"
Cohesion: 0.50
Nodes (3): Result, Vec, Store

### Community 1158 - "Error"
Cohesion: 0.40
...
### Community 1253 - "D-102 — Worker results relay under the delivery ack policy"
Cohesion: 0.40
Nodes (5): Consequences, D-102 — Worker results relay under the delivery ack policy, Decision, Rationale, Would change if

### Community 1254 - "D-158 — Standing rules hold gate-time scope bindings; responsibility manifests remain views"
Cohesion: 0.40
Nodes (5): Consequences, D-158 — Standing rules hold gate-time scope bindings; responsibility manifests remain views, Decision, Rationale, Would change if

### Community 1255 - "D-159 — Outstanding dark-window exceptions are bounded per reviewed rule version"
Cohesion: 0.40
Nodes (5): Consequences, D-159 — Outstanding dark-window exceptions are bounded per reviewed rule version, Decision, Rationale, Would change if

### Community 1256 - "D-160 — The exception cap and the fired-token binding answer different questions"
Cohesion: 0.40
Nodes (5): Consequences, D-160 — The exception cap and the fired-token binding answer different questions, Decision, Rationale, Would change if

### Community 1257 - "D-161 — A fired exception is accounted as an exception, not as quota"
Cohesion: 0.40
Nodes (5): Consequences, D-161 — A fired exception is accounted as an exception, not as quota, Decision, Rationale, Would change if

### Community 1263 - "D-015 — Phase 1 should avoid final email send"
Cohesion: 0.40
Nodes (5): Consequences, D-015 — Phase 1 should avoid final email send, Decision, Rationale, Would change if

### Community 1344 - "Store"
Cohesion: 0.36
Nodes (4): PauseStandingRuleOutcome, Option, Result, Store

### Community 1345 - "String"
Cohesion: 0.25
Nodes (7): Capabilities, Dependencies, Modified Capabilities, New Capabilities, Out of Scope, What Changes, Why

### Community 1350 - "Value"
Cohesion: 0.40
...
### Community 1351 - "String"
Cohesion: 0.36
Nodes (7): plan_preview_records_telegram_failure_counter_on_send_error(), plan_preview_records_telegram_success_counter(), plan_proposal_budget_exhaustion_persists_no_request(), plan_propose_approve_rederives_gate_and_resolves(), proposed_plan_fixture(), MockServer, tampered_plan_artifact_is_refused_at_approval_callback()

### Community 1352 - "standing-rules Specification"
Cohesion: 0.40
...
### Community 1353 - "Requirement: Event bus subscription types MUST be explicit schemas"
Cohesion: 0.29
Nodes (6): MODIFIED Requirements, Requirement: Repeated approvals MUST be derived from scoped audit evidence, Scenario: Duplicate decision rows do not satisfy the threshold, Scenario: Payload variation remains separate from request shape, Scenario: Repeated approvals remain proposed, Scenario: Two context classes cannot form one pattern

### Community 1355 - "Connection"
Cohesion: 0.57
Nodes (6): at(), every_rendering_has_the_same_width(), round_trips_through_parse(), sql_timestamp(), trimmed_trailing_zeros_do_not_invert_the_order(), whole_second_sorts_before_a_later_instant_in_the_same_second()

### Community 1356 - "Result"
Cohesion: 0.70
Nodes (4): atomic_grant_and_briefcase_persists_both_on_success(), atomic_grant_and_briefcase_rolls_back_on_briefcase_failure(), minimal_briefcase(), Briefcase

### Community 1357 - "Ulid"
Cohesion: 0.40
Nodes (5): Consequences, D-166 — Channel-neutral owner review is an immutable decision record, not a channel authority, Decision, Rationale, Would change if

### Community 1361 - "Requirement: Route resolution schemas MUST represent ambiguity"
Cohesion: 0.40
Nodes (5): Consequences, D-167 — Counterparty erasure is a store-level admission predicate swept over stored rules, Decision, Rationale, Would change if

### Community 1368 - "ArtifactRef"
Cohesion: 0.40
Nodes (5): Consequences, D-168 — Repeated-approval evidence is typed and derived, never a raw row count, Decision, Rationale, Would change if

### Community 1369 - "Connection"
Cohesion: 0.50
Nodes (3): ReflectionProposal, Result, Value

### Community 1370 - "Option"
Cohesion: 0.50
Nodes (3): ADDED Requirements, Requirement: Catalog non-delegability MUST be explicit, Scenario: Final send is catalog-denied
...
### Community 1374 - "Option"
Cohesion: 0.40
Nodes (5): Consequences, D-170 — Owner approval mints a fresh activation grant rather than reusing the proposer's, Decision, Rationale, Would change if

### Community 1375 - "Store"
Cohesion: 0.40
Nodes (5): Consequences, D-171 — Lifecycle refusals surface as refusals, never as successful or replayed decisions, Decision, Rationale, Would change if

### Community 2460 - "atomic_write"
Cohesion: 0.13
Nodes (9): Sha256, Digest, digest_from_hash(), digest_of_bytes_hashes_raw_content_directly(), digest_of_is_a_pinned_golden_value(), digest_round_trips_through_serde(), HasherWriter, InvalidDigest (+1 more)

## Knowledge Gaps
- **3738 isolated node(s):** `autoresearch.sh script`, `ReadThreadPayload`, `ConversationClaimGuard<'a>`, `ArtifactStore`, `OnboardingState` (+3733 more)
...
- **Why does `AppState` connect `config.rs` to `D-005 — Private-data shell must be contained`, `handle_owner_update`, `D-023 — OpenSpine is the substrate; Lyra is a product built on it`, `artifact_loader.rs`, `D-024 — OpenSpec is the development/change-management layer, not the runtime`, `banner`, `.put`, `String`, `ProposedArtifact`, `content-modules.mjs`, `Reflection & product surface`, `Requirements`, `model_swap.rs`, `opsx-explore.md`, `D-040 — Pending (pre-approval) `ActionRequest`s are persisted in a new `action_requests` table`, `ApprovalRecord`, `opsx-propose.md`, `AppState`, `D-044 — Approved draft creation dispatches kernel-side; no new shell spawn`, `StoreError`, `Requirements`, `D-014 — Bootstrap/setup secrets bypass shell/model context`, `Proposal: Define grant chain and modes`, `ArtifactId`, `Requirements`, `String`, `Requirements`, `ADDED Requirements`, `D-032 — Kernel↔shell transport is HTTP/JSON with a per-task bearer token`, `ADDED Requirements`, `effect_paths.rs`, `Requirements`, `Requirements`, `retry_worker.rs`, `Proposal: Implement identity store and principal`, `ADDED Requirements`, `compose_authority`, `tsconfig.json`, `Error`, `String`, `check.sh`, `Ok`, `D-032 — Kernel↔shell transport is HTTP/JSON with a per-task bearer token`, `Proposal: Implement digest-bound draft approval`, `Value`, `Proposal: Implement selected-thread email preview slice`, `Result`, `Result`, `opsx-archive.md`, `D-051 — The agent-OS canon (AD-001..153) is decomposed into a dependency-edged change sequence; the stale later-changes placeholders are superseded or subsumed`, `Telegram owner-control setup (Phase 1)`, `Result`, `Requirement: Selection tokens MUST be single-use, expiring, and scope-fixed`, `SKILL.md`, `SKILL.md`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `digest_of()` connect `Error` to `GmailConnector`, `String`, `client.rs`, `Skills & workflows`, `Requirements`, `model_swap.rs`, `ActionId`, `AppState`, `atomic_write`, `OpenSpine Agent-OS Design Log`, `D-013 — Dynamic behavior easy; dynamic authority hard`, `String`, `properties`, `ADDED Requirements`, `Ulid`, `Requirements`, `Proposal: Implement identity store and principal`, `Box`, `Proposal: Implement selected-thread email preview slice`, `Result`, `opsx-archive.md`, `Vec`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `Timestamp` connect `ProposedArtifact` to `D-005 — Private-data shell must be contained`, `.new`, `.default`, `banner`, `.put`, `String`, `client.rs`, `content-modules.mjs`, `Reflection & product surface`, `Requirements`, `D-040 — Pending (pre-approval) `ActionRequest`s are persisted in a new `action_requests` table`, `D-044 — Approved draft creation dispatches kernel-side; no new shell spawn`, `Option`, `AppState`, `.sweep_expired_grants`, `ArtifactId`, `String`, `ADDED Requirements`, `String`, `architecture.md`, `Store`, `explore.md`, `OpenSpine kernel↔shell HTTP contract`, `Ok`, `D-032 — Kernel↔shell transport is HTTP/JSON with a per-task bearer token`, `Proposal: Backfill implemented capability specs`, `SKILL.md`, `Timestamp`, `Option`, `Requirement: Selection tokens MUST be single-use, expiring, and scope-fixed`, `artifact_propose.rs`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Are the 130 inferred relationships involving `test_state()` (e.g. with `artifact_propose_rejects_non_proposed_lifecycle()` and `artifact_propose_rejects_non_proposed_persona_kind()`) actually correct?**
  _`test_state()` has 130 INFERRED edges - model-reasoned connections that need verification._
- **What connects `autoresearch.sh script`, `ReadThreadPayload`, `ConversationClaimGuard<'a>` to the rest of the system?**
...
- **Should `GmailConnector` be split into smaller, more focused modules?**

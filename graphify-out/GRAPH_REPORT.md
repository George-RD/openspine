...
## Corpus Check
- 548 files · ~429,137 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7595 nodes · 9837 edges · 1684 communities (548 shown, 1136 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1320 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9bb88afb`
...
## Communities (1684 total, 1136 thin omitted)
...
### Community 1 - ".new"
Cohesion: 0.07
Nodes (20): Bot, Update, Url, configured_owner_text_message_is_verified(), invalid_candidate_bot_token_is_rejected_without_replacing_live_bot(), missing_sender_is_ignored(), non_text_update_from_owner_is_ignored(), owner_envelope_is_verified_with_owner_id_match_method() (+12 more)

### Community 2 - "event.rs"
Cohesion: 0.17
Nodes (4): ActionCatalog, ActionEgressDeclaration, ActionId, EffectPath
...
Cohesion: 0.07
Nodes (49): accepted_digest_tamper_invalidates(), base_namespace_is_not_treated_as_learned(), dangling_learned_route_is_orphaned_and_excluded(), insert_agent(), insert_pack(), insert_route(), insert_workflow(), learned() (+41 more)
...
Cohesion: 0.08
Nodes (68): draft_command_composes_email_preview_grant_whose_pending_ref_is_derived_message(), draft_command_for_a_missing_thread_mints_no_grant(), draft_command_for_a_real_thread_composes_a_bound_selection_grant(), draft_command_is_refused_without_the_unsafe_flag_under_process_driver(), draft_command_with_gmail_api_error_audits_no_event_received(), draft_command_without_gmail_configured_is_a_no_op(), artifact_propose_persists_and_sends_approval_button(), artifact_propose_rejects_duplicate_id_version() (+60 more)
...
Cohesion: 0.08
Nodes (46): bind_email_identity(), email_counterparty_resolves_to_bound_identity_when_address_is_bound(), email_counterparty_stays_unresolved_when_address_is_unbound(), minimal_grant(), mint_topup_grant(), post_topup(), topup_granted_grant_mutates_briefcase_atomically(), topup_oversized_section_key_is_rejected_without_persistence() (+38 more)

### Community 14 - "actions.rs"
Cohesion: 0.06
Nodes (50): canonical_json(), Briefcase, grant(), GrantLimits, GrantMode, legacy_missing_chain_defaults_but_fails_closed(), legacy_without_thread_id_defaults_to_none(), round_trip_and_mac() (+42 more)
...
Cohesion: 0.11
Nodes (59): Constraints, Policy, ArtifactId, Option, String, Vec, SessionPolicy, AuthorityInput (+51 more)
...
Cohesion: 0.12
Nodes (24): BuildEnvelopeFn, GrantBindingFn, PreflightFn, RouteGuardFn, complete_task_and_wake(), dispatch_task_wake(), reattempt_handed_off(), recover_timer_dispatches() (+16 more)
...
Cohesion: 0.12
Nodes (29): connector_failure_batches_and_is_audited(), counter_persistence_failure_is_durably_batched_as_resource(), immediate_failure_cannot_enter_digest_lane(), test_state_with_telegram(), digest_detail_corrupt_blob_surfaces_resource_without_leak(), digest_detail_immediate_success_outcome_audit_failure_is_delivery_unknown_and_no_retry(), digest_detail_missing_blob_surfaces_resource_without_leak(), digest_detail_not_found_is_truthful() (+21 more)
...
Cohesion: 0.15
Nodes (5): ActionHandler, ActionHandlerRegistry, handle_artifact_nominate(), handle_artifact_propose(), handle_plan_propose()
...
Cohesion: 0.13
Nodes (12): effect_defaults_to_allow_when_omitted(), owner_route(), round_trips_through_serde(), Route, route_can_be_a_deny_route(), RouteEffect, RouteResolution, ArtifactId (+4 more)
...
Cohesion: 0.06
Nodes (50): client_error(), get_briefcase(), post_topup(), deny_limit_exceeded(), GenerateRequestBody, GenerateResponseBody, post_model_generate(), template_id_for_agent() (+42 more)
...
Cohesion: 0.20
Nodes (16): counterparty_resolves_identity_but_no_principal(), handle_owner_bind(), IdentityResolver, IdentityResolver<'a>, owner_verified_path_resolves_owner_principal_and_relationship(), Option, Result, Self (+8 more)
...
Cohesion: 0.15
Nodes (12): PostApprovalFuture, create_approved_draft(), finalize_nomination(), NominationAssertion, reinstate_artifact(), handle_activate_artifact(), handle_create_approved_draft(), handle_nominate_upstream() (+4 more)
...
### Community 119 - "attrs"
Cohesion: 0.20
Nodes (12): String, truncate_for_telegram(), truncate_with_notice(), call_with_connector(), dispatch_plan_preview(), ProposalError, propose_draft_creation(), dispatch_lyra_preview() (+4 more)
...
Cohesion: 0.19
Nodes (18): Future, Output, Pin, Send, GmailFailureClass, emit_preflight_failure(), email_build_envelope(), email_grant_binding() (+10 more)
...
Cohesion: 0.08
Nodes (32): PostApprovalHandler, handle_draft_approval_callback(), handle_plan_approval_callback(), resolve_approved_plan(), handle_resolve_approved_plan(), resolve_post_approval_handler(), handoff_complete(), run() (+24 more)
...
Cohesion: 0.19
Nodes (9): CanonicalValue, digest_from_hash(), digest_of(), digest_of_bytes_hashes_raw_content_directly(), digest_of_is_a_pinned_golden_value(), HasherWriter, Value, test_digest_matches_hash() (+1 more)
...
Cohesion: 0.32
Nodes (11): ActionRequestBody, ActionResponseBody, cleanup_pre_effect_reservations(), FailureSurface, guard_connector_dispatch(), mediate_and_dispatch_action_with_attribution(), mediate_and_dispatch_action_with_attribution_and_token(), post_actions() (+3 more)
...
Cohesion: 0.05
Nodes (79): approved_plan_digest_allows_through_gate(), argument_mutation_denied_when_summary_is_unchanged(), mutated_plan_after_approval_is_denied_at_gate(), step(), digest_is_order_argument_and_schema_sensitive(), digest_matches_serialized_plan_payload(), Plan, PlanApprovalQuestion (+71 more)

### Community 159 - "D-011 — Approval must be digest-bound"
Cohesion: 0.24
Nodes (10): build_state(), build_state_with_store(), repo_lyra_dir(), test_state_with_store(), router(), commissioned_worker_reports_and_master_relays_through_real_shell(), parent_briefcase(), parent_grant_for_commission() (+2 more)
...
Cohesion: 0.15
Nodes (12): Consequences, Consequences, D-090 — Workflow manifests are digest-bound at run start; production driving is deferred, D-099 — Connector breakers use sliding-window failure accounting, Decision, Decision, Decision Index, Lyra PRD Companion — Decisions Log (+4 more)
...
Cohesion: 0.23
Nodes (8): action_id_qualifier_is_part_of_identity(), action_id_serializes_as_bare_string(), ActionRequest, DenialReason, EffectPathClass, GateDecision, SkillAttribution, SkillAttributionKind
...
Cohesion: 0.21
Nodes (3): BreakerState, CircuitBreaker, VecDeque
...
## Knowledge Gaps
- **2296 isolated node(s):** `set.sh script`, `autoresearch.sh script`, `TelegramReplyPayload`, `ReadThreadPayload`, `ArtifactNominatePayload` (+2291 more)
...
- **Why does `digest_of()` connect `D-004 — Every effectful action goes through `gate()`` to `D-005 — Private-data shell must be contained`, `config.rs`, `OpenSpine`, `client.rs`, `actions.rs`, `Design: Digest-bound draft approval`, `Requirements`, `Proposal: Define core runtime schemas`, `content.d.ts`, `ADDED Requirements`, `attrs`, `Proposal: Implement gate action API`, `ActionId`, `AppState`, `SKILL.md`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `handle_owner_update()` connect `config.rs` to `decisions.md`, `D-011 — Approval must be digest-bound`, `.default`, `banner`, `openspine-decision-log.md`, `client.rs`, `policy.rs`, `Proposal: Define core runtime schemas`, `action.rs`, `Lifecycle`, `D-042 — Reply recipient is kernel-derived, never shell-supplied: newest non-owner sender, matched against a configured mailbox address`, `ADDED Requirements`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `digest_of_bytes()` connect `digest.rs` to `D-004 — Every effectful action goes through `gate()``, `artifact_activation_tests.rs`, `.default`, `GmailConnector`, `Design: Authority composition`, `config.rs`, `.put`, `OpenSpine`, `client.rs`, `policy.rs`, `Requirements`, `ADDED Requirements`, `Proposal: Implement selected-thread email preview slice`, `AuditEvent`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Are the 89 inferred relationships involving `handle_owner_update()` (e.g. with `draft_command_composes_email_preview_grant_whose_pending_ref_is_derived_message()` and `draft_command_for_a_missing_thread_mints_no_grant()`) actually correct?**
  _`handle_owner_update()` has 89 INFERRED edges - model-reasoned connections that need verification._
- **Are the 84 inferred relationships involving `owner_update()` (e.g. with `draft_command_composes_email_preview_grant_whose_pending_ref_is_derived_message()` and `draft_command_for_a_missing_thread_mints_no_grant()`) actually correct?**
...
- **Are the 67 inferred relationships involving `test_state_with_telegram()` (e.g. with `lyra_ui_preview_sends_telegram_reply_to_grant_bound_chat()` and `lyra_ui_preview_truncates_long_body_to_utf16_limit()`) actually correct?**

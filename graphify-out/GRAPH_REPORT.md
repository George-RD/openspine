# Graph Report - implement-persona-binding-and-headless-lanes  (2026-07-19)

## Corpus Check
- 550 files · ~434,168 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7597 nodes · 10556 edges · 1570 communities (561 shown, 1009 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1330 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b5b83ae6`
...
2. `handle_owner_update()` - 99 edges
3. `test_state()` - 88 edges
4. `owner_update()` - 87 edges
5. `TaskGrant` - 80 edges
6. `test_state_with_telegram()` - 72 edges
7. `Timestamp` - 65 edges
8. `gate()` - 55 edges
9. `digest_of_bytes()` - 43 edges
10. `ActionId` - 41 edges
...
- 3-file cycle: `crates/openspine-kernel/src/api/actions.rs -> crates/openspine-schemas/src/grant.rs -> crates/openspine-kernel/src/workflow.rs -> crates/openspine-kernel/src/api/actions.rs`
...
- 4-file cycle: `crates/openspine-kernel/src/api/actions.rs -> crates/openspine-kernel/src/pipeline/mod.rs -> crates/openspine-kernel/src/connector_reality.rs -> crates/openspine-kernel/src/workflow.rs -> crates/openspine-kernel/src/api/actions.rs`
- 4-file cycle: `crates/openspine-kernel/src/api/actions.rs -> crates/openspine-kernel/src/pipeline/mod.rs -> crates/openspine-schemas/src/grant.rs -> crates/openspine-kernel/src/workflow.rs -> crates/openspine-kernel/src/api/actions.rs`
- 5-file cycle: `crates/openspine-kernel/src/api/actions.rs -> crates/openspine-kernel/src/pipeline/mod.rs -> crates/openspine-kernel/src/pipeline/message_notify.rs -> crates/openspine-schemas/src/grant.rs -> crates/openspine-kernel/src/workflow.rs -> crates/openspine-kernel/src/api/actions.rs`
- 5-file cycle: `crates/openspine-kernel/src/api/actions.rs -> crates/openspine-kernel/src/pipeline/mod.rs -> crates/openspine-kernel/src/connectors.rs -> crates/openspine-kernel/src/connector_reality.rs -> crates/openspine-kernel/src/workflow.rs -> crates/openspine-kernel/src/api/actions.rs`

## Communities (1570 total, 1009 thin omitted)
...
### Community 1 - ".new"
Cohesion: 0.16
Nodes (8): configured_owner_text_message_is_verified(), invalid_candidate_bot_token_is_rejected_without_replacing_live_bot(), missing_sender_is_ignored(), non_text_update_from_owner_is_ignored(), owner_message_in_a_group_chat_is_ignored_not_routed(), unknown_telegram_user_is_ignored_not_routed(), update(), verify_update()

### Community 2 - "event.rs"
Cohesion: 0.10
Nodes (10): action_id_qualifier_is_part_of_identity(), action_id_serializes_as_bare_string(), ActionCatalog, ActionEgressDeclaration, ActionId, EffectPath, EffectPathClass, SkillAttribution (+2 more)

### Community 3 - "handle_owner_update"
Cohesion: 0.09
Nodes (47): artifact_key_bytes(), artifact_key_round_trips_bytes(), Config, ConfigError, default_kernel_bind(), default_lyra_dir(), example_configs_parse_against_the_real_schema(), gmail_client_secret() (+39 more)
...
Cohesion: 0.06
Nodes (53): accepted_digest_tamper_invalidates(), base_namespace_is_not_treated_as_learned(), dangling_learned_route_is_orphaned_and_excluded(), insert_agent(), insert_pack(), insert_route(), insert_workflow(), learned() (+45 more)

### Community 6 - "artifact_loader.rs"
Cohesion: 0.07
Nodes (33): DeserializeOwned, (), ApprovalStepInputs, ArtifactRef, bool, Digest, digest_inputs(), EntryBindingInputs (+25 more)

### Community 7 - "config.rs"
Cohesion: 0.08
Nodes (58): handle_owner_update(), Result, audit_payload_refs(), malformed_secret_command_is_reserved_from_normal_pipeline(), non_owner_update_is_ignored_and_audited_without_a_grant(), owner_update_composes_authority_and_persists_a_grant_bound_to_the_chat(), owner_update_grant_pins_original_message_raw_ref_through_to_audit(), Store (+50 more)
...
### Community 10 - ".put"
Cohesion: 0.16
Nodes (8): consult_standing_rule_gate(), StandingRuleGateOutcome, epoch_nanos_to_timestamp(), PendingScheduleCtx, StandingRule, StandingRulePendingAction, Store, timestamp_to_epoch_nanos()

### Community 11 - "ProposedArtifact"
Cohesion: 0.16
Nodes (27): seed_owner_history(), artifact_propose_persists_and_sends_approval_button(), artifact_propose_rejects_duplicate_id_version(), artifact_propose_rejects_malformed_yaml(), artifact_propose_rejects_non_proposed_lifecycle(), artifact_propose_rejects_persona_kind(), artifact_propose_rejects_template_kind(), artifact_propose_rejects_unknown_kind() (+19 more)
...
Cohesion: 0.10
Nodes (17): prune_non_highest_active_preserves_persona_typed_and_source_entries(), Ok, Sha256, CanonicalValue, CanonicalValue<'a>, Digest, digest_from_hash(), digest_of() (+9 more)
...
Cohesion: 0.09
Nodes (68): AuthorityInput, AuthorityOutcome, compose_authority(), mint_task_token(), narrow(), AgentManifest, Box, CapabilityPack (+60 more)
...
Cohesion: 0.06
Nodes (71): BTreeSet, apply_top_up(), apply_top_up_for_grant(), apply_top_up_for_grant_atomic(), BriefcaseKernelError, email_address_hash(), grant_view(), pack_for_pipeline() (+63 more)
...
Cohesion: 0.10
Nodes (32): classification_rank(), headless_route_guard(), AccountRole, ActorHint, ChannelTrust, Connector, DataClassification, EventEnvelope (+24 more)

### Community 27 - "Lifecycle"
Cohesion: 0.11
Nodes (25): BuildEnvelopeFn, ArtifactRef, Option, Result, Vec, run_pipeline(), run_pipeline_with_envelope(), headless_lane() (+17 more)
...
Cohesion: 0.20
Nodes (5): DeadLetterState, DetailReceipt, NotifyDeadLetter, parse_availability_outcome(), unavailable_outcome()

### Community 40 - "Requirements"
Cohesion: 0.09
Nodes (17): Cli, commit_post_bind_clock(), grant_hmac_key(), main(), Option, PathBuf, Result, Store (+9 more)
...
Cohesion: 0.21
Nodes (26): active_v2_survives_stale_approved_v1_recovery(), approved_dangling_recovery_quarantines_and_requests_reconfirm(), commit_before_publish_crash_republishes_exact_active_ref(), fixture(), insert_active_proposal(), insert_approved_proposal(), insert_proposal(), learned_row() (+18 more)
...
Cohesion: 0.12
Nodes (12): deserialize_schema_version(), provenance_round_trips_with_tag(), ref_of(), slice_round_trips_and_rejects_unknown_fields(), Task, task_rejects_plaintext_title_and_provenance_references(), task_rejects_unsupported_schema_version(), task_requires_schema_version_and_rejects_unknown_fields() (+4 more)

### Community 67 - "identity.rs"
Cohesion: 0.14
Nodes (11): effect_defaults_to_allow_when_omitted(), owner_route(), round_trips_through_serde(), Route, route_can_be_a_deny_route(), RouteEffect, RouteResolution, ArtifactId (+3 more)
...
Cohesion: 0.32
Nodes (19): artifact_ref(), email_route(), exact_deny_route_wins_over_allow_route(), gmail_connector_authenticated_alone_does_not_match_the_selected_thread_route(), higher_priority_route_wins_over_lower_priority(), matches(), no_matching_route_is_denied_not_ambiguous(), no_relationship_match_denies_the_route() (+11 more)
...
Cohesion: 0.15
Nodes (13): ConversationClaimGuard, ConversationClaimGuard<'a>, claim_conversation_in_flight(), connector_restart_cap_available(), release_conversation_in_flight(), release_conversation_in_flight_for_grant(), artifact_ref(), briefcase() (+5 more)

### Community 85 - "Proposal: Implement selected-thread email preview slice"
Cohesion: 0.25
Nodes (5): capture(), audit_failure_rolls_back_live_credential(), audit_failure_rolls_back_paired_promotion(), gmail_paired_intake_stages_first_half_then_promotes_on_second(), gmail_paired_intake_works_in_reverse_order()
...
Cohesion: 0.06
Nodes (74): PromotionDenial, SkillRow, dispatch_skill_context(), skill_context_rejects_unknown_grant_purpose(), skill_context_selects_only_grant_scoped_installed_matches(), task_class_from_grant_purpose(), CeremonyError, CeremonyToken (+66 more)

### Community 97 - "Tasks: Implement digest-bound draft approval"
Cohesion: 0.14
Nodes (10): Update, owner_envelope_is_verified_with_owner_id_match_method(), build_owner_envelope(), CallbackQueryUpdate, parse_digest_detail_command(), parse_digest_namespace(), project_update(), TelegramUpdate (+2 more)
...
Cohesion: 0.10
Nodes (27): kernel_notify_grant(), notify_owner_required_outcome(), notify_owner_with_digest(), NotifyOutcome, record_notify_skipped(), Option, Ulid, AppState (+19 more)

### Community 107 - "OpenSpine"
Cohesion: 0.13
Nodes (23): handle_draft_approval_callback(), Result, Ulid, notify_owner_best_effort(), handle_plan_approval_callback(), resolve_approved_plan(), Result, Ulid (+15 more)
...
Cohesion: 0.18
Nodes (11): connector_registry_enumerates_configured_connectors(), EmptyGateContext, gmail(), gmail_failure_records_breaker_failure_and_opens_breaker(), no_egress_classifier_skips_check_for_unrated_actions(), registry_rate_buckets_are_isolated_per_connector(), GmailConnector, Option (+3 more)

### Community 111 - "Design: Digest-bound draft approval"
Cohesion: 0.26
Nodes (16): action_for(), arm(), CaptureOutcome, kind_prefix(), owner_grant(), parse_command(), Pending, rollback_secret() (+8 more)
...
### Community 119 - "attrs"
Cohesion: 0.19
Nodes (31): ActionRequestBody, ActionResponseBody, cleanup_pre_effect_reservations(), dispatch_lyra_preview(), dispatch_read_selected_thread(), DispatchError, FailureSurface, guard_connector_dispatch() (+23 more)

### Community 120 - "Design: Harden approval and budgets"
Cohesion: 0.24
Nodes (4): Bot, Url, TelegramBotState, TelegramConnector
...
Cohesion: 0.21
Nodes (13): approval_for(), ApprovalDecision, ApprovalRecord, matches_rejects_expired_approval(), matches_rejects_non_approved_decisions(), matches_requires_both_digests_and_approved_decision(), round_trips_through_serde(), sample_approval() (+5 more)
...
Cohesion: 0.18
Nodes (16): notify_owner_required(), Result, notify_owner_required_errors_and_audits_on_send_failure(), notify_owner_required_succeeds_when_sent(), notify_owner_with_digest_records_success_counter(), notify_send_failure_records_attempt_failure_and_dead_letter(), parse_audit_event(), required_send_failure_keeps_dlq_when_counter_persistence_breaks() (+8 more)

### Community 126 - "D-002 — First usable UX should include an owner control channel"
Cohesion: 0.29
Nodes (15): HeadlessHookRequest, Vec, run_headless_hook(), headless_owner_route_binds_owner_persona_before_grant(), install_headless_route(), invalid_webhook_is_dropped_with_rejection_audit_and_no_grant(), production_owner_route_binds_seeded_persona(), replayed_webhook_is_dropped_with_rejection_audit() (+7 more)
...
Cohesion: 0.19
Nodes (14): post_webhook(), Arc, HeaderMap, Json, Option, Path, Result, State (+6 more)

### Community 143 - "Reflection & product surface"
Cohesion: 0.16
Nodes (15): truncate_for_telegram(), truncate_with_notice(), call_with_connector(), call_with_connector_preflight(), call_with_connector_write(), confirmed_gmail_api_write_failure_is_connector_error(), gmail_malformed_success_response_is_delivery_unknown(), gmail_transport_write_is_delivery_unknown() (+7 more)
...
Cohesion: 0.22
Nodes (13): headless_build_envelope(), headless_grant_binding(), headless_preflight(), HeadlessHookOutcome, ArtifactRef, Box, Future, Output (+5 more)
...
Cohesion: 0.15
Nodes (12): Consequences, Consequences, D-036 — Phase-2 thread selection is a kernel-recognized `/draft <thread_id>` command, not free-form NLU or a shell-supplied id, D-045 — WYSIWYS: a truncated preview refuses an approval button rather than splitting the message, Decision, Decision, Decision Index, Lyra PRD Companion — Decisions Log (+4 more)
...
Cohesion: 0.31
Nodes (9): digest_is_order_argument_and_schema_sensitive(), digest_matches_serialized_plan_payload(), Plan, PlanApprovalQuestion, PlanStep, question_renders_every_digest_bound_field(), sample(), serde_rejects_unknown_fields_and_round_trips() (+1 more)

### Community 185 - "Implementation notes"
Cohesion: 0.36
Nodes (11): counterparty_cannot_select_owner_route_persona(), owner_bound_number_selects_route_persona(), persona(), resolve_persona(), route(), route_context_mismatch_cannot_front_persona(), HashMap, Option (+3 more)

### Community 186 - "Implementation plan"
Cohesion: 0.30
Nodes (6): Option, Result, Ulid, Vec, Store, DigestItem
...
Cohesion: 0.15
Nodes (14): decode_hex(), Formatter, HashMap, Option, Result, String, Vec, signed_at_key_account_and_payload() (+6 more)
...
Cohesion: 0.12
Nodes (30): counterparty_deferral_text_is_canonical(), grant_with_thread(), no_thread_id_resolves_to_master(), owner_escalation_message(), owner_message_carries_action_and_reason_code(), resolve_by_thread_id_returns_bound_grant(), resolve_grant_for_thread(), route_escalation() (+22 more)
...
Cohesion: 0.25
Nodes (10): audit_action_count(), commissioned_worker_reports_and_master_relays_through_real_shell(), dispatch_state(), parent_briefcase(), parent_grant_for_commission(), Briefcase, PathBuf, String (+2 more)

### Community 207 - "check-claims.sh"
Cohesion: 0.14
Nodes (11): BreakerState, CircuitBreaker, ConnectorCallError, ConnectorProbePermit, ConnectorRuntime, ConnectorRuntimeState, Arc, Display (+3 more)
...
Cohesion: 0.22
Nodes (11): handle_worker_commission(), commissioned_grant_for_receipt(), CommissionReceipt, mark_worker_stranded_notified(), record_worker_commissioned(), stranded_worker_timeouts(), stranded_worker_timeout_detects_expired(), worker_dispatch_failed() (+3 more)
...
Cohesion: 0.22
Nodes (8): CircuitBreakerConfig, RateLimitBucket, RateLimitConfig, Default, Duration, Into, Self, Timestamp
...
### Community 317 - "Ulid"
Cohesion: 0.39
Nodes (5): MockContext, HashMap, Option, Ulid, Vec
...
Cohesion: 0.25
Nodes (8): Change Log, Consequences, D-117 — The headless lane is digest-only with non-downgradable approvals, Decision, Open Decision Questions — CLOSED (see linked decisions), Rationale, Research / Reference Backlog, Would change if
...
Cohesion: 0.11
Nodes (31): a_double_tap_on_approve_creates_only_one_gmail_draft(), activate_approved_artifact_audits_failure_when_no_row(), approval_audit_never_contains_the_plaintext_draft_body(), approval_fixture_grant(), approval_fixture_request(), approve_callback_update(), draft_write_timeout_is_delivery_unknown_and_leaves_pending_rows(), gmail_with_token_mock() (+23 more)
...
Cohesion: 0.13
Nodes (14): grant(), GrantLimits, GrantMode, legacy_missing_chain_defaults_but_fails_closed(), legacy_without_thread_id_defaults_to_none(), round_trip_and_mac(), ArtifactId, Option (+6 more)
...
## Knowledge Gaps
- **2253 isolated node(s):** `autoresearch.sh script`, `ArtifactNominatePayload`, `ArtifactProposePayload`, `ReadThreadPayload`, `ConversationClaimGuard<'a>` (+2248 more)
...
- **Why does `AppState` connect `openspine-decision-log.md` to `D-005 — Private-data shell must be contained`, `event.rs`, `handle_owner_update`, `.default`, `config.rs`, `Design: Backfill implemented capability specs`, `Design: Artifact lifecycle slice`, `ProposedArtifact`, `Skills & workflows`, `ActionId`, `AppState`, `.sweep_expired_grants`, `Lifecycle`, `D-047 — Task tokens are hashed at rest; expired grants are swept`, `ADDED Requirements`, `Requirements`, `Option`, `mod.rs`, `architecture.md`, `Requirements`, `threat-model.md`, `create_approved_draft`, `README.md`, `Proposal: Backfill implemented capability specs`, `Proposal: Harden approval and budgets`, `Tasks: Implement artifact lifecycle slice`, `Design: Authority composition`, `OpenSpine`, `Telegram owner-control setup (Phase 1)`, `Design: Digest-bound draft approval`, `attrs`, `D-001 — Lyra is a runtime/substrate, not a single agent`, `D-042 — Reply recipient is kernel-derived, never shell-supplied: newest non-owner sender, matched against a configured mailbox address`, `D-002 — First usable UX should include an owner control channel`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `TaskGrant` connect `Result` to `D-005 — Private-data shell must be contained`, `event.rs`, `config.rs`, `Design: Backfill implemented capability specs`, `Design: Artifact lifecycle slice`, `ProposedArtifact`, `actions.rs`, `StoreError`, `ActionId`, `D-047 — Task tokens are hashed at rest; expired grants are swept`, `Lifecycle`, `D-050 — `max_model_calls` is enforced with an atomic upsert, not a count-then-compare`, `ArtifactRef`, `D-025 — Rust/Tokio substrate: storage, audit chain, and secrets handling`, `Q: Trace the full runtime call path for a single incoming Telegram message from an authorized owner, all the way through to a TaskGrant being persisted in the kernel's SQLite store. List the modules/files involved, in call order, and identify the 2-3 modules that are most structurally central to this flow.`, `Option`, `threat-model.md`, `identity.rs`, `README.md`, `Proposal: Backfill implemented capability specs`, `openspine-decision-log.md`, `OpenSpine`, `Telegram owner-control setup (Phase 1)`, `Design: Digest-bound draft approval`, `attrs`, `D-001 — Lyra is a runtime/substrate, not a single agent`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `ArtifactRegistry` connect `create_approved_draft` to `D-045 — WYSIWYS: a truncated preview refuses an approval button rather than splitting the message`, `openspine-decision-log.md`, `GmailConnector`, `Value`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Are the 90 inferred relationships involving `handle_owner_update()` (e.g. with `handle_draft_approval_callback()` and `run_pipeline()`) actually correct?**
  _`handle_owner_update()` has 90 INFERRED edges - model-reasoned connections that need verification._
- **Are the 85 inferred relationships involving `test_state()` (e.g. with `email_counterparty_resolves_to_bound_identity_when_address_is_bound()` and `email_counterparty_stays_unresolved_when_address_is_unbound()`) actually correct?**
  _`test_state()` has 85 INFERRED edges - model-reasoned connections that need verification._
- **Are the 85 inferred relationships involving `owner_update()` (e.g. with `approve_callback_update()` and `verified_hook_approval_required_escalates_through_owner_surface()`) actually correct?**
  _`owner_update()` has 85 INFERRED edges - model-reasoned connections that need verification._
- **What connects `autoresearch.sh script`, `ArtifactNominatePayload`, `ArtifactProposePayload` to the rest of the system?**

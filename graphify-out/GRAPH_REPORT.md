...
## Corpus Check
- 646 files · ~517,590 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9244 nodes · 12175 edges · 2116 communities (666 shown, 1450 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 1678 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c766e772`
...
3. `owner_update()` - 91 edges
4. `test_state_with_telegram()` - 83 edges
5. `digest_of_bytes()` - 65 edges
6. `gate()` - 56 edges
7. `request_for()` - 38 edges
8. `publish_bundle()` - 37 edges
9. `test_catalog()` - 30 edges
...
Cohesion: 0.13
Nodes (26): connector_failure_batches_and_is_audited(), counter_persistence_failure_is_durably_batched_as_resource(), immediate_failure_cannot_enter_digest_lane(), long_detail_is_bounded_in_summary_and_full_via_ref(), digest_detail_corrupt_blob_surfaces_resource_without_leak(), digest_detail_immediate_success_outcome_audit_failure_is_delivery_unknown_and_no_retry(), digest_detail_missing_blob_surfaces_resource_without_leak(), digest_detail_not_found_is_truthful() (+18 more)
...
### Community 8 - "mod.rs"
Cohesion: 0.12
Nodes (26): artifact_key_bytes(), artifact_key_round_trips_bytes(), Config, ConfigError, default_kernel_bind(), example_configs_parse_against_the_real_schema(), gmail_client_secret(), gmail_refresh_token() (+18 more)
...
Cohesion: 0.18
Nodes (24): injected_activation_tx_failure_keeps_approved_old_state(), seed_owner_history(), ArtifactProposePayload, dispatch_artifact_propose(), artifact_propose_accepts_miner_reflection_correction_route(), artifact_propose_accepts_persona_kind(), reflection_miner_runtime_wires_ad135_route_through_lifecycle(), scheduled_reflection_miner_tick_mines_repeated_approval() (+16 more)
...
Cohesion: 0.09
Nodes (32): ActionHandler, Fn, TcpListener, ActionHandlerRegistry, bind_failure_retains_pending_finalization(), completed_audit_then_rollback_audit_sequence_records_both_events(), forge_mac(), forged_marker_fails_before_store_open() (+24 more)
...
Cohesion: 0.12
Nodes (19): canonical_json(), CanonicalValue, Digest, digest_from_hash(), digest_of(), digest_of_bytes_hashes_raw_content_directly(), digest_of_is_a_pinned_golden_value(), digest_round_trips_through_serde() (+11 more)
...
Cohesion: 0.28
Nodes (15): emit_preflight_failure(), non_immediate_lane_breach_blocks_composition_and_notifies_owner(), owner_lane_executed_stage_trace_matches_sync_prefix(), owner_lane_without_verified_context_fails_closed_before_grant(), owner_control_lane(), run_pipeline(), notification_state(), owner_inputs() (+7 more)
...
Cohesion: 0.09
Nodes (35): denied_read_thread_stops_without_drafting(), Draft, draft_reply(), empty_draft_skips_preview_without_error(), format_thread_for_model(), format_thread_for_model_includes_all_fields(), full_flow_reads_drafts_and_previews(), no_selection_tokens_is_an_error() (+27 more)
...
Cohesion: 0.18
Nodes (21): DeserializeOwned, (), ApprovalStepInputs, ArtifactRef, bool, Digest, GatedDepartureInputs, GatedStepDigest (+13 more)
...
Cohesion: 0.16
Nodes (17): ActorHint, ChannelTrust, Connector, EventEnvelope, EventType, InteractionMode, Lane, legacy_without_thread_id_defaults_to_none() (+9 more)
...
Cohesion: 0.30
Nodes (19): install_skill(), promote_mined_skill(), select_skills_for_task(), tokens_of(), benign_body(), make_skill(), malicious_body(), matcher_can_inject_but_never_install() (+11 more)
...
Cohesion: 0.09
Nodes (13): egress_declarations(), action_id_qualifier_is_part_of_identity(), action_id_serializes_as_bare_string(), ActionCatalog, ActionEgressDeclaration, ActionId, ActionRequest, DenialReason (+5 more)
...
Cohesion: 0.06
Nodes (22): Bot, Update, Url, configured_owner_text_message_is_verified(), invalid_candidate_bot_token_is_rejected_without_replacing_live_bot(), missing_sender_is_ignored(), non_text_update_from_owner_is_ignored(), owner_envelope_is_verified_with_owner_id_match_method() (+14 more)
...
Cohesion: 0.23
Nodes (6): canonical_catalog_covers_all_fixture_action_ids(), build_state_at(), full_export_restore_e2e_regression_under_newer_base(), mint_composed_owner_grant(), write_learned_route(), repo_lyra_dir()
...
Cohesion: 0.22
Nodes (6): EntryBindingInputs, EntryTransitionInputs, manifest_digest(), WorkflowStateMachine, WorkflowStateMachine<'a>, WorkflowStateMachineError
...
Cohesion: 0.11
Nodes (27): gated_step_persisted_pending_recovers_without_redispatch(), router(), build_state(), build_state_with_store(), repo_lyra_dir(), test_state_with_gmail_and_telegram(), test_state_with_store(), a_double_tap_on_approve_creates_only_one_gmail_draft() (+19 more)
...
Cohesion: 0.17
Nodes (22): bounded_text(), load_checkpoint(), relay_one(), RelayOutcome, resolve_relay_context(), run_worker_result_consumer(), worker_result_consumer_iteration(), worker_result_filter() (+14 more)
...
Cohesion: 0.10
Nodes (43): ReflectionProposal, counterparty_cannot_select_owner_route_persona(), owner_bound_number_selects_route_persona(), persona(), resolve_persona(), route(), route_context_mismatch_cannot_front_persona(), dispatch_reflection_proposal() (+35 more)
...
Cohesion: 0.38
Nodes (14): PromotionDenial, recent_promotion_decisions_for_test(), owner_decide_promotion(), benign_body(), make_mined_skill(), malicious_body(), owner_approval_promotes_through_evaluator(), owner_approve_but_evaluator_denies_labels_decision_approve() (+6 more)

### Community 175 - "D-033 — Action identifiers are exact-match dotted strings; unverified senders are audited and ignored"
Cohesion: 0.26
Nodes (14): agent_manifests_round_trip(), artifacts_dir(), email_grant_pack_excludes_read_inbox_and_send(), every_fixture_file_is_covered_by_a_test(), global_policy_round_trips_and_denies_send(), owner_control_pack_round_trips(), owner_email_selected_thread_route_is_expressible_declaratively(), owner_telegram_route_is_expressible_declaratively() (+6 more)
...
Cohesion: 0.24
Nodes (8): handle_skill_context(), dispatch_skill_context(), skill_context_rejects_unknown_grant_purpose(), skill_context_selects_only_grant_scoped_installed_matches(), task_class_from_grant_purpose(), CeremonyToken, reject_mined_skill(), reject_skill()
...
Cohesion: 0.27
Nodes (8): Constraints, Policy, ArtifactId, Option, String, Vec, SessionPolicy, DataClassification
...
Cohesion: 0.08
Nodes (64): draft_command_composes_email_preview_grant_whose_pending_ref_is_derived_message(), draft_command_for_a_missing_thread_mints_no_grant(), draft_command_for_a_real_thread_composes_a_bound_selection_grant(), draft_command_is_refused_without_the_unsafe_flag_under_process_driver(), draft_command_with_gmail_api_error_audits_no_event_received(), draft_command_without_gmail_configured_is_a_no_op(), plan_preview_records_telegram_failure_counter_on_send_error(), concurrent_owner_callbacks_are_serialized_by_handler() (+56 more)
...
Cohesion: 0.39
Nodes (6): email_lane_executed_stage_trace_matches_sync_prefix(), email_lane_marker_is_not_owner_control_screened(), email_lane_preflight_resolves_counterparty_into_persisted_briefcase(), injected_briefcase_persist_failure_leaves_no_spawn_or_orphans(), email_preview_lane(), gmail_state_with_real_thread()
...
Cohesion: 0.18
Nodes (5): handle_artifact_nominate(), handle_artifact_propose(), handle_lyra_preview(), handle_plan_propose(), handle_telegram_reply()
...
Cohesion: 0.24
Nodes (12): BuildEnvelopeFn, GrantBindingFn, PreflightFn, RouteGuardFn, complete_task_and_wake(), dispatch_task_wake(), reattempt_handed_off(), recover_timer_dispatches() (+4 more)
...
Cohesion: 0.62
Nodes (6): CeremonyError, install_mined_skill(), install_seed_skill(), install_skill_internal(), install_user_skill(), OwnerSkillDecision
...
### Community 764 - "D-010 — Model calls with private context go through model gateway"
Cohesion: 0.67
...
## Knowledge Gaps
- **2659 isolated node(s):** `set.sh script`, `autoresearch.sh script`, `TelegramReplyPayload`, `ReadThreadPayload`, `ArtifactNominatePayload` (+2654 more)
...
- **Why does `test_state()` connect `Tasks: Implement identity store and principal` to `Tasks: Define OpenSpine development process`, `artifact_loader.rs`, `config.rs`, `Proposal: Backfill implemented capability specs`, `standing_rule_timer.rs`, `.put`, `content.d.ts`, `Proposal: Define core runtime schemas`, `action.rs`, `artifact_propose.rs`, `Proposal: Refactor kernel registries`, `D-043 — `lyra.ui.preview` is extended (not duplicated) to propose the exact reviewed draft and attach the approval button`, `Reference hunt`, `Kernel foundation`, `SKILL.md`, `Lifecycle`, `mod.rs`, `SKILL.md`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `handle_owner_update()` connect `Tasks: Implement identity store and principal` to `decisions.md`, `D-005 — Private-data shell must be contained`, `.default`, `D-022 — Agent-owned inbox is distinct from owner mailbox access`, `artifact_loader.rs`, `D-016 — Capability packs are candidate profiles, not live authority`, `standing_rule_timer.rs`, `.put`, `ProposedArtifact`, `Proposal: Define core runtime schemas`, `action.rs`, `MockServer`, `Lifecycle`, `mod.rs`, `SKILL.md`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `digest_of_bytes()` connect `D-034 — `email.create_draft` is the one canonical action id; the qualified PRD §10.2 spelling is dropped` to `Option`, `.default`, `GmailConnector`, `D-016 — Capability packs are candidate profiles, not live authority`, `openspine-decision-log.md`, `standing_rule_timer.rs`, `ProposedArtifact`, `digest.rs`, `HeaderMap`, `content.d.ts`, `ArtifactRef`, `Proposal: Implement selected-thread email preview slice`, `Kernel foundation`, `opsx-propose.md`, `AppState`, `D-047 — Task tokens are hashed at rest; expired grants are swept`, `SKILL.md`, `AuditEvent`?**
...
- **Are the 95 inferred relationships involving `handle_owner_update()` (e.g. with `draft_command_composes_email_preview_grant_whose_pending_ref_is_derived_message()` and `draft_command_for_a_missing_thread_mints_no_grant()`) actually correct?**
  _`handle_owner_update()` has 95 INFERRED edges - model-reasoned connections that need verification._
- **Are the 90 inferred relationships involving `owner_update()` (e.g. with `draft_command_composes_email_preview_grant_whose_pending_ref_is_derived_message()` and `draft_command_for_a_missing_thread_mints_no_grant()`) actually correct?**

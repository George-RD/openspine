# Graph Report - implement-connector-reality  (2026-07-18)

## Corpus Check
- 473 files · ~351,050 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6390 nodes · 8906 edges · 1241 communities (478 shown, 763 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1018 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `33f6e317`
...
1. `AppState` - 119 edges
2. `handle_owner_update()` - 78 edges
3. `owner_update()` - 69 edges
4. `TaskGrant` - 62 edges
5. `StoreError` - 53 edges
6. `Timestamp` - 53 edges
7. `test_state_with_telegram()` - 52 edges
8. `test_state()` - 50 edges
9. `gate()` - 47 edges
10. `ActionId` - 45 edges
...
- `search_class_pack_cannot_submit_web_form()` --calls--> `gate()`  [INFERRED]
  crates/openspine-kernel/src/connectors_tests.rs → crates/openspine-gate/src/gate.rs
- `retry_due_notifications()` --calls--> `parse_availability_outcome()`  [INFERRED]
  crates/openspine-kernel/src/failure_surfacing/retry_worker.rs → crates/openspine-kernel/src/store/failure_surfacing_types.rs
...
## Communities (1241 total, 763 thin omitted)
...
Cohesion: 0.21
Nodes (35): bound_parameter_conflict_is_caveat_widening(), explicit_shell_deny_precedes_uncovered_egress_class(), kernel_origin_cannot_bypass_rated_egress_class(), expired_invalid_mac_is_caveat_widening_not_grant_expired(), gate_denies_catalog_unknown_id_with_unknown_action_reason(), gate_denies_stale_granted_but_catalog_unknown_id(), gate_keeps_not_granted_for_known_ungranted_id(), kernel_origin_call_outside_trusted_set_is_denied() (+27 more)

### Community 3 - "handle_owner_update"
Cohesion: 0.07
Nodes (29): BreakerState, CircuitBreaker, CircuitBreakerConfig, ConnectorProbePermit, ConnectorRuntime, ConnectorRuntimeState, decode_hex(), RateLimitBucket (+21 more)

### Community 4 - ".default"
Cohesion: 0.07
Nodes (40): DispatchError, Error, ArtifactNominatePayload, dispatch_artifact_nominate(), Option, Result, String, Value (+32 more)
...
Cohesion: 0.11
Nodes (45): dispatch_artifact_propose(), Option, Result, Value, artifact_propose_persists_and_sends_approval_button(), artifact_propose_rejects_duplicate_id_version(), artifact_propose_rejects_malformed_yaml(), artifact_propose_rejects_non_proposed_lifecycle() (+37 more)
...
Cohesion: 0.12
Nodes (31): authenticate(), bearer_token(), get_status(), internal_error(), router(), Arc, ArtifactRef, Display (+23 more)
...
Cohesion: 0.10
Nodes (32): bounded_json_response(), CachedToken, GmailConnector, Result, extract_email_address(), GmailConnector, GmailError, GmailFailureClass (+24 more)

### Community 16 - "Requirements"
Cohesion: 0.05
Nodes (65): Ok, Sha256, CanonicalValue, CanonicalValue<'a>, Digest, digest_from_hash(), digest_of(), digest_of_bytes() (+57 more)
...
Cohesion: 0.15
Nodes (25): ActionRequestBody, ActionResponseBody, dispatch_lyra_preview(), dispatch_read_selected_thread(), FailureSurface, guard_connector_dispatch(), mediate_and_dispatch_action(), post_actions() (+17 more)
...
Cohesion: 0.14
Nodes (19): BuildEnvelopeFn, email_preview_lane(), LaneSpec, owner_control_lane(), scheduled_internal_lane(), GrantBindingFn, PreflightFn, RouteGuardFn (+11 more)
...
Cohesion: 0.12
Nodes (6): AuditEvent, AuditKind, AuditKindError, genesis_hash(), round_trips_through_serde(), EventSubscriptionFilter

### Community 30 - "ArtifactRef"
Cohesion: 0.12
Nodes (34): a_failed_token_refresh_surfaces_as_an_error(), a_non_404_api_error_is_not_treated_as_missing(), connector(), fetch_thread_extracts_text_and_skips_attachments(), gmail_token_refresh_only_within_skew_window(), gmail_token_refreshes_near_expiry(), mount_token_endpoint(), rotated_vault_credentials_bypass_live_access_token_cache() (+26 more)

### Community 31 - "ADDED Requirements"
Cohesion: 0.14
Nodes (8): action_id_qualifier_is_part_of_identity(), action_id_serializes_as_bare_string(), ActionCatalog, ActionId, DenialReason, EffectPath, EffectPathClass, GateDecision
...
Cohesion: 0.12
Nodes (29): batch_failure(), encrypt_digest_detail(), FailureClass, notify_immediate_failure(), record_callback_ack(), record_connector_outcome(), record_connector_outcome_or_batch(), Option (+21 more)
...
Cohesion: 0.17
Nodes (31): emit_preflight_failure(), Result, email_build_envelope(), email_grant_binding(), email_preflight(), email_route_guard(), EventInputs, owner_build_envelope() (+23 more)
...
Cohesion: 0.19
Nodes (18): dispatch_polled_updates_for_test(), initialize_telegram_bot_id(), initialize_telegram_bot_id_until_ready(), is_already_processed(), resolve_telegram_offset(), resolve_telegram_offset_for_test(), Duration, Option (+10 more)
...
Cohesion: 0.15
Nodes (9): configured_owner_text_message_is_verified(), invalid_candidate_bot_token_is_rejected_without_replacing_live_bot(), missing_sender_is_ignored(), non_text_update_from_owner_is_ignored(), owner_message_in_a_group_chat_is_ignored_not_routed(), Option, unknown_telegram_user_is_ignored_not_routed(), update() (+1 more)
...
Cohesion: 0.15
Nodes (17): capture(), Option, Result, action_for(), arm(), CaptureOutcome, kind_prefix(), owner_grant() (+9 more)
...
### Community 80 - "Ok"
Cohesion: 0.20
Nodes (15): build_owner_envelope(), CallbackQueryUpdate, parse_approve_callback(), parse_approve_plan_callback(), parse_bind_command(), parse_digest_detail_command(), parse_digest_namespace(), parse_draft_command() (+7 more)

### Community 81 - "Proposal: Define core runtime schemas"
Cohesion: 0.13
Nodes (27): a_double_tap_on_approve_creates_only_one_gmail_draft(), approval_audit_never_contains_the_plaintext_draft_body(), approval_fixture_grant(), approval_fixture_request(), approve_callback_update(), activate_approved_artifact_audits_failure_when_no_row(), owner_notify_routes_through_gate_and_audits(), payload_mutated_since_approval_is_denied_and_creates_no_draft() (+19 more)
...
Cohesion: 0.14
Nodes (24): ActionHandler, ActionHandlerRegistry, handle_artifact_nominate(), handle_artifact_propose(), handle_lyra_preview(), handle_plan_propose(), handle_read_selected_thread(), handle_setup_workflow_start() (+16 more)
...
Cohesion: 0.29
Nodes (16): route_yaml(), String, approve_callback_update(), mount_send_message_ok(), orphaned_reconfirm_fixture(), reconfirm_legacy_migration_establishes_produced_by_and_proposal(), reconfirm_tap_refuses_base_namespace_collision(), reconfirm_tap_refuses_tampered_yaml() (+8 more)
...
Cohesion: 0.14
Nodes (15): handle_draft_approval_callback(), Result, Ulid, PostApprovalFuture, PostApprovalHandler, finalize_nomination(), NominationAssertion, reinstate_artifact() (+7 more)
...
Cohesion: 0.14
Nodes (30): test_state(), bind_email_identity(), email_counterparty_resolves_to_bound_identity_when_address_is_bound(), email_counterparty_stays_unresolved_when_address_is_unbound(), minimal_grant(), mint_topup_grant(), post_topup(), topup_granted_grant_mutates_briefcase_atomically() (+22 more)
...
Cohesion: 0.09
Nodes (37): canonical_json(), Briefcase, adding_thread_binding_without_resealing_invalidates_mac(), caveat_reorder_or_remove_invalidates_mac(), child_derives_from_parent_tip_without_root_key(), egress_class_tamper_invalidates_root_mac(), id_parent_and_action_list_tamper_fail(), identity_field_tamper_invalidates_mac() (+29 more)
...
Cohesion: 0.19
Nodes (14): handle_plan_approval_callback(), resolve_approved_plan(), Result, Ulid, step(), digest_is_order_argument_and_schema_sensitive(), digest_matches_serialized_plan_payload(), Plan (+6 more)
...
Cohesion: 0.09
Nodes (33): resolve_text(), retry_backoff(), retry_due_notifications(), Duration, Result, String, run_retry_loop(), kernel_notify_grant() (+25 more)
...
Cohesion: 0.15
Nodes (12): Consequences, Consequences, D-072 — Digest detail retrieval is a secure lossless pagination substrate, D-090 — Workflow manifests are digest-bound at run start; production driving is deferred, Decision, Decision, Decision Index, Lyra PRD Companion — Decisions Log (+4 more)
...
Cohesion: 0.27
Nodes (12): load_base_registry(), load_registry(), parse_proposal(), generic_overlay_loader_excludes_persona_and_base_loader_rejects_fixture(), kind_table_excludes_personas(), kind_table_excludes_templates(), kind_table_round_trips_all_six_kinds(), loads_every_real_fixture_without_error() (+4 more)
...
Cohesion: 0.44
Nodes (9): activation_with_mutated_payload_is_denied(), approve_callback_update(), approved_artifact_activates_into_registry_and_overlay(), model_swap_ceremony_switches_real_generate_provider(), mount_send_message_ok(), MockServer, TelegramConnector, Ulid (+1 more)
...
Cohesion: 0.31
Nodes (5): ensure_schema(), Connection, Result, Ulid, Store

### Community 217 - "SKILL.md"
Cohesion: 0.22
Nodes (6): candidate_error_is_invalid_token(), Error, Option, Result, TelegramConnector, RequestError
...
Cohesion: 0.25
Nodes (8): Change Log, Consequences, D-099 — Connector breakers use sliding-window failure accounting, Decision, Open Decision Questions — CLOSED (see linked decisions), Rationale, Research / Reference Backlog, Would change if
...
### Community 335 - "Value"
Cohesion: 0.24
Nodes (4): canonical_catalog(), counterparty_classification_is_kernel_owned_and_fails_closed(), test_catalog_effect_paths_are_fully_enumerated_and_classified(), canonical_catalog_covers_all_fixture_action_ids()
...
Cohesion: 0.09
Nodes (21): ConnectorCallError, built_in_web_egress_endpoints(), Connector, ConnectorRegistry, EgressRegistrationError, GmailConnector, Display, Error (+13 more)
...
## Knowledge Gaps
- **1988 isolated node(s):** `autoresearch.sh script`, `GmailConnector`, `IdentityResolver`, `NominationAssertion`, `Store` (+1983 more)
...
- **Why does `AppState` connect `banner` to `D-004 — Every effectful action goes through `gate()``, `.default`, `D-022 — Agent-owned inbox is distinct from owner mailbox access`, `config.rs`, `.put`, `client.rs`, `policy.rs`, `Requirements`, `content.d.ts`, `AppState`, `ArtifactRef`, `ADDED Requirements`, `D-052 — Archive applies deltas mechanically via `openspec archive --yes`; pre-seeded requirements are carried as MODIFIED; the `--skip-specs` hand-apply ceremony is retired`, `digest.rs`, `.default`, `ADDED Requirements`, `scripts`, `MODIFIED Requirements`, `Result`, `Proposal: Define core runtime schemas`, `Tasks: Implement selected-thread email preview slice`, `Tasks: Implement artifact lifecycle slice`, `Agent-OS change sequence (2026-07-07, AD canon)`, `AuditEvent`, `Design: Authority composition`, `Gmail selected-thread email preview setup (Phase 2)`?**
...
- **Why does `TaskGrant` connect `Agent-OS change sequence (2026-07-07, AD canon)` to `D-005 — Private-data shell must be contained`, `.default`, `D-022 — Agent-owned inbox is distinct from owner mailbox access`, `config.rs`, `banner`, `telegram.rs`, `policy.rs`, `Proposal: Define core runtime schemas`, `AppState`, `ADDED Requirements`, `AuditEvent`, `.default`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Are the 71 inferred relationships involving `handle_owner_update()` (e.g. with `activation_with_mutated_payload_is_denied()` and `approved_artifact_activates_into_registry_and_overlay()`) actually correct?**
  _`handle_owner_update()` has 71 INFERRED edges - model-reasoned connections that need verification._
- **Are the 67 inferred relationships involving `owner_update()` (e.g. with `activation_with_mutated_payload_is_denied()` and `approve_callback_update()`) actually correct?**
  _`owner_update()` has 67 INFERRED edges - model-reasoned connections that need verification._
- **What connects `autoresearch.sh script`, `GmailConnector`, `IdentityResolver` to the rest of the system?**

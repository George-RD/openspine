...
### Community 4 - ".default"
Cohesion: 0.07
Nodes (32): canonical_catalog_covers_all_fixture_action_ids(), PromptTemplate, T, canonical_catalog(), counterparty_classification_is_kernel_owned_and_fails_closed(), test_catalog_effect_paths_are_fully_enumerated_and_classified(), AgentManifest, ArtifactKindSpec (+24 more)
...
### Community 10 - ".put"
Cohesion: 0.14
Nodes (20): CanonicalValue, digest_from_hash(), digest_of(), digest_of_bytes(), digest_of_bytes_hashes_raw_content_directly(), digest_of_is_a_pinned_golden_value(), HasherWriter, Value (+12 more)
...
Cohesion: 0.05
Nodes (42): AtomicBool, counterparty_resolves_identity_but_no_principal(), handle_owner_bind(), IdentityResolver, IdentityResolver<'a>, owner_verified_path_resolves_owner_principal_and_relationship(), Option, Result (+34 more)
...
Cohesion: 0.06
Nodes (83): lyra_ui_preview_sends_telegram_reply_to_grant_bound_chat(), lyra_ui_preview_truncates_long_body_to_utf16_limit(), truncated_preview_carries_no_approval_button_and_persists_no_action_request(), parse_audit_event(), Value, shadow_grant_effect_suppressed_skips_effect_handler(), test_path_1_notify_owner_gated_and_audited(), test_path_2_create_draft_payload_mutated_audited() (+75 more)
...
Cohesion: 0.18
Nodes (13): PostApprovalFuture, PostApprovalHandler, create_approved_draft(), handle_draft_approval_callback(), activate_approved_artifact(), notify_owner_best_effort(), handle_plan_approval_callback(), resolve_approved_plan() (+5 more)
...
- **Why does `AppState` connect `mod.rs` to `D-021 — Email domain is broader than Gmail`, `properties`, `.default`, `SKILL.md`, `.put`, `SKILL.md`, `ADDED Requirements`, `Requirements`, `Tasks: Implement selected-thread email preview slice`, `.sweep_expired_grants`?**

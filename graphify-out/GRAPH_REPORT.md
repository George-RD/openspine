...
## Corpus Check
- 366 files · ~262,996 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4721 nodes · 6228 edges · 872 communities (380 shown, 492 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 736 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2da717cb`
...
1. `handle_owner_update()` - 60 edges
2. `owner_update()` - 57 edges
3. `gate()` - 46 edges
4. `test_state_with_telegram()` - 42 edges
5. `StoreError` - 40 edges
6. `request_for()` - 33 edges
7. `grant_with()` - 32 edges
8. `test_state()` - 31 edges
...
- `no_egress_classifier_skips_check_for_unrated_actions()` --calls--> `gate()`  [INFERRED]
  crates/openspine-kernel/src/connectors.rs → crates/openspine-gate/src/gate.rs

## Import Cycles
- None detected.

## Communities (872 total, 492 thin omitted)
...
Cohesion: 0.09
Nodes (42): ArtifactRef, bool, digest_inputs(), GatedStepDigest, Outcome, Duration, Error, Into (+34 more)

### Community 4 - ".default"
Cohesion: 0.07
Nodes (31): canonical_catalog_covers_all_fixture_action_ids(), PromptTemplate, canonical_catalog(), counterparty_classification_is_kernel_owned_and_fails_closed(), test_catalog_effect_paths_are_fully_enumerated_and_classified(), AgentManifest, ArtifactKindSpec, ArtifactLoadError (+23 more)
...
Cohesion: 0.13
Nodes (26): batch_failure(), encrypt_digest_detail(), FailureClass, notify_immediate_failure(), record_callback_ack(), record_connector_outcome(), record_connector_outcome_or_batch(), connector_counters_record_success_and_failure() (+18 more)

### Community 7 - "config.rs"
Cohesion: 0.13
Nodes (39): audit_payload_refs(), draft_command_composes_email_preview_grant_whose_pending_ref_is_derived_message(), draft_command_for_a_missing_thread_mints_no_grant(), draft_command_for_a_real_thread_composes_a_bound_selection_grant(), draft_command_is_refused_without_the_unsafe_flag_under_process_driver(), draft_command_with_gmail_api_error_audits_no_event_received(), draft_command_without_gmail_configured_is_a_no_op(), gmail_state_with_real_thread() (+31 more)

### Community 8 - "mod.rs"
Cohesion: 0.14
Nodes (27): notify_owner_required_errors_and_audits_on_send_failure(), notify_owner_required_succeeds_when_sent(), notify_owner_with_digest_records_success_counter(), notify_send_failure_records_attempt_failure_and_dead_letter(), parse_audit_event(), required_send_failure_keeps_dlq_when_counter_persistence_breaks(), shadow_grant_effect_suppressed_skips_effect_handler(), test_path_1_notify_owner_gated_and_audited() (+19 more)

### Community 9 - "telegram.rs"
Cohesion: 0.12
Nodes (34): authenticate(), bearer_token(), internal_error(), router(), unauthorized(), email_reply_drafter_grant(), email_reply_drafter_template_wraps_untrusted_context_on_the_wire(), grant_with_limits() (+26 more)

### Community 10 - ".put"
Cohesion: 0.17
Nodes (16): BuildEnvelopeFn, GrantBindingFn, PreflightFn, RouteGuardFn, email_preview_lane(), emit_preflight_failure(), LaneSpec, owner_control_lane() (+8 more)
...
Cohesion: 0.05
Nodes (40): AtomicBool, is_unique_constraint_store_error(), is_unique_constraint_violation(), Error, Option, Result, Ulid, Store (+32 more)
...
Cohesion: 0.07
Nodes (42): String, truncate_for_telegram(), truncate_with_notice(), HandlerFuture, build_raw_reply_message(), CachedToken, extract_body_text(), extract_email_address() (+34 more)
...
Cohesion: 0.20
Nodes (6): ConsumerError, IdempotentConsumer, LedgerEntry, PersistedConsumerState, Store, EventSubscriptionFilter
...
Cohesion: 0.28
Nodes (12): activation_with_mutated_payload_is_denied(), approve_callback_update(), approved_artifact_activates_into_registry_and_overlay(), model_swap_ceremony_switches_real_generate_provider(), mount_send_message_ok(), telegram_stub(), artifact_propose_persists_and_sends_approval_button(), artifact_propose_rejects_duplicate_id_version() (+4 more)
...
Cohesion: 0.15
Nodes (5): AsRef, AuditKind, AuditKindError, genesis_hash(), round_trips_through_serde()

### Community 58 - "Runtime schema groups"
Cohesion: 0.14
Nodes (12): PostApprovalFuture, PostApprovalHandler, activate_approved_artifact(), handle_activate_artifact(), handle_create_approved_draft(), handle_resolve_approved_plan(), handle_unknown_approved_action(), resolve_post_approval_handler() (+4 more)
...
Cohesion: 0.37
Nodes (12): RwLock, AppState, dispatch_polled_updates(), kernel_notify_grant(), notify_owner_best_effort(), notify_owner_required(), notify_owner_required_outcome(), notify_owner_with_digest() (+4 more)
...
Cohesion: 0.22
Nodes (10): CanonicalValue, digest_from_hash(), digest_of(), digest_of_bytes(), digest_of_bytes_hashes_raw_content_directly(), digest_of_is_a_pinned_golden_value(), HasherWriter, Value (+2 more)
...
Cohesion: 0.05
Nodes (40): AgentLimits, AgentManifest, main_assistant_agent(), main_assistant_denies_broad_email_access(), MemoryScope, ModelPolicy, OutputChannels, Persistence (+32 more)
...
Cohesion: 0.20
Nodes (10): ApprovalStepInputs, Digest, digest_round_trips_through_serde(), InvalidDigest, D, Deserialize, Display, Into (+2 more)
...
Cohesion: 0.26
Nodes (10): Future, Output, Pin, Send, EventInputs, email_build_envelope(), email_preflight(), owner_build_envelope() (+2 more)
...
Cohesion: 0.18
Nodes (8): ActionHandler, Result, run_benchmarks(), Instant, ActionHandlerRegistry, Cli, main(), shutdown_signal()
...
Cohesion: 0.29
Nodes (10): ApprovalDecision, ApprovalRecord, matches_rejects_expired_approval(), matches_rejects_non_approved_decisions(), matches_requires_both_digests_and_approved_decision(), round_trips_through_serde(), String, Ulid (+2 more)
...
Cohesion: 0.19
Nodes (16): ActorHint, ChannelTrust, Connector, EventEnvelope, InteractionMode, legacy_without_thread_id_defaults_to_none(), round_trips_through_serde(), sample_envelope() (+8 more)
...
### Community 182 - "Proposal: Implement durable workflow replay"
Cohesion: 0.25
...
Cohesion: 0.25
Nodes (8): Change Log, Consequences, D-076 — Spend caps are required finite configuration, Decision, Open Decision Questions — CLOSED (see linked decisions), Rationale, Research / Reference Backlog, Would change if

### Community 187 - "Interview me"
Cohesion: 0.25
Nodes (7): Consequences, D-066 — Paired Gmail credentials stage until atomic validated promotion, Decision, Decision Index, Lyra PRD Companion — Decisions Log, Rationale, Would change if
...
### Community 365 - "Json"
Cohesion: 0.22
Nodes (3): ArtifactRef, quarantine_pending_overlay(), reconcile_model_swap_overlay()
...
## Knowledge Gaps
- **1661 isolated node(s):** `set.sh script`, `autoresearch.sh script`, `TelegramReplyPayload`, `ReadThreadPayload`, `ArtifactProposePayload` (+1656 more)
...
- **Why does `Digest` connect `Proposal: Harden approval and budgets` to `handle_owner_update`, `tests.rs`, `client.rs`, `Json`, `Tasks: Implement gate action API`, `Proposal: Implement artifact lifecycle slice`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `canonical_json()` connect `README.md` to `handle_owner_update`, `tests.rs`, `create_approved_draft`, `telegram.rs`, `Proposal: Harden approval and budgets`, `Lifecycle`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `AppState` connect `identity.rs` to `handle_owner_update`, `properties`, `.default`, `Proposal: Define OpenSpine development process`, `ADDED Requirements`, `OpenSpine conventions`, `config.rs`, `OpenSpine`, `Requirement: Selection tokens MUST be single-use, expiring, and scope-fixed`, `SKILL.md`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Are the 56 inferred relationships involving `handle_owner_update()` (e.g. with `draft_command_composes_email_preview_grant_whose_pending_ref_is_derived_message()` and `draft_command_for_a_missing_thread_mints_no_grant()`) actually correct?**
  _`handle_owner_update()` has 56 INFERRED edges - model-reasoned connections that need verification._
- **Are the 56 inferred relationships involving `owner_update()` (e.g. with `draft_command_composes_email_preview_grant_whose_pending_ref_is_derived_message()` and `draft_command_for_a_missing_thread_mints_no_grant()`) actually correct?**
  _`owner_update()` has 56 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 40 inferred relationships involving `test_state_with_telegram()` (e.g. with `lyra_ui_preview_sends_telegram_reply_to_grant_bound_chat()` and `lyra_ui_preview_truncates_long_body_to_utf16_limit()`) actually correct?**
  _`test_state_with_telegram()` has 40 INFERRED edges - model-reasoned connections that need verification._
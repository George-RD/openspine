...
## Corpus Check
- 303 files · ~211,480 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3819 nodes · 5009 edges · 647 communities (321 shown, 326 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 466 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6205726e`
...
6. `StoreError` - 29 edges
7. `owner_update()` - 29 edges
8. `Digest` - 25 edges
...
## Communities (647 total, 326 thin omitted)
...
### Community 4 - ".default"
Cohesion: 0.14
Nodes (14): canonical_json(), CanonicalValue, digest_from_hash(), digest_matches_hash(), digest_of(), digest_of_bytes(), digest_of_bytes_hashes_raw_content_directly(), digest_of_is_a_pinned_golden_value() (+6 more)
...
Cohesion: 0.06
Nodes (60): effect_defaults_to_allow_when_omitted(), owner_route(), round_trips_through_serde(), Route, route_can_be_a_deny_route(), RouteActorWhen, RouteEffect, RouteResolution (+52 more)
...
Cohesion: 0.14
Nodes (9): evaluate(), JudgeDenial, GateDenial, GateEvidence, JudgePassed, ReplayPassed, run_gate(), evaluate() (+1 more)
...
Cohesion: 0.07
Nodes (79): lyra_ui_preview_sends_telegram_reply_to_grant_bound_chat(), lyra_ui_preview_truncates_long_body_to_utf16_limit(), truncated_preview_carries_no_approval_button_and_persists_no_action_request(), parse_audit_event(), Value, shadow_grant_effect_suppressed_skips_effect_handler(), test_path_1_notify_owner_gated_and_audited(), test_path_2_create_draft_payload_mutated_audited() (+71 more)
...
Cohesion: 0.23
Nodes (11): ActionHandler, activate_approved_artifact(), Result, RwLock, AppState, kernel_notify_grant(), notify_owner_best_effort(), notify_owner_required() (+3 more)
...
Cohesion: 0.20
Nodes (11): PostApprovalFuture, PostApprovalHandler, create_approved_draft(), handle_draft_approval_callback(), handle_plan_approval_callback(), resolve_approved_plan(), handle_activate_artifact(), handle_create_approved_draft() (+3 more)
...
Cohesion: 0.25
Nodes (6): Result, run_benchmarks(), Instant, Cli, main(), shutdown_signal()
...
Cohesion: 0.28
Nodes (5): action_id_qualifier_is_part_of_identity(), action_id_serializes_as_bare_string(), DenialReason, EffectPathClass, GateDecision
...
Cohesion: 0.06
Nodes (46): AgentManifest, ArtifactKindSpec, ArtifactLoadError, ArtifactRegistry, CapabilityPack, collide_keyed(), collide_route(), find_kind_spec() (+38 more)
...
## Knowledge Gaps
- **1410 isolated node(s):** `set.sh script`, `autoresearch.sh script`, `TelegramReplyPayload`, `ReadThreadPayload`, `ArtifactProposePayload` (+1405 more)
...
- **Why does `Digest` connect `.put` to `.default`, `Requirements`, `Requirements`, `opsx-explore.md`, `Requirements`, `.sweep_expired_grants`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `AppState` connect `compose_authority` to `properties`, `D-023 — OpenSpine is the substrate; Lyra is a product built on it`, `SKILL.md`, `properties`, `Requirements`, `README.md`, `ADDED Requirements`, `Requirements`, `AppState`, `D-049 — Capability specs are backfilled for subsystems implemented inside earlier slices`?**

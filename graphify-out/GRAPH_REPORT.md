# Graph Report - implement-event-bus-subscriptions  (2026-07-16)

## Corpus Check
- 263 files · ~188,408 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3298 nodes · 4061 edges · 661 communities (281 shown, 380 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 401 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `61440b0d`
...
1. `gate()` - 39 edges
2. `test_catalog()` - 31 edges
3. `handle_owner_update()` - 31 edges
4. `request_for()` - 28 edges
5. `StoreError` - 28 edges
...
## Communities (661 total, 380 thin omitted)
...
### Community 1 - ".new"
Cohesion: 0.08
Nodes (48): deny_limit_exceeded(), GenerateRequestBody, GenerateResponseBody, post_model_generate(), template_id_for_agent(), email_reply_drafter_grant(), email_reply_drafter_template_wraps_untrusted_context_on_the_wire(), grant_with_limits() (+40 more)

### Community 2 - "event.rs"
Cohesion: 0.08
Nodes (25): ConsumerError, IdempotentConsumer, PersistedConsumerState, F, HashSet, Into, Option, Result (+17 more)
...
Cohesion: 0.07
Nodes (30): PromptTemplate, T, canonical_catalog(), test_catalog_effect_paths_are_fully_enumerated_and_classified(), AgentManifest, ArtifactKindSpec, ArtifactLoadError, ArtifactRegistry (+22 more)
...
### Community 10 - ".put"
Cohesion: 0.11
Nodes (26): AccountRole, ActorHint, ChannelTrust, Connector, DataClassification, EventEnvelope, EventType, InteractionMode (+18 more)

### Community 11 - "ProposedArtifact"
Cohesion: 0.07
Nodes (71): activation_with_mutated_payload_is_denied(), approve_callback_update(), approved_artifact_activates_into_registry_and_overlay(), mount_send_message_ok(), telegram_stub(), artifact_propose_persists_and_sends_approval_button(), artifact_propose_rejects_duplicate_id_version(), artifact_propose_rejects_malformed_yaml() (+63 more)
...
Cohesion: 0.18
Nodes (13): Arc, Connection, Error, Mutex, Option, Path, Result, Self (+5 more)
...
Cohesion: 0.16
Nodes (13): ActionHandler, PostApprovalFuture, RwLock, ActionHandlerRegistry, create_approved_draft(), handle_draft_approval_callback(), activate_approved_artifact(), AppState (+5 more)
...
Cohesion: 0.10
Nodes (21): AsRef, LedgerEntry, AuditEvent, AuditKind, AuditKindError, default_aggregate_id(), genesis_hash(), round_trips_through_serde() (+13 more)
...
Cohesion: 0.30
Nodes (8): Connection, Option, Result, Ulid, Store, genesis_digest(), ArtifactRef, digest_matches_hash()
...
Cohesion: 0.08
Nodes (47): BuildEnvelopeFn, Future, GrantBindingFn, Output, Pin, PostApprovalHandler, PreflightFn, RouteGuardFn (+39 more)
...
Cohesion: 0.10
Nodes (17): Ok, Serialize, Sha256, CanonicalValue, CanonicalValue<'a>, Digest, digest_from_hash(), digest_of() (+9 more)
...
## Knowledge Gaps
- **1198 isolated node(s):** `autoresearch.sh script`, `TelegramReplyPayload`, `ReadThreadPayload`, `ArtifactProposePayload`, `TokenResponse` (+1193 more)
...
- **Why does `Digest` connect `add_column_if_missing` to `Requirements`, `ADDED Requirements`, `OpenSpine Agent-OS Design Log`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `digest_of()` connect `add_column_if_missing` to `AppState`, `AppState`, `ProposedArtifact`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `run_pipeline()` connect `editUrl` to `mod.rs`, `ProposedArtifact`?**

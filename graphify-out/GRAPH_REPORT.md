# Graph Report - openspine  (2026-07-23)

## Corpus Check
- 580 files · ~469,647 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8213 nodes · 10737 edges · 1841 communities (600 shown, 1241 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1418 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5c51ded6`
...
## Communities (1841 total, 1241 thin omitted)
...
Cohesion: 0.10
Nodes (13): action_id_qualifier_is_part_of_identity(), action_id_serializes_as_bare_string(), ActionCatalog, ActionEgressDeclaration, ActionId, ActionRequest, DenialReason, EffectPath (+5 more)
...
### Community 4 - ".default"
Cohesion: 0.10
Nodes (30): approval_required_is_ok_not_err(), counterparty_denial_preserves_only_canonical_deferral(), deny_decision_is_ok_not_err(), generate_sends_bearer_auth(), generate_sends_untrusted_context_in_body(), get_task_deserializes_selection_tokens(), get_task_sends_bearer_auth(), submit_action_sends_bearer_auth() (+22 more)
...
Cohesion: 0.09
Nodes (56): draft_command_composes_email_preview_grant_whose_pending_ref_is_derived_message(), draft_command_for_a_missing_thread_mints_no_grant(), draft_command_for_a_real_thread_composes_a_bound_selection_grant(), draft_command_is_refused_without_the_unsafe_flag_under_process_driver(), draft_command_with_gmail_api_error_audits_no_event_received(), draft_command_without_gmail_configured_is_a_no_op(), plan_preview_records_telegram_failure_counter_on_send_error(), concurrent_owner_callbacks_are_serialized_by_handler() (+48 more)

### Community 8 - "mod.rs"
Cohesion: 0.08
Nodes (39): CounterpartyEraseError, erase_counterparty(), ErasureReport, activated_standing_rule_becomes_unusable_after_source_scope_erasure(), active_model_swap_disappears_from_active_ids_after_source_scope_erasure(), chain_verification_passes_after_erasure(), ciphertext_remains_on_disk_but_is_unrecoverable_after_erase(), cleanup_retry_returns_terminal_identities_with_zero_new_changes() (+31 more)
...
Cohesion: 0.15
Nodes (27): artifact_propose_persists_and_sends_approval_button(), artifact_propose_rejects_duplicate_id_version(), artifact_propose_rejects_malformed_yaml(), artifact_propose_rejects_non_proposed_lifecycle(), artifact_propose_rejects_persona_kind(), artifact_propose_rejects_template_kind(), artifact_propose_rejects_unknown_kind(), injected_activation_tx_failure_keeps_approved_old_state() (+19 more)
...
Cohesion: 0.18
Nodes (17): BuildEnvelopeFn, GrantBindingFn, PreflightFn, RouteGuardFn, email_preview_lane(), LaneSpec, owner_control_lane(), scheduled_internal_lane() (+9 more)
...
Cohesion: 0.16
Nodes (23): connector_failure_batches_and_is_audited(), counter_persistence_failure_is_durably_batched_as_resource(), immediate_failure_cannot_enter_digest_lane(), digest_detail_corrupt_blob_surfaces_resource_without_leak(), digest_detail_immediate_success_outcome_audit_failure_is_delivery_unknown_and_no_retry(), digest_detail_missing_blob_surfaces_resource_without_leak(), digest_detail_not_found_is_truthful(), digest_detail_retry_emits_viewed_receipt_exactly_once() (+15 more)
...
Cohesion: 0.18
Nodes (22): aead_associated_data_scope_tamper_fails_decrypt(), bit_flipped_ciphertext_fails_aead(), clear_upgrade_pending_sync_failure_retains_marker_for_retry(), cross_counterparty_dedup_does_not_defeat_erasure(), different_content_is_different_ref(), erased_counterparty_payload_is_unrecoverable(), existing_blob_retry_durability_resyncs(), format2_post_rename_sync_failure_recovers_once_without_syncing_steady_state_reads() (+14 more)
...
Cohesion: 0.15
Nodes (27): alias_survival_prevented_and_temp_cleaned_on_publication_and_startup(), already_locked_legacy_lookup_migrates_without_re_locking(), associated_data_binds_counterparty_id_and_rejects_key_substitution(), closed_scope_in_memory_blocks_get_and_create(), concurrent_first_use_is_race_free(), creates_and_persists_a_key(), different_scopes_do_not_contend(), distinct_counterparties_get_distinct_keys() (+19 more)
...
Cohesion: 0.07
Nodes (57): denied_read_thread_stops_without_drafting(), Draft, draft_reply(), empty_draft_skips_preview_without_error(), format_thread_for_model(), format_thread_for_model_includes_all_fields(), full_flow_reads_drafts_and_previews(), no_selection_tokens_is_an_error() (+49 more)
...
Cohesion: 0.17
Nodes (16): ActorHint, Connector, EventEnvelope, EventType, InteractionMode, Lane, legacy_without_thread_id_defaults_to_none(), round_trips_through_serde() (+8 more)
...
Cohesion: 0.18
Nodes (10): MutexGuard, ConversationClaimGuard, ConversationClaimGuard<'a>, handle_worker_commission(), claim_conversation_in_flight(), connector_restart_cap_available(), release_conversation_in_flight(), release_conversation_in_flight_for_grant() (+2 more)
...
Cohesion: 0.06
Nodes (50): authenticate(), bearer_token(), internal_error(), unauthorized(), briefcase(), get_task(), get_task_emits_empty_output_channels_for_worker_grant(), TaskLimitsBody (+42 more)
...
Cohesion: 0.05
Nodes (77): PromotionDenial, SkillRow, dispatch_skill_context(), skill_context_rejects_unknown_grant_purpose(), skill_context_selects_only_grant_scoped_installed_matches(), task_class_from_grant_purpose(), CeremonyError, CeremonyToken (+69 more)
...
Cohesion: 0.22
Nodes (18): persona_overlay_dir(), repair_persona_file(), seed_definitions(), seed_if_missing(), stage_persona(), a_committed_row_with_a_missing_file_self_heals_without_new_provenance(), a_corrupt_existing_file_is_repaired_to_the_row_digest(), audit_failure_rolls_back_learned_row_and_seeded_receipt() (+10 more)

### Community 107 - "OpenSpine"
Cohesion: 0.17
Nodes (8): CounterpartyKeyRing, ArtifactStore, ArtifactStoreError, concurrent_marker_recovery_and_missing_marker_clear_are_idempotent(), corrupt_scoped_target_with_valid_flat_source_fails_migration(), fsync_dir(), legacy_blobs_migrate_under_system_scope(), legacy_migration_recovers_from_crash_between_write_and_cleanup()
...
Cohesion: 0.22
Nodes (16): digest_of_bytes(), legacy_blob_with_tag_colliding_nonce_still_migrates(), prune_non_highest_active_preserves_persona_typed_and_source_entries(), accepted_dependency_fingerprint_migration_is_idempotent(), accepted_dependency_fingerprint_round_trips(), activation_cannot_replace_erased_identity_with_other_scope(), base_namespace_cannot_be_recorded_as_learned(), learned_artifact_round_trip_preserves_typed_provenance() (+8 more)
...
Cohesion: 0.11
Nodes (24): bounded_preview(), content_diff_summary(), kernel_notify_grant(), notify_owner_required(), notify_owner_required_outcome(), notify_owner_with_digest(), NotifyOutcome, record_notify_skipped() (+16 more)
...
Cohesion: 0.11
Nodes (20): PostApprovalFuture, PostApprovalHandler, create_approved_draft(), emit_preflight_failure(), activate_approved_artifact(), finalize_nomination(), NominationAssertion, ArtifactNamespace (+12 more)
...
Cohesion: 0.26
Nodes (11): String, truncate_for_telegram(), truncate_with_notice(), call_with_connector(), dispatch_lyra_preview(), dispatch_read_selected_thread(), DispatchError, PreviewPayload (+3 more)
...
Cohesion: 0.21
Nodes (7): ActionHandler, Fn, Cli, commit_post_bind_clock(), main(), shutdown_signal(), ActionHandlerRegistry
...
Cohesion: 0.22
Nodes (3): handle_artifact_nominate(), handle_artifact_propose(), handle_lyra_preview()
...
Cohesion: 0.36
Nodes (3): ProposalError, FailureClass, notify_immediate_failure()

### Community 359 - "Option"
Cohesion: 0.46
Nodes (6): artifact_ref(), briefcase(), commission(), key(), restart_caps_hold_under_flaky_connector(), worker_crash_emits_structured_failure_and_requires_recomposition()
...
## Knowledge Gaps
- **2448 isolated node(s):** `set.sh script`, `autoresearch.sh script`, `TelegramReplyPayload`, `ReadThreadPayload`, `ArtifactNominatePayload` (+2443 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **1241 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `test_state()` connect `config.rs` to `Tasks: Define OpenSpine development process`, `D-004 — Every effectful action goes through `gate()``, `standing_rule_timer.rs`, `ProposedArtifact`, `Display`, `client.rs`, `Proposal: Define core runtime schemas`, `D-037 — Gmail OAuth via a plain refresh-token POST (no `oauth2` crate); `base64` promoted from transitive to direct dependency`, `Approach`, `artifact_propose.rs`, `action.rs`, `approval.rs`, `Proposal: Backfill implemented capability specs`, `AppState`, `Proposal: Implement artifact lifecycle slice`, `Lifecycle`, `Tasks: Refactor kernel registries`, `Requirements`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `handle_owner_update()` connect `config.rs` to `decisions.md`, `D-004 — Every effectful action goes through `gate()``, `Tasks: Define OpenSpine development process`, `standing_rule_timer.rs`, `D-028 — Canonical artifact format is YAML+serde; digests are `sha256:` over canonical JSON`, `ProposedArtifact`, `Display`, `D-032 — Kernel↔shell transport is HTTP/JSON with a per-task bearer token`, `Proposal: Define core runtime schemas`, `Approach`, `action.rs`, `opsx-apply.md`, `Lifecycle`, `ADDED Requirements`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `digest_of_bytes()` connect `Failure surfacing & operations` to `.default`, `GmailConnector`, `ADDED Requirements`, `standing_rule_timer.rs`, `mod.rs`, `openspine-decision-log.md`, `.put`, `OpenSpine`, `ProposedArtifact`, `digest.rs`, `check-claims.sh`, `Requirements`, `README.md`, `content.d.ts`, `opsx-apply.md`, `Proposal: Implement selected-thread email preview slice`, `AuditEvent`, `Requirements`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Are the 97 inferred relationships involving `test_state()` (e.g. with `draft_command_without_gmail_configured_is_a_no_op()` and `artifact_propose_rejects_non_proposed_lifecycle()`) actually correct?**
  _`test_state()` has 97 INFERRED edges - model-reasoned connections that need verification._
- **Are the 90 inferred relationships involving `handle_owner_update()` (e.g. with `draft_command_composes_email_preview_grant_whose_pending_ref_is_derived_message()` and `draft_command_for_a_missing_thread_mints_no_grant()`) actually correct?**
  _`handle_owner_update()` has 90 INFERRED edges - model-reasoned connections that need verification._
- **Are the 85 inferred relationships involving `owner_update()` (e.g. with `draft_command_composes_email_preview_grant_whose_pending_ref_is_derived_message()` and `draft_command_for_a_missing_thread_mints_no_grant()`) actually correct?**
  _`owner_update()` has 85 INFERRED edges - model-reasoned connections that need verification._
- **Are the 76 inferred relationships involving `test_state_with_telegram()` (e.g. with `lyra_ui_preview_sends_telegram_reply_to_grant_bound_chat()` and `lyra_ui_preview_truncates_long_body_to_utf16_limit()`) actually correct?**

# Graph Report - implement-nerve-subscribers  (2026-07-18)

## Corpus Check
- 449 files · ~331,881 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6005 nodes · 7816 edges · 1264 communities (453 shown, 811 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 953 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bd1d49c3`
...
8. `StoreError` - 32 edges
9. `test_catalog()` - 30 edges
10. `digest_of_bytes()` - 30 edges
...
## Communities (1264 total, 811 thin omitted)

### Community 0 - "README.md"
Cohesion: 0.06
Nodes (60): class_digest(), advisee_scope(), concurrent_cross_connection_admission_spends_once(), declaration(), provenance(), ensure_schema(), filter_within_scope(), class_digest() (+52 more)
...
Cohesion: 0.12
Nodes (36): apply_compatibility(), dangling_for_parsed(), ensure_reconfirm_request(), exclude_orphans(), find_orphans(), missing_provenance(), OrphanedArtifact, owner_accepted_newly_dangling() (+28 more)
...
Cohesion: 0.20
Nodes (17): Future, Output, Pin, Send, GmailFailureClass, emit_preflight_failure(), email_build_envelope(), email_preflight() (+9 more)

### Community 15 - "ADDED Requirements"
Cohesion: 0.18
Nodes (12): bounded_json_response(), CachedToken, extract_email_address(), GmailConnector, GmailError, GmailMessage, GmailThread, http_client() (+4 more)

### Community 16 - "Requirements"
Cohesion: 0.38
Nodes (18): digest_of_bytes(), highest_active_prunes_stale_loaded_lower_version(), missing_highest_blob_fails_closed_no_rollback(), on_disk_artifact_without_active_proposal_is_excluded(), active_v2_survives_stale_approved_v1_recovery(), approved_dangling_recovery_quarantines_and_requests_reconfirm(), commit_before_publish_crash_republishes_exact_active_ref(), fixture() (+10 more)
...
Cohesion: 0.06
Nodes (53): BTreeSet, Briefcase, BriefcaseError, BriefcaseSection, CounterpartyRef, depth(), LearnedSource, pack() (+45 more)
...
Cohesion: 0.12
Nodes (22): BuildEnvelopeFn, Option, Result, Vec, run_pipeline(), email_lane_executed_stage_trace_matches_sync_prefix(), email_lane_marker_is_not_owner_control_screened(), email_lane_preflight_resolves_counterparty_into_persisted_briefcase() (+14 more)
...
Cohesion: 0.17
Nodes (17): bind_consumer_conn(), ConsumerError, IdempotentConsumer, LedgerEntry, PersistedConsumerState, Connection, F, HashSet (+9 more)
...
Cohesion: 0.18
Nodes (23): digest_of(), artifact_propose_persists_and_sends_approval_button(), artifact_propose_rejects_duplicate_id_version(), artifact_propose_rejects_malformed_yaml(), injected_activation_tx_failure_keeps_approved_old_state(), activation_with_mutated_payload_is_denied(), approve_callback_update(), approved_artifact_activates_into_registry_and_overlay() (+15 more)
...
Cohesion: 0.16
Nodes (15): AgentManifest, ArtifactRef, Duration, IntoIterator, Item, Option, Result, String (+7 more)
...
Cohesion: 0.23
Nodes (18): apply_top_up(), apply_top_up_for_grant(), apply_top_up_for_grant_atomic(), BriefcaseKernelError, email_address_hash(), grant_view(), pack_for_pipeline(), pack_for_task() (+10 more)
...
Cohesion: 0.21
Nodes (13): bindings_valid(), chain_structurally_valid(), ct_eq_hex(), effectively_allows(), effectively_allows_output_channel(), effectively_approval_required(), flattened_caveats(), has_unsupported_caveats() (+5 more)
...
Cohesion: 0.06
Nodes (31): advisee_ids(), advisee_scope_of(), atomic_ingestion_emits_no_signal_for_clean_text(), atomic_ingestion_emits_signal_on_marker(), dispatch_revokes_registration_when_limits_disappear(), dummy_ref(), issuance_count(), manifest() (+23 more)

### Community 76 - "Tasks: Harden approval and budgets"
Cohesion: 0.25
Nodes (17): Caveat, caveat_bytes(), ChainStep, compute_mac_hex(), compute_tip(), hex_decode_32(), hex_encode(), hmac_sha256() (+9 more)
...
Cohesion: 0.25
Nodes (7): grant(), GrantLimits, legacy_missing_chain_defaults_but_fails_closed(), legacy_without_thread_id_defaults_to_none(), round_trip_and_mac(), thread_id_round_trips_when_populated(), empty_session_policy()
...
Cohesion: 0.05
Nodes (47): PostApprovalFuture, PostApprovalHandler, kernel_notify_grant(), notify_owner_best_effort(), notify_owner_required_outcome(), notify_owner_with_digest(), NotifyOutcome, record_notify_skipped() (+39 more)
...
Cohesion: 0.45
Nodes (12): email_read_selected_thread_rejects_expired_token(), email_read_selected_thread_rejects_foreign_grant(), email_read_selected_thread_rejects_malformed_payload(), email_read_selected_thread_rejects_second_use(), email_read_selected_thread_returns_thread_via_mocked_gmail(), gmail_connector(), mint_grant_with_selection_token(), mount_gmail_thread_endpoint() (+4 more)
...
Cohesion: 0.27
Nodes (13): adding_thread_binding_without_resealing_invalidates_mac(), caveat_reorder_or_remove_invalidates_mac(), child_derives_from_parent_tip_without_root_key(), egress_class_tamper_invalidates_root_mac(), id_parent_and_action_list_tamper_fail(), identity_field_tamper_invalidates_mac(), legacy_grant_without_thread_id_still_verifies(), pre_egress_grant_mac_still_verifies_after_upgrade() (+5 more)
...
Cohesion: 0.22
Nodes (12): Cli, commit_post_bind_clock(), grant_hmac_key(), main(), nerve_delivery_handoff_complete(), Option, PathBuf, Result (+4 more)

### Community 132 - "D-022 — Agent-owned inbox is distinct from owner mailbox access"
Cohesion: 0.15
Nodes (12): Consequences, Consequences, D-045 — WYSIWYS: a truncated preview refuses an approval button rather than splitting the message, D-046 — Grant budgets are enforced kernel-dispatch-side; the artifact budget counts only shell-initiated puts, Decision, Decision, Decision Index, Lyra PRD Companion — Decisions Log (+4 more)
...
Cohesion: 0.31
Nodes (10): ActionRequestBody, ActionResponseBody, dispatch_allowed_action(), dispatch_read_selected_thread(), DispatchError, FailureSurface, mediate_and_dispatch_action(), post_actions() (+2 more)
...
Cohesion: 0.20
Nodes (6): ActionHandler, Instant, OwnedMutexGuard, RwLock, ActionHandlerRegistry, AppState
...
### Community 465 - "Self"
Cohesion: 0.60
Nodes (4): learned_template_row(), orphan_active_yaml_without_db_row_is_quarantined(), overlay_template_yaml(), reconfirmed_legacy_template_stays_live_across_restart()
...
## Knowledge Gaps
- **1898 isolated node(s):** `autoresearch.sh script`, `TelegramReplyPayload`, `ReadThreadPayload`, `ArtifactNominatePayload`, `ArtifactProposePayload` (+1893 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **811 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `run_pipeline()` connect `Lifecycle` to `Tasks: Implement Telegram owner control slice`, `config.rs`, `create_approved_draft`, `Gmail selected-thread email preview setup (Phase 2)`, `actions.rs`, `Design: OpenSpine development process`, `post_action`, `Requirements`, `effect_paths.rs`, `HeaderMap`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `TaskGrant` connect `create_approved_draft` to `Tasks: Implement Telegram owner control slice`, `Lifecycle`, `Tasks: Harden approval and budgets`, `ApprovalRecord`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `StoreError` connect `ApprovalRecord` to `Agent-OS change sequence (2026-07-07, AD canon)`, `ArtifactRef`, `Requirements`?**
...
- **Are the 46 inferred relationships involving `test_state()` (e.g. with `owner_lane_executed_stage_trace_matches_sync_prefix()` and `owner_lane_without_verified_context_fails_closed_before_grant()`) actually correct?**

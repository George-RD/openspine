# Graph Report - implement-worker-runtime  (2026-07-18)

## Corpus Check
- 487 files · ~368,938 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6635 nodes · 9387 edges · 1267 communities (495 shown, 772 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1105 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e1e602a9`
...
1. `AppState` - 87 edges
2. `TaskGrant` - 86 edges
3. `handle_owner_update()` - 78 edges
4. `owner_update()` - 68 edges
5. `ActionId` - 63 edges
6. `gate()` - 58 edges
7. `test_state_with_telegram()` - 58 edges
8. `StoreError` - 53 edges
9. `test_state()` - 50 edges
10. `request_for()` - 39 edges
...
- `search_class_pack_cannot_submit_web_form()` --calls--> `gate()`  [INFERRED]
  crates/openspine-kernel/src/connectors_tests.rs → crates/openspine-gate/src/gate.rs
- `reconfirm_legacy_migration_establishes_produced_by_and_proposal()` --calls--> `route_yaml()`  [INFERRED]
  crates/openspine-kernel/src/api/reconfirm_tests.rs → crates/openspine-kernel/src/api/artifact_propose_tests.rs
...
- `immediate_failure_cannot_enter_digest_lane()` --calls--> `batch_failure()`  [INFERRED]
  crates/openspine-kernel/src/failure_surfacing/tests.rs → crates/openspine-kernel/src/failure_surfacing.rs
...
## Communities (1267 total, 772 thin omitted)
...
Cohesion: 0.20
Nodes (36): gate(), allowed_action_returns_allow(), allowed_plus_approval_required_returns_approval_required(), allowed_plus_denied_returns_deny(), approval_required_action_does_not_execute(), approval_required_action_returns_approval_required(), approved_but_payload_changed_since_is_denied_not_reasked(), audit_metadata_records_action_grant_and_refs_not_plaintext() (+28 more)

### Community 7 - "config.rs"
Cohesion: 0.12
Nodes (47): handle_owner_update(), Result, audit_append_failure_fails_notification_before_connector_effect(), audit_readonly_failure_fails_notification_before_connector_effect(), disk_full_audit_append_aborts_before_connector_effect(), draft_command_composes_email_preview_grant_whose_pending_ref_is_derived_message(), draft_command_for_a_missing_thread_mints_no_grant(), draft_command_for_a_real_thread_composes_a_bound_selection_grant() (+39 more)
...
Cohesion: 0.18
Nodes (25): dispatch_artifact_propose(), Option, Result, Value, approve_callback_update(), mount_send_message_ok(), orphaned_reconfirm_fixture(), reconfirm_legacy_migration_establishes_produced_by_and_proposal() (+17 more)
...
Cohesion: 0.13
Nodes (28): DenialReason, GateDecision, allow_and_suppressed_do_not_surface(), approval_required_surfaces_as_deferral_with_approval_missing(), denial_reason_code(), deny_surfaces_canonical_deferral_and_escalation(), escalation_notice_round_trips(), EscalationEvent (+20 more)
...
Cohesion: 0.15
Nodes (27): ActionRequestBody, ActionResponseBody, dispatch_lyra_preview(), dispatch_read_selected_thread(), DispatchError, FailureSurface, guard_connector_dispatch(), mediate_and_dispatch_action() (+19 more)
...
Cohesion: 0.16
Nodes (20): ArtifactStore, ArtifactStoreError, different_content_is_different_ref(), get_is_idempotent(), hex_encode(), key(), round_trips_plaintext(), Aes256Gcm (+12 more)

### Community 27 - "Lifecycle"
Cohesion: 0.12
Nodes (22): BuildEnvelopeFn, Option, Result, Vec, run_pipeline(), GrantBindingFn, PreflightFn, RouteGuardFn (+14 more)
...
Cohesion: 0.17
Nodes (26): find_task_grant_by_token_rejects_the_raw_hash_value(), persisted_grant_json_contains_no_task_token(), sample_grant(), task_grant_round_trips_by_token(), classified_empty_output_channel_denial(), commission(), commission_is_receipt_idempotent(), commission_receipt_binding_rejects_different_parent_or_request() (+18 more)
...
Cohesion: 0.21
Nodes (24): commissioned_grant_for_receipt(), CommissionReceipt, ensure_schema(), mark_worker_stranded_notified(), pending_worker_dispatches(), record_worker_commissioned(), record_worker_result(), ArtifactRef (+16 more)
...
Cohesion: 0.11
Nodes (9): encrypt_digest_detail(), FailureClass, notify_immediate_failure(), record_callback_ack(), record_connector_outcome(), record_connector_outcome_or_batch(), connector_failure_batches_and_is_audited(), counter_persistence_failure_is_durably_batched_as_resource() (+1 more)
...
Cohesion: 0.16
Nodes (17): notify_owner_required(), Result, notify_owner_required_errors_and_audits_on_send_failure(), notify_owner_required_succeeds_when_sent(), notify_owner_with_digest_records_success_counter(), notify_send_failure_records_attempt_failure_and_dead_letter(), parse_audit_event(), required_send_failure_keeps_dlq_when_counter_persistence_breaks() (+9 more)

### Community 78 - "explore.md"
Cohesion: 0.23
Nodes (17): action_for(), arm(), CaptureOutcome, kind_prefix(), owner_grant(), parse_command(), Pending, rollback_secret() (+9 more)
...
Cohesion: 0.07
Nodes (47): deny_limit_exceeded(), GenerateRequestBody, GenerateResponseBody, post_model_generate(), Arc, HeaderMap, Json, Option (+39 more)

### Community 92 - "Agent-OS change sequence (2026-07-07, AD canon)"
Cohesion: 0.14
Nodes (25): ActionHandler, egress_declarations(), id(), Vec, ActionHandlerRegistry, handle_artifact_nominate(), handle_artifact_propose(), handle_lyra_preview() (+17 more)
...
Cohesion: 0.25
Nodes (14): grant_with_token(), make_token(), MockContext, request_for_token(), HashMap, Option, Ulid, Vec (+6 more)

### Community 98 - "Tasks: Implement Telegram owner control slice"
Cohesion: 0.24
Nodes (17): artifact_ref(), checkpoint_last_acked(), checkpoint_load_error_fails_closed_without_replay(), commission_and_record(), parent_grant(), ArtifactRef, Briefcase, Option (+9 more)
...
Cohesion: 0.27
Nodes (9): PostApprovalFuture, finalize_nomination(), NominationAssertion, handle_activate_artifact(), handle_create_approved_draft(), handle_nominate_upstream(), handle_reconfirm_artifact(), handle_resolve_approved_plan() (+1 more)
...
Cohesion: 0.16
Nodes (20): bind_email_identity(), email_counterparty_resolves_to_bound_identity_when_address_is_bound(), email_counterparty_stays_unresolved_when_address_is_unbound(), minimal_grant(), mint_topup_grant(), post_topup(), topup_granted_grant_mutates_briefcase_atomically(), topup_oversized_section_key_is_rejected_without_persistence() (+12 more)
...
Cohesion: 0.05
Nodes (44): add_column_if_missing(), apply_ad_hoc_migrations(), apply_single_migration_for_test(), apply_single_migration_inner(), apply_versioned_migrations(), latest_user_version(), read_user_version(), revert_versioned_migrations_for_test() (+36 more)
...
Cohesion: 0.30
Nodes (14): handle_worker_commission(), handle_worker_report_result(), ArtifactRef, HandlerFuture, Option, String, Value, Vec (+6 more)

### Community 123 - "D-001 — Lyra is a runtime/substrate, not a single agent"
Cohesion: 0.05
Nodes (38): complete_u32(), divergent_inputs_fail_closed(), ledger_corruption_fails_closed(), ModelOutput, atomic_grant_and_briefcase_persists_both_on_success(), atomic_grant_and_briefcase_rolls_back_on_briefcase_failure(), minimal_briefcase(), breaker_transitions_closed_open_half_open_closed() (+30 more)
...
Cohesion: 0.08
Nodes (33): activate_approved_artifact(), Result, kernel_notify_grant(), notify_owner_best_effort(), notify_owner_required_outcome(), notify_owner_with_digest(), NotifyOutcome, record_notify_skipped() (+25 more)
...
Cohesion: 0.18
Nodes (15): dispatch_artifact_nominate(), Option, Result, Value, call_with_connector(), call_with_connector_preflight(), call_with_connector_write(), confirmed_gmail_api_write_failure_is_connector_error() (+7 more)
...
Cohesion: 0.07
Nodes (53): client_error(), get_briefcase(), post_topup(), Arc, Display, HeaderMap, Json, Path (+45 more)
...
Cohesion: 0.31
Nodes (11): ArtifactRef, Option, Self, String, Vec, WorkerBoundParameter, WorkerCommissionSpec, WorkerOutcome (+3 more)

### Community 157 - "D-050 — `max_model_calls` is enforced with an atomic upsert, not a count-then-compare"
Cohesion: 0.15
Nodes (12): Consequences, Consequences, D-062 — Active model swaps require symmetric DB and overlay provenance, D-099 — Connector breakers use sliding-window failure accounting, Decision, Decision, Decision Index, Lyra PRD Companion — Decisions Log (+4 more)
...
Cohesion: 0.26
Nodes (11): canonical_catalog(), counterparty_classification_is_kernel_owned_and_fails_closed(), handler_registry_requires_explicit_classification(), id(), test_catalog_effect_paths_are_fully_enumerated_and_classified(), worker_actions_declare_no_egress_and_no_output_channel(), gate_request(), narrowed_gate_worker() (+3 more)
...
Cohesion: 0.11
Nodes (15): Option, ActionCatalog, ActionEgressDeclaration, EffectPath, EffectPathClass, HashMap, HashSet, Into (+7 more)
...
### Community 487 - "Timestamp"
Cohesion: 0.17
Nodes (19): ActionOrigin, AuditMeta, chain_valid(), EgressClassifier, GateContext, GateOutcome, NoEgress, resolve() (+11 more)
...
Cohesion: 0.10
Nodes (10): ArtifactNominatePayload, String, ArtifactProposePayload, String, action_id_qualifier_is_part_of_identity(), action_id_serializes_as_bare_string(), ArtifactRef, Ulid (+2 more)
...
### Community 637 - "Error"
Cohesion: 0.32
Nodes (13): child_cannot_widen_parent_action(), child_cannot_widen_parent_expiry(), commission_spec(), direct_worker_egress_impossible(), mint_task_token(), mint_worker_grant(), minted_worker_has_empty_output_channels_despite_parent(), MintError (+5 more)

## Knowledge Gaps
- **2036 isolated node(s):** `autoresearch.sh script`, `TokenResponse`, `GmailConnector`, `IdentityResolver`, `NominationAssertion` (+2031 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **772 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `AppState` connect `banner` to `D-004 — Every effectful action goes through `gate()``, `Option`, `config.rs`, `telegram.rs`, `.put`, `client.rs`, `Reflection & product surface`, `content.d.ts`, `D-037 — Gmail OAuth via a plain refresh-token POST (no `oauth2` crate); `base64` promoted from transitive to direct dependency`, `AppState`, `.sweep_expired_grants`, `Lifecycle`, `D-013 — Dynamic behavior easy; dynamic authority hard`, `Requirements`, `Implementation notes`, `properties`, `explore.md`, `Result`, `Proposal: Define core runtime schemas`, `Tasks: Implement selected-thread email preview slice`, `Proposal: Harden approval and budgets`, `Tasks: Implement artifact lifecycle slice`, `Agent-OS change sequence (2026-07-07, AD canon)`, `Tasks: Implement Telegram owner control slice`, `D-008 — Deterministic routing decides authority; agentic routing decides strategy`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `TaskGrant` connect `D-005 — Private-data shell must be contained` to `Option`, `artifact_loader.rs`, `config.rs`, `banner`, `telegram.rs`, `ProposedArtifact`, `Reflection & product surface`, `package.json`, `D-037 — Gmail OAuth via a plain refresh-token POST (no `oauth2` crate); `base64` promoted from transitive to direct dependency`, `AppState`, `Lifecycle`, `ArtifactRef`, `properties`, `D-029 — Gmail OAuth scopes: `readonly` + `compose`, send hard-denied at the gate`, `Implementation notes`, `explore.md`, `Proposal: Define core runtime schemas`, `Agent-OS change sequence (2026-07-07, AD canon)`, `Tasks: Implement digest-bound draft approval`, `Tasks: Implement Telegram owner control slice`, `Timestamp`, `Tasks: Implement gate action API`, `D-008 — Deterministic routing decides authority; agentic routing decides strategy`, `Error`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `ActionId` connect `Agent-OS change sequence (2026-07-07, AD canon)` to `D-005 — Private-data shell must be contained`, `Option`, `Timestamp`, `telegram.rs`, `D-029 — Gmail OAuth scopes: `readonly` + `compose`, send hard-denied at the gate`, `D-048 — `artifact.activate` is the single canonical activation action id; every runtime proposal requires uniform owner approval; prompt templates are excluded from proposable kinds`, `Implementation notes`, `explore.md`, `ProposedArtifact`, `Result`, `AppState`, `D-008 — Deterministic routing decides authority; agentic routing decides strategy`, `Tasks: Implement artifact lifecycle slice`, `D-049 — Capability specs are backfilled for subsystems implemented inside earlier slices`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Are the 71 inferred relationships involving `handle_owner_update()` (e.g. with `orphaned_reconfirm_fixture()` and `reconfirm_legacy_migration_establishes_produced_by_and_proposal()`) actually correct?**
  _`handle_owner_update()` has 71 INFERRED edges - model-reasoned connections that need verification._
- **Are the 67 inferred relationships involving `owner_update()` (e.g. with `approve_callback_update()` and `orphaned_reconfirm_fixture()`) actually correct?**
  _`owner_update()` has 67 INFERRED edges - model-reasoned connections that need verification._
- **What connects `autoresearch.sh script`, `TokenResponse`, `GmailConnector` to the rest of the system?**

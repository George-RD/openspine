...
## Corpus Check
- 350 files · ~248,132 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4462 nodes · 5743 edges · 840 communities (359 shown, 481 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 712 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3a5a9bb6`
...
## Communities (840 total, 481 thin omitted)
...
### Community 4 - ".default"
Cohesion: 0.07
Nodes (32): canonical_catalog_covers_all_fixture_action_ids(), PromptTemplate, T, AgentManifest, ArtifactKindSpec, ArtifactLoadError, ArtifactRegistry, CapabilityPack (+24 more)
...
Cohesion: 0.05
Nodes (43): AtomicBool, counterparty_resolves_identity_but_no_principal(), handle_owner_bind(), IdentityResolver, IdentityResolver<'a>, owner_verified_path_resolves_owner_principal_and_relationship(), Option, Result (+35 more)

### Community 13 - "policy.rs"
Cohesion: 0.13
Nodes (39): dispatch_artifact_propose(), artifact_propose_persists_and_sends_approval_button(), artifact_propose_rejects_duplicate_id_version(), artifact_propose_rejects_malformed_yaml(), artifact_propose_rejects_non_proposed_lifecycle(), artifact_propose_rejects_template_kind(), artifact_propose_rejects_unknown_kind(), handle_owner_update() (+31 more)
...
Cohesion: 0.06
Nodes (49): String, truncate_for_telegram(), truncate_with_notice(), HandlerFuture, ActionRequestBody, ActionResponseBody, dispatch_allowed_action(), dispatch_lyra_preview() (+41 more)
...
Cohesion: 0.26
Nodes (11): Future, Output, Pin, Send, EventInputs, email_build_envelope(), email_grant_binding(), email_preflight() (+3 more)
...
Cohesion: 0.44
Nodes (8): activation_with_mutated_payload_is_denied(), approve_callback_update(), approved_artifact_activates_into_registry_and_overlay(), model_swap_ceremony_switches_real_generate_provider(), mount_send_message_ok(), telegram_stub(), seed_owner_history(), injected_activation_tx_failure_keeps_approved_old_state()
...
Cohesion: 0.22
Nodes (17): Sandbox, RwLock, AppState, dispatch_polled_updates(), kernel_notify_grant(), notify_owner_required(), notify_owner_with_digest(), NotifyOutcome (+9 more)
...
Cohesion: 0.17
Nodes (15): BuildEnvelopeFn, email_lane_executed_stage_trace_matches_sync_prefix(), owner_lane_executed_stage_trace_matches_sync_prefix(), owner_lane_without_verified_context_fails_closed_before_grant(), GrantBindingFn, PreflightFn, RouteGuardFn, email_preview_lane() (+7 more)
...
Cohesion: 0.18
Nodes (13): PostApprovalFuture, PostApprovalHandler, create_approved_draft(), handle_draft_approval_callback(), notify_owner_best_effort(), handle_plan_approval_callback(), resolve_approved_plan(), activate_approved_artifact() (+5 more)
...
Cohesion: 0.08
Nodes (50): refuses_external_communication_without_containment(), RelationshipKind, effect_defaults_to_allow_when_omitted(), owner_route(), round_trips_through_serde(), Route, route_can_be_a_deny_route(), RouteActorWhen (+42 more)
...
## Knowledge Gaps
- **1598 isolated node(s):** `set.sh script`, `autoresearch.sh script`, `TelegramReplyPayload`, `ReadThreadPayload`, `ArtifactProposePayload` (+1593 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **481 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Digest` connect `Ok` to `client.rs`, `Proposal: Implement gate action API`, `Proposal: Implement Telegram owner control slice`, `Tasks: Define core runtime schemas`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `handle_owner_update()` connect `policy.rs` to `identity.rs`, `artifact_loader.rs`, `mod.rs`, `create_approved_draft`, `CLAUDE.md`, `action.rs`, `Requirements`, `Runtime schema groups`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `dispatch_artifact_propose()` connect `policy.rs` to `Requirements`, `.default`, `Proposal: Implement gate action API`, `Requirements`, `Tasks: Implement selected-thread email preview slice`, `Proposal: Implement Telegram owner control slice`, `Lifecycle`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._

...
## Corpus Check
- 848 files · ~742,762 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12514 nodes · 17916 edges · 2378 communities (877 shown, 1501 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 2155 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a2ead828`
...
2. `handle_owner_update()` - 107 edges
3. `StoreError` - 106 edges
4. `owner_update()` - 97 edges
5. `test_state_with_telegram()` - 95 edges
6. `digest_of_bytes()` - 76 edges
7. `ActionId` - 72 edges
8. `Timestamp` - 65 edges
9. `gate()` - 59 edges
10. `ResolvedActionContext` - 53 edges
...
- `search_class_pack_cannot_submit_web_form()` --calls--> `gate()`  [INFERRED]
  crates/openspine-kernel/src/connectors_tests.rs → crates/openspine-gate/src/gate.rs
- `handle_lyra_preview()` --calls--> `dispatch_lyra_preview()`  [INFERRED]
  crates/openspine-kernel/src/api/handler_registry.rs → crates/openspine-kernel/src/api/actions.rs
...
## Communities (2378 total, 1501 thin omitted)
...
### Community 1 - ".new"
Cohesion: 0.07
Nodes (74): a_blocked_install_is_told_what_is_missing_every_start(), a_corrupt_marker_reads_as_incomplete(), a_ready_install_greets_once_then_stays_quiet(), blocked(), blocked_notice(), completion_round_trips_through_the_data_directory(), first_start(), FirstStart (+66 more)

### Community 2 - "event.rs"
Cohesion: 0.06
Nodes (56): oauth_pkce_generator_computes_valid_s256_challenge(), PkceChallenge, Default, Self, String, build_authorization_url(), exchange_code(), oauth_login_fallback_accepts_manual_authorization_code_input() (+48 more)

### Community 3 - "handle_owner_update"
Cohesion: 0.61
Nodes (7): http_consumed_causal_token_still_contextualizes_later_tokenless_denial(), http_skill_context_token_concurrent_submit_has_one_winner(), http_skill_context_token_has_causal_digest_and_strict_allowed_payload(), http_tokenless_denial_reports_bounded_contextual_notice_without_consuming(), install_context_skill(), post_action_with_skill_token(), telegram_server()

### Community 4 - ".default"
Cohesion: 0.07
Nodes (42): OwnerApprovalAuditMetadata, OwnerApprovalScopeArtifact, Store, ApprovalObservation, AuditTrailEntry, classification_within(), CorrectionObservation, EvalProbe (+34 more)

### Community 5 - "GmailConnector"
Cohesion: 0.07
Nodes (17): dark_window_allow_eligible(), dark_window_allow_eligible_actions(), required_scope_dimensions_for(), BTreeSet, Option, delegation_descriptors(), egress_declarations(), id() (+9 more)

### Community 6 - "artifact_loader.rs"
Cohesion: 0.12
Nodes (25): connector_failure_batches_and_is_audited(), counter_persistence_failure_is_durably_batched_as_resource(), immediate_failure_cannot_enter_digest_lane(), batch_failure(), encrypt_digest_detail(), FailureClass, notify_immediate_failure(), record_callback_ack() (+17 more)

### Community 7 - "config.rs"
Cohesion: 0.14
Nodes (12): Result, run_benchmarks(), build_selection_token(), format_pending_message(), String, Ulid, Instant, OwnedMutexGuard (+4 more)

### Community 8 - "mod.rs"
Cohesion: 0.08
Nodes (40): mediate_and_dispatch_action(), suppressed_schedules_consume_no_budget(), varying_the_payload_cannot_amplify_owner_silence(), email_read_selected_thread_rejects_expired_token(), email_read_selected_thread_rejects_foreign_grant(), email_read_selected_thread_rejects_malformed_payload(), email_read_selected_thread_rejects_second_use(), email_read_selected_thread_returns_thread_via_mocked_gmail() (+32 more)
...
### Community 10 - ".put"
Cohesion: 0.09
Nodes (9): ArtifactRef, Option, Result, Ulid, Store, hydrate_task_grant(), Store, StoreError (+1 more)

### Community 11 - "ProposedArtifact"
Cohesion: 0.10
Nodes (44): Authorization, begin(), begin_with_client_id(), default_port(), finish(), parse_authorization_paste(), a_bare_pasted_code_uses_the_authorization_state(), a_pasted_code_carrying_its_state_is_split_and_both_are_sent() (+36 more)
...
Cohesion: 0.16
Nodes (28): canonical_json(), pre_egress_mac_hex(), pre_egress_root_bytes(), bindings_valid(), Caveat, caveat_bytes(), chain_structurally_valid(), ChainStep (+20 more)
...
Cohesion: 0.18
Nodes (22): DeserializeOwned, (), ApprovalStepInputs, ArtifactRef, bool, Digest, EntryBindingInputs, EntryTransitionInputs (+14 more)

### Community 17 - "content.d.ts"
Cohesion: 0.13
Nodes (22): disclosure_slug(), binding_matches_rejects_a_different_provenance_set(), binding_matches_rejects_a_different_requesting_grant(), carve_out_extends_covered_egress_without_new_policy(), check_egress(), ClassifiedBriefcaseItem, coverage_uses_provenance_even_when_generalized_text_is_public(), DisclosureClass (+14 more)

### Community 19 - "action.rs"
Cohesion: 0.10
Nodes (36): claim_conversation_in_flight(), connector_restart_cap_available(), connector_restart_count_in_window(), ensure_schema(), record_worker_failed(), release_conversation_in_flight(), release_conversation_in_flight_for_grant(), ArtifactRef (+28 more)

### Community 20 - "StoreError"
Cohesion: 0.29
Nodes (15): ReflectionProposal, build_miner_owner_review(), dispatch_miner_evaluated_proposal(), dispatch_reflection_proposal(), gate_and_reserve_model_call(), MinerRuntimeError, owner_review_epochs(), reserve_model_call() (+7 more)

### Community 21 - "post_action"
Cohesion: 0.15
Nodes (21): hex(), oauth_tokens_stored_encrypted_in_secret_store(), OAuthIdentityMetadata, OAuthTokens, Aes256Gcm, Arc, Digest, Error (+13 more)

### Community 22 - "ApprovalRecord"
Cohesion: 0.13
Nodes (37): catalog_with(), communication_delegation_rejects_action_only_scope_and_allow_defaults(), communication_scope_floor_covers_external_services_and_counterparties(), compatibility_epoch_and_scope_key_move_independently(), context_input(), descriptor(), digest(), implementation() (+29 more)
...
Cohesion: 0.17
Nodes (32): Dirent, dup_fd(), is_eloop(), libc_close(), libc_closedir(), libc_dup(), libc_dup_checked(), libc_errno_location() (+24 more)

### Community 27 - "Lifecycle"
Cohesion: 0.14
Nodes (33): handle_terminal_message(), inspect_is_read_only_and_writes_no_disposition(), narrow_persists_a_distinct_record_and_leaves_the_original_bytes_untouched(), persist(), rendered_copy_never_claims_readiness_without_a_registered_executor(), terminal_cannot_mutate_lifecycle_state_before_approval_binds_a_rule(), terminal_delta_parser_rejects_an_unreviewed_target(), terminal_reject_transitions_the_review_and_binds_no_rule() (+25 more)

### Community 28 - "Requirements"
Cohesion: 0.11
Nodes (23): EvalRow, digest_axis_stale(), epoch_nanos_to_timestamp(), EvalVerdict, insert_eval_verdict_conn(), map_row(), read_eval_row(), read_u32_col() (+15 more)

### Community 29 - "OpenSpine Agent-OS Design Log"
Cohesion: 0.18
Nodes (15): briefcase(), get_task(), get_task_emits_empty_output_channels_for_worker_grant(), TaskLimitsBody, TaskViewBody, worker_grant(), record_worker_commissioned(), WorkerBoundParameter (+7 more)

### Community 30 - "ArtifactRef"
Cohesion: 0.11
Nodes (27): ActionDescriptor, ActionImplementationDescriptor, ActionImplementationId, ActionSemantics, BudgetWindowBounds, DarkWindowPolicy, DataDestination, DelegationCatalogError (+19 more)
...
Cohesion: 0.15
Nodes (11): Option, Result, Ulid, Vec, Store, DeadLetterState, detail_insert_columns(), DetailReceipt (+3 more)
...
Cohesion: 0.09
Nodes (23): EffectExecutorFuture, PostApprovalFuture, PostApprovalHandler, EffectOutcome, create_approved_draft(), gmail_create_draft_executor(), handle_draft_approval_callback(), finalize_nomination() (+15 more)
...
Cohesion: 0.07
Nodes (54): denied_read_thread_stops_without_drafting(), Draft, draft_reply(), empty_draft_skips_preview_without_error(), format_thread_for_model(), format_thread_for_model_includes_all_fields(), full_flow_reads_drafts_and_previews(), no_selection_tokens_is_an_error() (+46 more)

### Community 54 - "Requirements"
Cohesion: 0.18
Nodes (22): a_spoofed_closing_marker_in_the_content_does_not_escape_the_boundary(), build_prompt(), build_prompt_carries_system_preamble_and_conversation_through(), build_prompt_with_untrusted_context(), GatewayTierMap, PromptMessage, PromptRole, PromptTemplate (+14 more)
...
Cohesion: 0.11
Nodes (23): agent_manifests_round_trip(), artifacts_dir(), email_grant_pack_excludes_read_inbox_and_send(), every_fixture_file_is_covered_by_a_test(), global_policy_round_trips_and_denies_send(), owner_control_pack_round_trips(), owner_email_selected_thread_route_is_expressible_declaratively(), owner_telegram_route_is_expressible_declaratively() (+15 more)
...
Cohesion: 0.19
Nodes (15): manifest_digest(), Digest, HashMap, Into, Option, Result, Self, Store (+7 more)
...
Cohesion: 0.18
Nodes (23): confirm(), prompt(), Option, Result, String, bootstrap(), choose_model(), encrypted_state_in() (+15 more)

### Community 65 - "compose_authority"
Cohesion: 0.18
Nodes (20): ResolvedPrompt, generate_onyx(), onyx_request_parts(), Client, Result, String, GatewayError, generate_anthropic() (+12 more)
...
Cohesion: 0.05
Nodes (92): AgentLimits, AgentManifest, main_assistant_agent(), main_assistant_denies_broad_email_access(), MemoryScope, ModelPolicy, OutputChannels, Persistence (+84 more)
...
### Community 74 - ".put"
Cohesion: 0.18
Nodes (25): pending_worker_dispatches(), record_worker_result(), surface_stranded_worker(), classified_empty_output_channel_denial(), commission(), commission_is_receipt_idempotent(), commission_receipt_binding_rejects_different_parent_or_request(), commissioning_persists_briefcase_without_board_row() (+17 more)
...
Cohesion: 0.11
Nodes (9): ReviewRow, OwnerReviewRow, ensure_column(), ensure_schema(), epoch_nanos_to_timestamp(), map_row(), read_review_row(), state_str() (+1 more)

### Community 79 - "OpenSpine kernel↔shell HTTP contract"
Cohesion: 0.25
Nodes (8): activate_approved_artifact(), ActivationCommit, epoch_digests_match(), epoch_versions_match(), OwnerReviewApprovalCommit, Store, verify_evaluated_activation_in_tx(), ArtifactNamespace
...
Cohesion: 0.22
Nodes (23): accepted_digest_tamper_invalidates(), base_namespace_is_not_treated_as_learned(), dangling_learned_route_is_orphaned_and_excluded(), erased(), exclude_erased_covers_registered_kinds_and_exact_version_model_swaps(), insert_agent(), insert_pack(), insert_route() (+15 more)
...
Cohesion: 0.05
Nodes (54): is_already_locked(), OverlayControl, cleanup_install(), cleanup_path(), continuity_path(), exists(), inspect_install(), install_or_recover() (+46 more)
...
Cohesion: 0.09
Nodes (33): a_consumed_token_cannot_be_consumed_twice(), a_token_expiring_on_an_exact_second_is_live_one_nanosecond_earlier(), a_token_expiring_on_an_exact_second_is_refused_one_nanosecond_later(), consume(), Store, Ulid, selection(), count_skill_rows_for_test() (+25 more)
...
Cohesion: 0.21
Nodes (20): run_pipeline(), email_preview_lane(), owner_control_lane(), email_lane_executed_stage_trace_matches_sync_prefix(), email_lane_marker_is_not_owner_control_screened(), email_lane_preflight_resolves_counterparty_into_persisted_briefcase(), injected_briefcase_persist_failure_leaves_no_spawn_or_orphans(), non_immediate_lane_breach_blocks_composition_and_notifies_owner() (+12 more)

### Community 97 - "Tasks: Implement digest-bound draft approval"
Cohesion: 0.19
Nodes (22): choose_provider(), complete_login(), ensure_codex_identity(), headless(), login_flow(), open_in_browser(), provider_entry(), Client (+14 more)
...
Cohesion: 0.21
Nodes (12): OverlayControl, check_continuity_alignment(), ensure_data_root_dir(), marker_path(), read_generation_marker(), write_generation_marker(), newer_ledger(), valid_transition() (+4 more)
...
Cohesion: 0.16
Nodes (22): orphan_higher_persona_cannot_hide_row_backed_lower_version(), PromptTemplate, load_keyed(), load_registry_into(), artifact_identity_pairs(), artifact_version(), ArtifactKindSpec, ArtifactLoadError (+14 more)
...
Cohesion: 0.17
Nodes (19): BundleNamePayload, foreign_principal_is_rejected(), handle_overlay_export(), handle_overlay_restore(), invoked_action_must_match_handler(), malformed_and_unknown_payload_fields_fail(), mint_grant(), non_root_parent_or_chain_is_rejected() (+11 more)

### Community 112 - "Design: Gate action API"
Cohesion: 0.18
Nodes (21): bounded_text(), load_checkpoint(), relay_one(), RelayOutcome, resolve_relay_context(), run_worker_result_consumer(), artifact_ref(), checkpoint_load_error_fails_closed_without_replay() (+13 more)
...
Cohesion: 0.06
Nodes (15): AuditKind, AuditKindError, genesis_hash(), round_trips_through_serde(), ConsumerCheckpoint, EventSubscriptionFilter, filter_defaults_match_all(), append() (+7 more)
...
Cohesion: 0.18
Nodes (28): a_set_variable_is_retained_over_the_file(), absent_env_file_is_not_an_error(), EnvFileError, generated_key_file_is_never_readable_by_other_accounts(), group_readable_env_file_is_refused_with_its_mode(), is_identifier(), load_adjacent(), Loaded (+20 more)
...
Cohesion: 0.09
Nodes (23): 1. The cautious agent power user, 2. The agent product builder, 3. The capable-agent sceptic, Competitive position, Copy rules, Core offer, Customer personas, Decision (+15 more)

### Community 123 - "D-001 — Lyra is a runtime/substrate, not a single agent"
Cohesion: 0.22
Nodes (20): connector_for_action(), refuse(), resume_standing_rule_revalidated(), ResumeOutcome, ResumeRefusal, budget(), digest(), email_context() (+12 more)

### Community 124 - "mod.rs"
Cohesion: 0.16
Nodes (15): a_failed_response_carries_the_upstream_message(), a_terminal_event_with_failed_status_is_rejected_despite_deltas(), an_incomplete_terminal_without_text_fails_with_its_reason(), completed_output_text(), generate_codex_responses(), prompt(), request_body(), Client (+7 more)
...
Cohesion: 0.10
Nodes (40): bind_email_identity(), email_counterparty_resolves_to_bound_identity_when_address_is_bound(), email_counterparty_stays_unresolved_when_address_is_unbound(), minimal_grant(), mint_topup_grant(), post_topup(), topup_granted_grant_mutates_briefcase_atomically(), topup_oversized_section_key_is_rejected_without_persistence() (+32 more)
...
Cohesion: 0.15
Nodes (19): BuildEnvelopeFn, GrantBindingFn, PreflightFn, RouteGuardFn, email_build_envelope(), email_preflight(), EventInputs, LaneSpec (+11 more)
...
Cohesion: 0.19
Nodes (19): ActionRequestBody, ActionResponseBody, cleanup_pre_effect_reservations(), dispatch_lyra_preview(), dispatch_read_selected_thread(), DispatchError, FailureSurface, guard_connector_dispatch() (+11 more)

### Community 156 - "D-049 — Capability specs are backfilled for subsystems implemented inside earlier slices"
Cohesion: 0.32
Nodes (19): commit_disposition(), commit_lifecycle(), dispatch_narrowed_miner_proposal(), load_owner_review_for_surface(), MinerEvaluationApproval, mint_owner_activation_grant(), OwnerReviewDecisionError, OwnerReviewDecisionOutcome (+11 more)

### Community 157 - "D-050 — `max_model_calls` is enforced with an atomic upsert, not a count-then-compare"
Cohesion: 0.18
Nodes (32): allowed_action_returns_allow(), allowed_plus_approval_required_returns_approval_required(), allowed_plus_denied_returns_deny(), approval_for(), approval_required_action_does_not_execute(), approval_required_action_returns_approval_required(), approved_but_payload_changed_since_is_denied_not_reasked(), audit_metadata_records_action_grant_and_refs_not_plaintext() (+24 more)

### Community 158 - "D-006 — Identity is not authority"
Cohesion: 0.17
Nodes (13): action_for(), arm(), capture(), CaptureOutcome, kind_prefix(), owner_grant(), parse_command(), Pending (+5 more)
...
Cohesion: 0.09
Nodes (15): Debug, ReplayKey, BreakerState, CircuitBreaker, CircuitBreakerConfig, ConnectorRuntimeState, decode_hex(), RateLimitBucket (+7 more)
...
Cohesion: 0.11
Nodes (19): Requirement: The kernel MUST re-derive digests from artifact-store bytes at approval-effect time, Scenario: Approved admission sources converge on one executor, Scenario: Confirmed creation is executed exactly once in evidence, Scenario: Delivery is unknown after a provider write attempt, Scenario: Delivery is unknown and retry is fenced, Scenario: Delivery-unknown retains the reserved budget and the fence, Scenario: Exact request after explicit resolution may proceed, Scenario: Exact stored plan bytes are approved (+11 more)
...
Cohesion: 0.12
Nodes (14): deserialize_schema_version(), provenance_round_trips_with_tag(), ref_of(), slice_round_trips_and_rejects_unknown_fields(), Task, task_rejects_plaintext_title_and_provenance_references(), task_rejects_unsupported_schema_version(), task_requires_schema_version_and_rejects_unknown_fields() (+6 more)
...
Cohesion: 0.20
Nodes (14): a_deny_default_stays_permitted(), a_drifted_context_cannot_spend_a_pre_drift_waiver(), a_fired_exception_is_audited_distinctly_and_does_not_extend_the_lapse_clock(), activation_refuses_an_allow_default_for_an_ineligible_action(), opening_a_database_retires_a_stored_ineligible_allow_rule(), the_reviewed_allowance_is_validated(), the_sweep_leaves_a_deny_rule_alone(), a_staled_exception_frees_its_slot() (+6 more)

### Community 190 - "template"
Cohesion: 0.25
Nodes (9): ConnectorImplementationScope, reviewed_scope_digest_of(), reviewed_scope_values_of(), ReviewedActionScope, ReviewedScopeError, ReviewedScopeValue, ReviewedTargetScope, ScopeComparison (+1 more)

### Community 191 - "architecture.md"
Cohesion: 0.13
Nodes (10): Update, build_owner_envelope(), CallbackQueryUpdate, DisclosureAnswer, parse_digest_detail_command(), parse_digest_namespace(), parse_disclosure_command(), project_update() (+2 more)
...
Cohesion: 0.11
Nodes (17): Consequences, Consequences, D-010 — Model calls with private context go through model gateway, D-121 — Fail-closed disclosure budget accounting with policy-free worker outcomes, D-153 — "Both admission sources" means approval and the headless approved lane; scoped standing-rule admission stays #128, Decision, Decision, Decision (+9 more)

### Community 196 - "tsconfig.json"
Cohesion: 0.29
Nodes (17): expired_invalid_mac_is_caveat_widening_not_grant_expired(), gate_denies_catalog_unknown_id_with_unknown_action_reason(), gate_denies_stale_granted_but_catalog_unknown_id(), gate_keeps_not_granted_for_known_ungranted_id(), grant_with_token(), kernel_origin_call_outside_trusted_set_is_denied(), kernel_origin_owner_notify_is_auto_allowed(), kernel_origin_unknown_action_is_unknown_not_trusted() (+9 more)
...
Cohesion: 0.07
Nodes (27): add-channel-neutral-responsibility-review, Agent-OS change sequence (2026-07-07, AD canon), bound-dark-window-exceptions, compose-whole-responsibilities, define-responsibility-contract, Event substrate, Failure surfacing & operations, implement-connector-reality (+19 more)

### Community 206 - "check.sh"
Cohesion: 0.29
Nodes (7): authenticate(), bearer_token(), internal_error(), unauthorized(), client_error(), get_briefcase(), post_topup()
...
Cohesion: 0.23
Nodes (15): detail_pages(), handle_command(), handle_detail_command(), record_unavailable(), render_page(), resolve_detail(), admits_more_than_three_tiny_items(), canonical_unavailable_marker_view_does_not_grow_items_or_audits() (+7 more)
...
Cohesion: 0.15
Nodes (9): DarkWindowSchedule, Option, Result, String, Transaction, stale_pending_exceptions_in_tx(), Store, parse_owner_surface() (+1 more)
...
Cohesion: 0.36
Nodes (14): append_approval(), miner_tick_harness(), MinerTickHarness, resolved_email_context(), resolved_email_context_with_task_shape(), scheduled_reflection_miner_two_context_classes_do_not_form_one_pattern(), append_approval_with_grouping_binding(), append_duplicate_audit_row() (+6 more)
...
Cohesion: 0.13
Nodes (9): Connection, FnOnce, Path, R, Result, Store, String, Vec (+1 more)
...
Cohesion: 0.11
Nodes (18): Requirement: Activated artifacts MUST survive a kernel restart, Requirement: Artifact id and version MUST be unique across fixtures, overlay, and pending proposals, Requirement: Digest/brief format MUST remain a learnable default, Requirement: Learned artifacts MUST carry durable exchange provenance, Requirement: Only active artifacts MUST participate in authority composition, Requirement: Overlay version cutover MUST be highest-only and monotonic, Requirement: Personality seed seeding MUST be idempotent across boots, Requirement: Proposed artifacts MUST follow the lifecycle chain with illegal transitions rejected (+10 more)
...
Cohesion: 0.10
Nodes (13): EffectExecutor, EffectExecutorRegistry, bounded_preview(), content_diff_summary(), build_state(), build_state_inner(), build_state_with_store(), owner_surface() (+5 more)
...
Cohesion: 0.20
Nodes (22): expired_pending_test(), mismatched_chat_pending_test(), mount_unused_provider(), production_intake_rotate_connector_call_integration(), provider_pointed_at(), different_bot_token_rotation_starts_fresh_namespace(), mount_unused_provider(), provider_pointed_at() (+14 more)
...
Cohesion: 0.22
Nodes (11): canonical_catalog(), approval_narrowing_allowlist_is_explicit_and_fails_closed(), counterparty_classification_is_kernel_owned_and_fails_closed(), email_draft_has_a_reviewed_descriptor_and_a_registered_implementation(), every_delegation_descriptor_names_a_catalogued_action(), handler_registry_requires_explicit_classification(), non_delegable_catalog_is_exactly_the_root_only_set(), non_effect_stub_allowlist_is_explicit_and_fails_closed() (+3 more)

### Community 288 - "fixtures.rs"
Cohesion: 0.14
Nodes (8): handle_artifact_nominate(), handle_artifact_propose(), handle_lyra_preview(), handle_plan_propose(), handle_telegram_reply(), dispatch_plan_preview(), truncate_for_telegram(), truncate_with_notice()
...
Cohesion: 0.25
Nodes (12): ResponsibilityAssessment, ResponsibilityCompatibilityBinding, ResponsibilityDriftReason, ResponsibilityManifest, ResponsibilityStatus, ArtifactId, BTreeSet, Digest (+4 more)
...
Cohesion: 0.14
Nodes (13): Purpose, Requirement: Approvals MUST expire, Requirement: Draft creation MUST remain approval-required, Requirement: Final email send MUST remain denied, Requirement: Plan steps MUST bind exact execution identity, Requirement: Target mutation MUST invalidate approval, Requirements, Scenario: Agent requests send after draft creation (+5 more)
...
Cohesion: 0.27
Nodes (12): admit_connector_write(), call_with_admitted_connector_write(), call_with_connector(), call_with_connector_preflight(), call_with_connector_write(), confirmed_gmail_api_write_failure_is_connector_error(), gmail_malformed_success_response_is_delivery_unknown(), gmail_transport_write_is_delivery_unknown() (+4 more)

### Community 304 - "Approach"
Cohesion: 0.44
Nodes (12): active_rule(), allowed_pending_is_recoverable_until_consumed(), claimed_fired_pending_is_surfaced_once_not_redispatched(), deny_default_never_dispatches_and_is_terminal(), fired_allow_token_is_digest_bound_and_one_use(), fired_allow_token_rejects_different_fingerprint(), owner_resolution_before_fire_controls_claim(), payload() (+4 more)
...
Cohesion: 0.08
Nodes (47): action_for_egress(), action_for_scope(), cancel_reservations(), collect_nested_strings(), disclosure_policy_does_not_revoke_existing_egress_standing_rule(), disclosure_policy_recovers_carve_outs_from_store(), enforcement_allows_after_owner_answer(), forum_request() (+39 more)
...
Cohesion: 0.37
Nodes (12): digest(), email_context(), reserved_usage_count(), StandingRuleManifest, Store, scoped_consult_admits_exactly_one_matching_rule_and_reserves_budget(), scoped_consult_ambiguous_overlap_fails_closed_with_no_budget(), scoped_consult_corrupt_binding_fails_closed_as_invalid_scope() (+4 more)
...
Cohesion: 0.27
Nodes (10): miner_proposal_denied_verdict_refuses_without_review_or_activation(), miner_proposal_mismatched_verdict_refuses_without_review_or_activation(), miner_proposal_missing_verdict_refuses_without_review_or_activation(), miner_proposal_non_review_required_refuses_without_review_or_activation(), miner_proposal_stale_verdict_refuses_without_review_or_activation(), run_dispatch_control(), apply_dispatch_test_mutation(), DispatchTestMutation (+2 more)
...
Cohesion: 0.13
Nodes (16): Option, Result, String, Transaction, Store, ensure_schema(), epoch_nanos_to_timestamp(), Connection (+8 more)
...
Cohesion: 0.26
Nodes (9): run_pipeline_with_envelope(), empty_session_policy(), resolve_ambiguous_route(), resolve_tied_routes(), RouteAuthoritySources, SelectedRoute, TieResolution, PipelineStage (+1 more)

### Community 360 - "Self"
Cohesion: 0.38
Nodes (8): a_reviewed_allowance_of_two_admits_exactly_two(), concurrent_requests_cannot_cross_the_final_slot(), dark_window_rule(), many_distinct_over_budget_requests_yield_one_exception(), payload(), repeating_one_request_consumes_no_second_slot(), resolving_an_exception_frees_its_slot(), rule()
...
Cohesion: 0.24
Nodes (4): concurrent_pending_claims_have_one_winner(), draft_request_fingerprint(), pending_request_fingerprint_migrates_and_fences_by_identity(), Store

### Community 389 - "Response"
Cohesion: 0.31
Nodes (5): hash_task_token(), Result, String, Ulid, Store
...
Cohesion: 0.13
Nodes (9): Authority boundary, Build, Configure Onyx and LFM2.5, Direct terminal chat, Run, Canon sources, Completed / archived, OpenSpine OpenSpec change sequence (+1 more)
...
### Community 435 - "Error"
Cohesion: 0.27
Nodes (8): commissioned_grant_for_receipt(), CommissionReceipt, mark_worker_stranded_notified(), stranded_worker_timeouts(), stranded_worker_timeout_detects_expired(), worker_dispatch_failed(), worker_dispatch_state(), WorkerDispatchState

### Community 436 - "PathBuf"
Cohesion: 0.36
Nodes (6): every_transmitted_codex_element_participates_in_the_digest(), fingerprint_material(), fingerprint_parts(), oauth_fingerprint_digest(), Digest, String
...
### Community 459 - "Vec"
Cohesion: 0.43
Nodes (6): every_transmitted_element_participates_in_the_digest(), fingerprint_material(), fingerprint_parts(), oauth_fingerprint_digest(), Digest, String

### Community 460 - "proposed_plan_fixture"
Cohesion: 0.46
Nodes (7): at(), every_rendering_has_the_same_width(), round_trips_through_parse(), String, sql_timestamp(), trimmed_trailing_zeros_do_not_invert_the_order(), whole_second_sorts_before_a_later_instant_in_the_same_second()
...
### Community 484 - "Vec"
Cohesion: 0.25
Nodes (6): Receiver, Request, Respond, Sender, concurrent_owner_callbacks_are_serialized_by_handler(), FirstCallbackGate
...
Cohesion: 0.50
Nodes (7): consult_scoped_rule(), dispatch_scoped_effect(), resolve_scoped_admission(), ScopedAdmission, ScopedAdmissionContext, ScopedAdmissionDecision, unresolvable()
...
Cohesion: 0.39
Nodes (5): column_names(), legacy_grant_without_an_owner_surface_fails_closed(), open_at_pre_129_schema(), versioned_rebuilds_preserve_every_pre_existing_column(), versioned_rebuilds_preserve_row_data_including_sibling_columns()

### Community 501 - "String"
Cohesion: 0.36
Nodes (4): a_widened_candidate_is_not_a_strict_narrowing(), narrower_or_equal(), ReviewedActionScope, ReviewedScopeNarrowError
...
### Community 559 - "Self"
Cohesion: 0.29
Nodes (7): Adversarial review and gate, Business strategist, Gate result, Maya, Priya, Sam, Sceptical marketer
...
### Community 562 - "Vec"
Cohesion: 0.43
Nodes (5): resolve_text(), retry_backoff(), retry_due_notifications(), run_retry_loop(), parse_availability_outcome()
...
Cohesion: 0.52
Nodes (6): artifact_ref(), owner_review_decision_audit_records_principal_and_intent(), owner_review_illegal_transition_is_refused(), owner_review_legal_transition_applies_and_is_idempotent(), owner_review_revoked_reachable_from_any_non_terminal_state(), owner_review_row_persists_and_round_trips()
...
### Community 581 - "Ulid"
Cohesion: 0.18
Nodes (11): Requirement: A digest-bound decision MAY be submitted with a short digest token, Requirement: Proposal copy MUST NOT outrun evidence, scope, or executor readiness, Requirement: Responsibility MUST remain a reference view rather than live authority, Requirement: Scoped effect admission MUST emit a responsibility receipt, Requirements, Scenario: A callback token that does not match the stored digest, Scenario: Active responsibility executes another task, Scenario: Copy claims readiness without a registered executor (+3 more)
...
Cohesion: 0.33
Nodes (6): Category line, Current-proof line, Headline, Primary call to action, Recommended copy direction, Supporting copy

### Community 596 - "ArtifactId"
Cohesion: 0.24
Nodes (5): Bot, Url, telegram_chat_id(), TelegramBotState, TelegramConnector
...
Cohesion: 0.67
Nodes (5): load_checkpoint(), route_failure(), run_worker_failed_consumer(), worker_failed_consumer_iteration(), worker_failed_filter()
...
Cohesion: 0.14
Nodes (13): ProposalError, propose_draft_creation(), Error, Result, Ulid, grant(), GrantLimits, GrantMode (+5 more)
...
Cohesion: 0.40
Nodes (5): Requirement: Decision refusals MUST be typed and enumerated, Scenario: Edit is refused because the kernel cannot synthesise a replacement, Scenario: Pause on an already paused rule is an unchanged replay, Scenario: Pause refusal preserves an ineligible non-paused rule, Scenario: Resume refusal preserves the paused rule
...
Cohesion: 0.05
Nodes (51): Command, audit_action_count(), PathBuf, shell_binary(), terminal_owner_status_reaches_device_through_real_shell(), classify_docker_exit_code(), docker_driver_args_are_correct_and_secret_free(), DockerDriver (+43 more)
...
Cohesion: 0.25
Nodes (25): cleanup_temp_at(), is_allowed_platform_redirect(), o_cloexec(), o_creat(), o_directory(), o_nofollow(), open_canonical_dir_nofollow(), open_or_create_control_dir_relative() (+17 more)
...
Cohesion: 0.22
Nodes (9): Requirement: Delegation evidence classes MUST remain distinct, Scenario: Approvals across two targets are not one pattern, Scenario: Duplicate decision rows are not repeated approvals, Scenario: Non-pattern evidence is rendered, Scenario: One or duplicate approval is offered as a pattern, Scenario: Payload variation does not change request shape, Scenario: Provenance copy is derived from evidence, Scenario: Repeated approvals belong to a different context class (+1 more)
...
Cohesion: 0.29
Nodes (7): Requirement: Exactly one compatible scoped rule MUST match before any budget moves, Scenario: Ambiguous overlap fails closed, Scenario: Erasure is checked before scoped reservation, Scenario: Erasure wins the admission transaction race, Scenario: Exactly one rule matches, Scenario: No rule matches the resolved scope, Scenario: Two accounts cannot form one pattern
...
Cohesion: 0.23
Nodes (13): valid_name(), apply_terminal_erasure_delta(), expected_entries_after_delta(), normalize_erased_ids(), remove_if_present(), validate_manifest_path(), enum_dir_fd(), enumerate_data_root() (+5 more)
...
Cohesion: 0.20
Nodes (31): atomic_rename_noreplace(), Cleanup, create_dir(), create_temp_dir(), ensure_absent(), io_err(), is_eloop(), mutation_or_io() (+23 more)

### Community 953 - "Requirement: Identity schemas MUST NOT grant runtime authority"
Cohesion: 0.50
...
### Community 958 - "content-modules.mjs"
Cohesion: 0.50
...
### Community 977 - "Option"
Cohesion: 0.50
Nodes (4): Requirement: Approval MUST bind only what the owner was shown, Scenario: Preview fits without truncation, Scenario: Preview must be truncated, Scenario: Re-derived payload digest must match what was shown

### Community 978 - "Self"
Cohesion: 0.50
Nodes (4): Requirement: Draft creation MUST require digest-bound approval, Scenario: Draft body changes after approval, Scenario: Kernel re-derivation catches the mutation, Scenario: Owner approves exact draft
...
### Community 989 - "SelectionTokenType"
Cohesion: 0.50
Nodes (4): Requirement: Miner-originated owner reviews MUST bind exact evaluated proposals, Scenario: Miner proposal reaches owner review only after exact evaluation, Scenario: Missing or stale evaluation refuses review, Scenario: Narrowed miner review is re-evaluated

### Community 990 - "Failure surfacing & operations"
Cohesion: 0.50
Nodes (4): 10x challenge, 1/10 challenge, Phase 2: pricing, Position

### Community 991 - "BriefcaseAudit"
Cohesion: 0.50
Nodes (4): Current market context, Direct reader evidence, Product truth, Research brief
...
### Community 1035 - "head"
Cohesion: 0.67
Nodes (3): ArtifactProposalReceipt, ArtifactProposePayload, dispatch_artifact_propose_core()
...
Cohesion: 0.10
Nodes (21): built_in_web_egress_endpoints(), Connector, ConnectorRegistry, EgressRegistrationError, GmailConnector, Display, Error, Formatter (+13 more)
...
### Community 1089 - "check-file-sizes.sh"
Cohesion: 0.67
...
### Community 1090 - "KernelTrustedRated"
Cohesion: 0.67
Nodes (3): Requirement: A mutated approved plan MUST be refused at the gate, Scenario: Step is inserted after approval, Scenario: Steps are reordered after approval

### Community 1091 - "CLAUDE.md"
Cohesion: 0.67
Nodes (3): Requirement: Approval audit MUST avoid plaintext private payloads, Scenario: Approval is recorded, Scenario: Audit records the re-derived digest

### Community 1092 - "Vec"
Cohesion: 0.67
Nodes (3): Requirement: Plan approval MUST bind the complete ordered step-list digest, Scenario: Data-handling step participates in the digest, Scenario: Owner approves the shown plan

### Community 1094 - "Requirement: Event envelopes MUST include source authenticity fields"
Cohesion: 0.67
Nodes (3): Requirement: Approval-required decisions MUST not execute immediately, Scenario: Draft creation requires approval, Scenario: Kernel-origin action needs no approval but is audited
...
## Knowledge Gaps
- **3838 isolated node(s):** `set.sh script`, `autoresearch.sh script`, `TelegramReplyPayload`, `ReadThreadPayload`, `ArtifactNominatePayload` (+3833 more)
...
- **Why does `digest_of_bytes()` connect `HashMap` to `mod.rs`, `content.d.ts`, `post_action`, `Option`, `D-049 — Capability specs are backfilled for subsystems implemented inside earlier slices`, `D-006 — Identity is not authority`, `Requirements`, `D-013 — Dynamic behavior easy; dynamic authority hard`, `Vec`, `Blindspot pass`, `ADDED Requirements`, `digest.rs`, `Vec`, `ADDED Requirements`, `Approach`, `PathBuf`, `Reference hunt`, `Vec`, `S`, `Proposal: Backfill implemented capability specs`, `AuditEvent`, `Option`, `Self`, `openspine-decision-log.md`, `Design: Digest-bound draft approval`, `SKILL.md`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `digest_of()` connect `Requirements` to `standing_rule_timer.rs`, `D-024 — OpenSpec is the development/change-management layer, not the runtime`, `String`, `client.rs`, `head`, `action.rs`, `ActionId`, `fixtures.rs`, `D-013 — Dynamic behavior easy; dynamic authority hard`, `Vec`, `ADDED Requirements`, `Architecture`, `owner_event`, `Runtime schema groups`, `ADDED Requirements`, `template`, `head`, `.put`, `SKILL.md`, `S`, `Tasks: Backfill implemented capability specs`, `Default`, `Design: Gate action API`?**
...
- **Are the 130 inferred relationships involving `test_state()` (e.g. with `disclosure_policy_does_not_revoke_existing_egress_standing_rule()` and `disclosure_policy_recovers_carve_outs_from_store()`) actually correct?**
  _`test_state()` has 130 INFERRED edges - model-reasoned connections that need verification._
- **Are the 101 inferred relationships involving `handle_owner_update()` (e.g. with `webhook_minted_headless_draft_refuses_before_any_write()` and `verified_hook_approval_required_escalates_through_owner_surface()`) actually correct?**
  _`handle_owner_update()` has 101 INFERRED edges - model-reasoned connections that need verification._
- **Are the 96 inferred relationships involving `owner_update()` (e.g. with `verified_hook_approval_required_escalates_through_owner_surface()` and `activation_with_mutated_payload_is_denied()`) actually correct?**
  _`owner_update()` has 96 INFERRED edges - model-reasoned connections that need verification._
- **Are the 93 inferred relationships involving `test_state_with_telegram()` (e.g. with `lyra_ui_preview_sends_telegram_reply_to_grant_bound_chat()` and `lyra_ui_preview_truncates_long_body_to_utf16_limit()`) actually correct?**
  _`test_state_with_telegram()` has 93 INFERRED edges - model-reasoned connections that need verification._
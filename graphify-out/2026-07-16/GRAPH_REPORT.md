# Graph Report - implement-escalation-and-refusal  (2026-07-16)

## Corpus Check
- 287 files · ~205,101 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3613 nodes · 4922 edges · 623 communities (297 shown, 326 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 461 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e9324ddb`
...
1. `TaskGrant` - 59 edges
2. `gate()` - 46 edges
3. `ActionId` - 43 edges
4. `AppState` - 41 edges
5. `handle_owner_update()` - 39 edges
6. `request_for()` - 34 edges
7. `grant_with()` - 33 edges
8. `EventEnvelope` - 31 edges
9. `test_catalog()` - 30 edges
10. `owner_update()` - 29 edges
...
## Communities (623 total, 326 thin omitted)

### Community 0 - "README.md"
Cohesion: 0.15
Nodes (22): AccountRole, ActorHint, ChannelTrust, Connector, EventEnvelope, EventType, InteractionMode, legacy_without_thread_id_defaults_to_none() (+14 more)

### Community 1 - ".new"
Cohesion: 0.06
Nodes (50): artifact_ref(), email_route(), exact_deny_route_wins_over_allow_route(), gmail_connector_authenticated_alone_does_not_match_the_selected_thread_route(), higher_priority_route_wins_over_lower_priority(), matches(), no_matching_route_is_denied_not_ambiguous(), no_relationship_match_denies_the_route() (+42 more)
...
### Community 4 - ".default"
Cohesion: 0.06
Nodes (33): genesis_digest(), Arc, Connection, Error, Mutex, Option, Path, Result (+25 more)
...
Cohesion: 0.07
Nodes (32): canonical_catalog(), counterparty_classification_is_kernel_owned_and_fails_closed(), id(), test_catalog_effect_paths_are_fully_enumerated_and_classified(), PromptTemplate, T, AgentManifest, ArtifactKindSpec (+24 more)

### Community 7 - "config.rs"
Cohesion: 0.16
Nodes (32): bindings_valid(), Caveat, caveat_bytes(), chain_structurally_valid(), ChainStep, compute_mac_hex(), compute_tip(), ct_eq_hex() (+24 more)
...
Cohesion: 0.08
Nodes (29): Bot, build_owner_envelope(), CallbackQueryUpdate, parse_approve_callback(), parse_approve_plan_callback(), parse_bind_command(), parse_draft_command(), project_update() (+21 more)

### Community 10 - ".put"
Cohesion: 0.07
Nodes (27): Purpose, Requirement: Action requests and gate decisions MUST be typed, Requirement: Approval records MUST bind reviewed payloads and targets, Requirement: Audit schemas MUST reference private payloads by encrypted or hash refs, Requirement: Event bus subscription types MUST be explicit schemas, Requirement: Event envelopes MUST include source authenticity fields, Requirement: Identity schemas MUST NOT grant runtime authority, Requirement: OpenSpine core runtime objects MUST have explicit schemas (+19 more)

### Community 11 - "ProposedArtifact"
Cohesion: 0.10
Nodes (15): action_request_consume_is_single_use(), action_request_round_trips_by_id(), approval_round_trips_by_action_request_id(), find_task_grant_by_token_rejects_the_raw_hash_value(), most_recent_approval_wins_when_multiple_exist_for_one_request(), opening_a_pre_existing_db_without_the_used_column_is_migrated_in_place(), persisted_grant_json_contains_no_task_token(), Ulid (+7 more)

### Community 12 - "client.rs"
Cohesion: 0.09
Nodes (49): ActionBody, ActionOutcome, approval_required_is_ok_not_err(), counterparty_denial_preserves_only_canonical_deferral(), deny_decision_is_ok_not_err(), generate_sends_bearer_auth(), generate_sends_untrusted_context_in_body(), GenerateBody (+41 more)
...
Cohesion: 0.19
Nodes (19): DenialReason, GateDecision, allow_and_suppressed_do_not_surface(), approval_required_surfaces_as_deferral_with_approval_missing(), denial_reason_code(), deny_surfaces_canonical_deferral_and_escalation(), escalation_notice_round_trips(), EscalationEvent (+11 more)
...
Cohesion: 0.12
Nodes (59): AuthorityInput, classification_rank(), compose_authority(), mint_task_token(), narrow(), AgentManifest, CapabilityPack, HashSet (+51 more)
...
Cohesion: 0.08
Nodes (24): AuthorityOutcome, Box, action_id_qualifier_is_part_of_identity(), action_id_serializes_as_bare_string(), ActionCatalog, ActionId, ActionRequest, EffectPath (+16 more)
...
Cohesion: 0.13
Nodes (16): EvalRow, Row, TryFrom, epoch_nanos_to_timestamp(), EvalVerdict, map_row(), read_eval_row(), Store (+8 more)
...
Cohesion: 0.18
Nodes (14): BuildEnvelopeFn, GrantBindingFn, PreflightFn, RouteGuardFn, email_preview_lane(), emit_preflight_failure(), LaneSpec, owner_control_lane() (+6 more)
...
Cohesion: 0.19
Nodes (13): grant(), GrantMode, legacy_missing_chain_defaults_but_fails_closed(), legacy_without_thread_id_defaults_to_none(), round_trip_and_mac(), ArtifactId, Option, String (+5 more)
...
Cohesion: 0.26
Nodes (10): Aes256Gcm, ArtifactStore, ArtifactStoreError, different_content_is_different_ref(), get_is_idempotent(), key(), round_trips_plaintext(), same_content_is_content_addressed() (+2 more)
...
### Community 50 - "mod.rs"
Cohesion: 0.23
Nodes (20): email_build_envelope(), email_grant_binding(), email_preflight(), email_route_guard(), owner_build_envelope(), owner_grant_binding(), owner_preflight(), owner_route_guard() (+12 more)
...
Cohesion: 0.18
Nodes (13): notify_owner_best_effort(), PostApprovalFuture, PostApprovalHandler, activate_approved_artifact(), create_approved_draft(), handle_draft_approval_callback(), handle_plan_approval_callback(), resolve_approved_plan() (+5 more)
...
Cohesion: 0.09
Nodes (16): can_transition(), Lifecycle, ArtifactProposePayload, derived_lineage_round_trips_on_artifact_row(), inconsistent_generation_zero_with_parents_is_rejected(), inconsistent_positive_generation_without_parents_is_rejected(), lineage_is_distinct_from_version(), root_lineage_round_trips_on_artifact_row() (+8 more)
...
Cohesion: 0.11
Nodes (34): ActionRequestBody, ActionResponseBody, dispatch_allowed_action(), dispatch_lyra_preview(), dispatch_read_selected_thread(), DispatchError, post_actions(), PreviewPayload (+26 more)
...
Cohesion: 0.25
Nodes (7): Consequences, D-020 — Railway/Docker/VPS are deployment targets, not core architecture, Decision, Decision Index, Lyra PRD Companion — Decisions Log, Rationale, Would change if
...
Cohesion: 0.20
Nodes (13): ActionHandler, AppState, kernel_notify_grant(), notify_owner_required(), Option, PathBuf, Result, Store (+5 more)
...
Cohesion: 0.06
Nodes (35): built_in_web_egress_endpoints(), conflicting_egress_rating_is_rejected_without_downgrade(), Connector, connector_registry_enumerates_configured_connectors(), ConnectorRegistry, EgressRegistrationError, EmptyGateContext, gmail() (+27 more)
...
## Knowledge Gaps
- **1303 isolated node(s):** `autoresearch.sh script`, `ArtifactProposePayload`, `TokenResponse`, `IdentityResolver`, `WorkflowManifest` (+1298 more)
...
- **Why does `AppState` connect `ActionRequest` to `compose_authority`, `artifact_loader.rs`, `SKILL.md`, `client.rs`, `digest.rs`, `Tasks: Implement authority composition`, `mod.rs`, `Requirements`, `post_action`, `AppState`, `TaskGrant`, `ADDED Requirements`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `ArtifactRegistry` connect `artifact_loader.rs` to `ActionRequest`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `TaskGrant` connect `properties` to `event.rs`, `.default`, `config.rs`, `properties`, `ActionRequest`, `SKILL.md`, `ProposedArtifact`, `Tasks: Implement authority composition`, `content.d.ts`, `mod.rs`, `Proposal: Implement gate action API`, `Requirements`, `AppState`, `TaskGrant`, `ADDED Requirements`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Are the 40 inferred relationships involving `gate()` (e.g. with `allowed_action_returns_allow()` and `allowed_plus_approval_required_returns_approval_required()`) actually correct?**
  _`gate()` has 40 INFERRED edges - model-reasoned connections that need verification._
- **Are the 31 inferred relationships involving `handle_owner_update()` (e.g. with `approval_required_action_stops_before_dispatch()` and `counterparty_denial_returns_deferral_routes_and_audits()`) actually correct?**

...
## Corpus Check
- 287 files · ~200,448 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3614 nodes · 4890 edges · 590 communities (308 shown, 282 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 450 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `42779af9`
...
## Communities (590 total, 282 thin omitted)

### Community 0 - "README.md"
Cohesion: 0.08
Nodes (53): artifact_ref(), email_route(), exact_deny_route_wins_over_allow_route(), gmail_connector_authenticated_alone_does_not_match_the_selected_thread_route(), higher_priority_route_wins_over_lower_priority(), matches(), no_matching_route_is_denied_not_ambiguous(), no_relationship_match_denies_the_route() (+45 more)

### Community 1 - ".new"
Cohesion: 0.14
Nodes (8): hash_task_token(), Result, String, Timestamp, Ulid, Store, Store, StoreError
...
Cohesion: 0.26
Nodes (37): AuthorityInput, AuthorityOutcome, classification_rank(), compose_authority(), mint_task_token(), narrow(), unknown_candidate(), artifact_ref() (+29 more)
...
Cohesion: 0.15
Nodes (7): From, action_id_qualifier_is_part_of_identity(), action_id_serializes_as_bare_string(), ActionCatalog, ActionId, EffectPath, EffectPathClass
...
Cohesion: 0.18
Nodes (9): activate_approved_artifact(), Result, ActionRequest, grant(), GrantLimits, GrantMode, legacy_missing_chain_defaults_but_fails_closed(), round_trip_and_mac() (+1 more)
...
Cohesion: 0.12
Nodes (27): BuildEnvelopeFn, email_preview_lane(), emit_preflight_failure(), EventInputs, LaneSpec, owner_control_lane(), PipelineStage, PreflightFailure (+19 more)
...
### Community 50 - "mod.rs"
Cohesion: 0.27
Nodes (16): email_build_envelope(), email_grant_binding(), email_route_guard(), owner_build_envelope(), owner_grant_binding(), owner_route_guard(), Result, Timestamp (+8 more)
...
Cohesion: 0.06
Nodes (86): activation_with_mutated_payload_is_denied(), approve_callback_update(), approved_artifact_activates_into_registry_and_overlay(), mount_send_message_ok(), MockServer, TelegramConnector, Ulid, telegram_stub() (+78 more)
...
Cohesion: 0.21
Nodes (12): PostApprovalFuture, PostApprovalHandler, create_approved_draft(), handle_draft_approval_callback(), notify_owner_best_effort(), handle_plan_approval_callback(), resolve_approved_plan(), handle_activate_artifact() (+4 more)
...
Cohesion: 0.38
Nodes (9): caveat_reorder_or_remove_invalidates_mac(), child_derives_from_parent_tip_without_root_key(), egress_class_tamper_invalidates_root_mac(), id_parent_and_action_list_tamper_fail(), identity_field_tamper_invalidates_mac(), pre_egress_grant_mac_still_verifies_after_upgrade(), root_seals_and_verifies(), sample_root() (+1 more)
...
Cohesion: 0.29
Nodes (5): ActionHandler, ActionHandlerRegistry, empty_session_policy(), kernel_notify_grant(), run_telegram_poll_loop()
...
## Knowledge Gaps
- **1327 isolated node(s):** `set.sh script`, `autoresearch.sh script`, `TelegramReplyPayload`, `ReadThreadPayload`, `ArtifactProposePayload` (+1322 more)
...
- **Why does `AppState` connect `mod.rs` to `compose_authority`, `sandbox.rs`, `artifact_loader.rs`, `ActionRequest`, `SKILL.md`, `properties`, `digest.rs`, `Requirements`, `post_action`, `AppState`, `ADDED Requirements`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `DenialReason` connect `client.rs` to `AppState`, `event.rs`, `OpenSpine Agent-OS Design Log`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `Digest` connect `actions.rs` to `.default`, `digest.rs`, `opsx-explore.md`, `mod.rs`, `Requirements`, `.default`, `Lifecycle`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Are the 39 inferred relationships involving `gate()` (e.g. with `bound_parameter_conflict_is_caveat_widening()` and `explicit_shell_deny_precedes_uncovered_egress_class()`) actually correct?**
  _`gate()` has 39 INFERRED edges - model-reasoned connections that need verification._

# Graph Report - implement-personality-seed  (2026-07-18)

## Corpus Check
- 460 files · ~342,599 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6189 nodes · 8185 edges · 1248 communities (460 shown, 788 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 985 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ce6339ab`
...
1. `handle_owner_update()` - 74 edges
2. `owner_update()` - 68 edges
3. `test_state_with_telegram()` - 50 edges
4. `test_state()` - 49 edges
5. `gate()` - 47 edges
6. `StoreError` - 43 edges
7. `digest_of_bytes()` - 37 edges
8. `ArtifactRegistry` - 35 edges
...
## Communities (1248 total, 788 thin omitted)
...
Cohesion: 0.08
Nodes (65): ApprovalDecision, ApprovalRecord, matches_rejects_expired_approval(), matches_rejects_non_approved_decisions(), matches_requires_both_digests_and_approved_decision(), round_trips_through_serde(), sample_approval(), TimeoutBehavior (+57 more)
...
Cohesion: 0.12
Nodes (36): dependency_fingerprint(), apply_compatibility(), dangling_for_parsed(), ensure_reconfirm_request(), exclude_orphans(), find_orphans(), missing_provenance(), OrphanedArtifact (+28 more)
...
### Community 10 - ".put"
Cohesion: 0.17
Nodes (22): artifact_identity_pairs(), artifact_version(), ArtifactRegistry, ArtifactSource, exclude_identity_pairs(), exclude_unbacked_persona_versions(), load_admitted_personas(), merge_registry() (+14 more)
...
Cohesion: 0.13
Nodes (23): CompatibilityStatus, dependency_fingerprint_allows(), ensure_schema(), LearnedArtifact, migrate_provenance_column(), nomination_name(), NominationStatus, parse_nomination() (+15 more)

### Community 15 - "ADDED Requirements"
Cohesion: 0.14
Nodes (17): bounded_json_response(), CachedToken, extract_email_address(), GmailConnector, GmailError, GmailFailureClass, GmailMessage, GmailThread (+9 more)

### Community 16 - "Requirements"
Cohesion: 0.05
Nodes (88): ArtifactStore, ArtifactStoreError, different_content_is_different_ref(), get_is_idempotent(), hex_encode(), key(), round_trips_plaintext(), Aes256Gcm (+80 more)
...
Cohesion: 0.14
Nodes (25): AntiPattern, count_bullets(), count_occurrences(), every_anti_pattern_has_a_failing_sample(), has(), probe_apology_theater(), probe_deferential_double_asking(), probe_faked_intimacy() (+17 more)
...
Cohesion: 0.15
Nodes (4): AuditKind, AuditKindError, genesis_hash(), round_trips_through_serde()
...
Cohesion: 0.07
Nodes (24): GateDenial, GateEvidence, JudgePassed, ReplayPassed, Digest, Option, Result, Store (+16 more)
...
Cohesion: 0.16
Nodes (11): batch_failure(), encrypt_digest_detail(), FailureClass, notify_immediate_failure(), record_callback_ack(), record_connector_outcome(), record_connector_outcome_or_batch(), connector_counters_record_success_and_failure() (+3 more)
...
Cohesion: 0.16
Nodes (28): artifact_propose_persists_and_sends_approval_button(), artifact_propose_rejects_duplicate_id_version(), artifact_propose_rejects_malformed_yaml(), artifact_propose_rejects_non_proposed_lifecycle(), artifact_propose_rejects_persona_kind(), artifact_propose_rejects_template_kind(), artifact_propose_rejects_unknown_kind(), route_yaml() (+20 more)
...
Cohesion: 0.15
Nodes (19): bind_consumer_conn(), ConsumerError, IdempotentConsumer, LedgerEntry, PersistedConsumerState, Connection, F, HashSet (+11 more)
...
Cohesion: 0.15
Nodes (11): append(), consumer_id_is_bound_to_filter(), failed_handler_does_not_advance_checkpoint(), filtered_replay_is_idempotent(), kind_filter_preserves_global_order(), persisted_checkpoint_survives_reload(), replay_after_watermark_skips_earlier_rows(), Option (+3 more)
...
Cohesion: 0.07
Nodes (12): PersonaElement, ArtifactId, String, lifecycle_name(), lineage_from_json(), lineage_to_json(), parse_lifecycle(), ProposedArtifact (+4 more)
...
### Community 80 - "Ok"
Cohesion: 0.16
Nodes (16): ArtifactNominatePayload, dispatch_artifact_nominate(), Option, Result, String, Value, ActionRequestBody, ActionResponseBody (+8 more)

### Community 81 - "Proposal: Define core runtime schemas"
Cohesion: 0.18
Nodes (17): gated_step_persisted_pending_recovers_without_redispatch(), a_double_tap_on_approve_creates_only_one_gmail_draft(), activate_approved_artifact_audits_failure_when_no_row(), approval_audit_never_contains_the_plaintext_draft_body(), approval_fixture_grant(), approval_fixture_request(), approve_callback_update(), gmail_with_token_mock() (+9 more)
...
Cohesion: 0.06
Nodes (58): get_task(), TaskLimitsBody, TaskViewBody, client_error(), get_briefcase(), post_topup(), authenticate(), bearer_token() (+50 more)

### Community 92 - "Agent-OS change sequence (2026-07-07, AD canon)"
Cohesion: 0.16
Nodes (9): grant(), GrantLimits, GrantMode, legacy_missing_chain_defaults_but_fails_closed(), legacy_without_thread_id_defaults_to_none(), round_trip_and_mac(), TaskGrant, thread_id_round_trips_when_populated() (+1 more)
...
Cohesion: 0.24
Nodes (11): Vec, run_case(), run_cases(), GoldenSet, GoldenSetCase, GoldenSetCaseKind, GoldenSetCaseResult, GoldenSetRunResult (+3 more)
...
Cohesion: 0.12
Nodes (23): PostApprovalFuture, PostApprovalHandler, kernel_notify_grant(), notify_owner_best_effort(), notify_owner_required_outcome(), notify_owner_with_digest(), NotifyOutcome, record_notify_skipped() (+15 more)
...
Cohesion: 0.14
Nodes (30): bind_email_identity(), email_counterparty_resolves_to_bound_identity_when_address_is_bound(), email_counterparty_stays_unresolved_when_address_is_unbound(), minimal_grant(), mint_topup_grant(), post_topup(), topup_granted_grant_mutates_briefcase_atomically(), topup_oversized_section_key_is_rejected_without_persistence() (+22 more)
...
Cohesion: 0.21
Nodes (13): ArtifactKindSpec, find_kind_spec(), is_proposable_kind(), overlay_subdir_for_kind(), parse_proposal(), rehydrate_source(), replace_keyed(), Error (+5 more)
...
Cohesion: 0.18
Nodes (25): canonical_json(), pre_egress_mac_hex(), pre_egress_root_bytes(), bindings_valid(), Caveat, caveat_bytes(), chain_structurally_valid(), ChainStep (+17 more)
...
Cohesion: 0.19
Nodes (16): bounded_excerpt(), bounded_excerpt_never_exceeds_byte_cap_at_utf8_boundary(), enrich(), golden_case_output_passes(), golden_set_digest(), remaining_runtime(), remaining_runtime_respects_short_grant_and_rejects_expiry(), Digest (+8 more)

### Community 138 - "add_column_if_missing"
Cohesion: 0.13
Nodes (14): ActionHandler, Cli, commit_post_bind_clock(), grant_hmac_key(), main(), Option, PathBuf, Result (+6 more)

### Community 139 - "Design: Backfill implemented capability specs"
Cohesion: 0.15
Nodes (12): Consequences, Consequences, D-062 — Active model swaps require symmetric DB and overlay provenance, D-081 — Upstream nomination is explicit depersonalized opt-in, Decision, Decision, Decision Index, Lyra PRD Companion — Decisions Log (+4 more)
...
Cohesion: 0.24
Nodes (8): truncate_for_telegram(), truncate_with_notice(), dispatch_lyra_preview(), guard_connector_dispatch(), PreviewPayload, dispatch_plan_preview(), ProposalError, propose_draft_creation()
...
Cohesion: 0.33
Nodes (10): HandlerFuture, handle_artifact_nominate(), handle_artifact_propose(), handle_lyra_preview(), handle_plan_propose(), handle_read_selected_thread(), handle_setup_workflow_start(), handle_status_read() (+2 more)
...
Cohesion: 0.42
Nodes (8): approve_callback(), learned_route(), nomination_owner_tap_persists_nominated_status_and_audit(), nomination_rejects_persona_kind_before_authority_path(), nomination_requires_explicit_depersonalized_assertion(), MockServer, Ulid, telegram_ok()
...
Cohesion: 0.25
Nodes (8): Change Log, Consequences, D-097 — Persona overlay loading is admission-gated, Decision, Open Decision Questions — CLOSED (see linked decisions), Rationale, Research / Reference Backlog, Would change if
...
Cohesion: 0.13
Nodes (21): ArtifactLoadError, load_base_registry(), load_registry(), load_registry_into(), load_registry_without_personas(), load_yaml_dir(), F, Path (+13 more)
...
### Community 484 - "Vec"
Cohesion: 0.83
Nodes (3): handoff_complete(), Arc, run()
...
## Knowledge Gaps
- **1958 isolated node(s):** `autoresearch.sh script`, `TelegramReplyPayload`, `ReadThreadPayload`, `ArtifactProposePayload`, `TokenResponse` (+1953 more)
...
- **Why does `digest_of_bytes()` connect `Requirements` to `Tasks: Implement digest-bound draft approval`, `Tasks: Implement Telegram owner control slice`, `Design: Authority composition`, `GmailConnector`, `MODIFIED Requirements`, `client.rs`, `check-claims.sh`, `Ok`, `Requirements`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `digest_of()` connect `Requirements` to `Tasks: Implement Telegram owner control slice`, `Design: Authority composition`, `banner`, `Ok`, `Proposal: Define core runtime schemas`, `content.d.ts`, `post_action`, `D-043 — `lyra.ui.preview` is extended (not duplicated) to propose the exact reviewed draft and attach the approval button`, `ActionId`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `test_state()` connect `Gmail selected-thread email preview setup (Phase 2)` to `D-024 — OpenSpec is the development/change-management layer, not the runtime`, `ADDED Requirements`, `config.rs`, `Lifecycle`, `client.rs`, `policy.rs`, `Proposal: Define core runtime schemas`, `action.rs`, `Requirements`, `Tasks: Implement artifact lifecycle slice`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Are the 71 inferred relationships involving `handle_owner_update()` (e.g. with `artifact_propose_persists_and_sends_approval_button()` and `artifact_propose_rejects_duplicate_id_version()`) actually correct?**
  _`handle_owner_update()` has 71 INFERRED edges - model-reasoned connections that need verification._
- **Are the 67 inferred relationships involving `owner_update()` (e.g. with `artifact_propose_persists_and_sends_approval_button()` and `artifact_propose_rejects_duplicate_id_version()`) actually correct?**
  _`owner_update()` has 67 INFERRED edges - model-reasoned connections that need verification._
- **Are the 48 inferred relationships involving `test_state_with_telegram()` (e.g. with `artifact_propose_persists_and_sends_approval_button()` and `artifact_propose_rejects_duplicate_id_version()`) actually correct?**
  _`test_state_with_telegram()` has 48 INFERRED edges - model-reasoned connections that need verification._
- **Are the 47 inferred relationships involving `test_state()` (e.g. with `artifact_propose_rejects_non_proposed_lifecycle()` and `artifact_propose_rejects_persona_kind()`) actually correct?**
  _`test_state()` has 47 INFERRED edges - model-reasoned connections that need verification._
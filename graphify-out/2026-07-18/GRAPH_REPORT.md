# Graph Report - implement-worker-supervision  (2026-07-18)

## Corpus Check
- 540 files · ~426,118 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7457 nodes · 9978 edges · 1619 communities (544 shown, 1075 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1336 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `354eb792`
...
1. `handle_owner_update()` - 98 edges
2. `owner_update()` - 85 edges
3. `test_state()` - 79 edges
4. `test_state_with_telegram()` - 69 edges
5. `AppState` - 59 edges
6. `gate()` - 54 edges
7. `StoreError` - 51 edges
8. `TaskGrant` - 44 edges
9. `ActionId` - 43 edges
...
## Communities (1619 total, 1075 thin omitted)
...
Cohesion: 0.10
Nodes (15): egress_declarations(), id(), Vec, action_id_qualifier_is_part_of_identity(), action_id_serializes_as_bare_string(), ActionCatalog, ActionEgressDeclaration, ActionId (+7 more)
...
Cohesion: 0.11
Nodes (44): handle_owner_update(), Result, draft_command_composes_email_preview_grant_whose_pending_ref_is_derived_message(), draft_command_for_a_missing_thread_mints_no_grant(), draft_command_for_a_real_thread_composes_a_bound_selection_grant(), draft_command_is_refused_without_the_unsafe_flag_under_process_driver(), draft_command_with_gmail_api_error_audits_no_event_received(), draft_command_without_gmail_configured_is_a_no_op() (+36 more)
...
Cohesion: 0.15
Nodes (28): digest_of(), artifact_propose_persists_and_sends_approval_button(), artifact_propose_rejects_duplicate_id_version(), artifact_propose_rejects_malformed_yaml(), artifact_propose_rejects_non_proposed_lifecycle(), artifact_propose_rejects_persona_kind(), artifact_propose_rejects_template_kind(), artifact_propose_rejects_unknown_kind() (+20 more)

### Community 10 - ".put"
Cohesion: 0.14
Nodes (20): consult_standing_rule_gate(), StandingRuleGateOutcome, active_rule(), allowed_pending_is_recoverable_until_consumed(), claimed_fired_pending_is_surfaced_once_not_redispatched(), deny_default_never_dispatches_and_is_terminal(), fired_allow_token_is_digest_bound_and_one_use(), fired_allow_token_rejects_different_fingerprint() (+12 more)
...
Cohesion: 0.10
Nodes (37): dispatch_task_timer_event(), test_state(), long_detail_is_bounded_in_summary_and_full_via_ref(), consumed_update_is_dropped_before_pipeline_dispatch(), different_bot_rotation_starts_fresh_namespace(), telegram_offset_reads_namespaced_consumed_offset_for_same_bot(), mediate_and_dispatch_action(), artifact_revoke_dispatch_removes_rule_from_live_consultation() (+29 more)

### Community 14 - "actions.rs"
Cohesion: 0.22
Nodes (15): bindings_valid(), Caveat, chain_structurally_valid(), ChainStep, ct_eq_hex(), effectively_allows(), effectively_allows_egress_class(), effectively_allows_output_channel() (+7 more)
...
Cohesion: 0.18
Nodes (46): AuthorityInput, AuthorityOutcome, classification_rank(), compose_authority(), mint_task_token(), narrow(), unknown_candidate(), class_identity_is_stable_across_composition_timestamps() (+38 more)
...
Cohesion: 0.13
Nodes (34): canonical_catalog(), counterparty_classification_is_kernel_owned_and_fails_closed(), handler_registry_requires_explicit_classification(), id(), test_catalog_effect_paths_are_fully_enumerated_and_classified(), worker_actions_declare_no_egress_and_no_output_channel(), classified_empty_output_channel_denial(), commission() (+26 more)
...
Cohesion: 0.14
Nodes (27): claim_conversation_in_flight(), connector_restart_cap_available(), connector_restart_count_in_window(), ensure_schema(), record_worker_failed(), release_conversation_in_flight(), release_conversation_in_flight_for_grant(), ArtifactRef (+19 more)
...
Cohesion: 0.20
Nodes (25): commissioned_grant_for_receipt(), CommissionReceipt, ensure_schema(), mark_worker_stranded_notified(), pending_worker_dispatches(), record_worker_commissioned(), record_worker_result(), ArtifactRef (+17 more)
...
Cohesion: 0.32
Nodes (15): handle_artifact_nominate(), handle_artifact_propose(), handle_artifact_revoke(), handle_lyra_preview(), handle_plan_propose(), handle_read_selected_thread(), handle_setup_workflow_start(), handle_skill_context() (+7 more)
...
Cohesion: 0.15
Nodes (22): root_pipeline_shell_does_not_report_worker_result(), build_state(), build_state_with_store(), repo_lyra_dir(), test_state_with_gmail_and_telegram(), test_state_with_store(), gated_step_persisted_pending_recovers_without_redispatch(), a_double_tap_on_approve_creates_only_one_gmail_draft() (+14 more)
...
Cohesion: 0.28
Nodes (18): RouteResolution, artifact_ref(), email_route(), exact_deny_route_wins_over_allow_route(), gmail_connector_authenticated_alone_does_not_match_the_selected_thread_route(), higher_priority_route_wins_over_lower_priority(), matches(), no_matching_route_is_denied_not_ambiguous() (+10 more)

### Community 88 - "Proposal: Backfill implemented capability specs"
Cohesion: 0.20
Nodes (23): lyra_ui_preview_sends_telegram_reply_to_grant_bound_chat(), lyra_ui_preview_truncates_long_body_to_utf16_limit(), truncated_preview_carries_no_approval_button_and_persists_no_action_request(), test_state_with_gmail(), http_consumed_causal_token_still_contextualizes_later_tokenless_denial(), http_skill_context_token_concurrent_submit_has_one_winner(), http_skill_context_token_has_causal_digest_and_strict_allowed_payload(), http_tokenless_denial_reports_bounded_contextual_notice_without_consuming() (+15 more)
...
Cohesion: 0.06
Nodes (72): PromotionDenial, SkillRow, dispatch_skill_context(), skill_context_rejects_unknown_grant_purpose(), skill_context_selects_only_grant_scoped_installed_matches(), task_class_from_grant_purpose(), CeremonyError, CeremonyToken (+64 more)
...
Cohesion: 0.11
Nodes (25): AppState, bounded_preview(), content_diff_summary(), mint_reconfirm_grant(), Arc, Digest, Duration, HashMap (+17 more)

### Community 107 - "OpenSpine"
Cohesion: 0.20
Nodes (11): PostApprovalFuture, finalize_nomination(), NominationAssertion, handle_activate_artifact(), handle_create_approved_draft(), handle_nominate_upstream(), handle_reconfirm_artifact(), handle_resolve_approved_plan() (+3 more)
...
Cohesion: 0.26
Nodes (15): ArtifactRef, Option, Self, String, Ulid, Vec, WorkerBoundParameter, WorkerCommissionSpec (+7 more)
...
Cohesion: 0.17
Nodes (19): Future, Output, Pin, Send, build_selection_token(), format_pending_message(), emit_preflight_failure(), email_build_envelope() (+11 more)

### Community 122 - "D-008 — Deterministic routing decides authority; agentic routing decides strategy"
Cohesion: 0.20
Nodes (14): owner_accepted_missing_source_is_fail_closed(), owner_accepted_route_with_no_refs_is_compatible_after_epoch_change(), owner_accepted_route_with_removed_ref_is_newly_dangling(), reconfirm_request_reuses_unchanged_and_rotates_changed_payload(), converge_owner_accepted_dependencies(), apply_compatibility(), dangling_for_parsed(), ensure_reconfirm_request() (+6 more)
...
Cohesion: 0.15
Nodes (25): artifact_ref(), checkpoint_last_acked(), checkpoint_load_error_fails_closed_without_replay(), commission_and_record(), parent_grant(), ArtifactRef, Briefcase, Option (+17 more)
...
Cohesion: 0.13
Nodes (8): atomic_grant_and_briefcase_persists_both_on_success(), atomic_grant_and_briefcase_rolls_back_on_briefcase_failure(), minimal_briefcase(), runtime_clock_observation_survives_restart_and_preserves_maximum(), runtime_timer_driver_observation_is_durable(), legacy_digest_summary_is_sanitized_idempotently(), versioned_migrations_atomicity_rollback(), versioned_migrations_up_down_up()
...
Cohesion: 0.26
Nodes (13): canonical_json(), caveat_bytes(), compute_mac_hex(), compute_tip(), hex_decode_32(), hex_encode(), hmac_sha256(), RootAuthority (+5 more)
...
Cohesion: 0.14
Nodes (20): truncate_for_telegram(), truncate_with_notice(), dispatch_plan_preview(), ProposalError, propose_draft_creation(), ActionRequestBody, ActionResponseBody, cleanup_pre_effect_reservations() (+12 more)
...
Cohesion: 0.45
Nodes (11): child_cannot_widen_parent_action(), child_cannot_widen_parent_expiry(), commission_spec(), direct_worker_egress_impossible(), mint_task_token(), mint_worker_grant(), minted_worker_has_empty_output_channels_despite_parent(), MintError (+3 more)
...
Cohesion: 0.15
Nodes (12): Consequences, Consequences, D-006 — Identity is not authority, D-089 — Reasoning-tier routing resolves the active provider per call, Decision, Decision, Decision Index, Lyra PRD Companion — Decisions Log (+4 more)
...
Cohesion: 0.06
Nodes (47): authenticate(), bearer_token(), get_status(), internal_error(), router(), Arc, ArtifactRef, Display (+39 more)
...
Cohesion: 0.29
Nodes (9): audit_action_count(), commissioned_worker_reports_and_master_relays_through_real_shell(), dispatch_state(), parent_briefcase(), parent_grant_for_commission(), Briefcase, PathBuf, String (+1 more)
...
Cohesion: 0.28
Nodes (6): Display, Error, Formatter, Result, TaskRunError, ExitStatus
...
Cohesion: 0.25
Nodes (8): Change Log, Consequences, D-114 — Tuple-addressed workers with a durable failure consumer, Decision, Open Decision Questions — CLOSED (see linked decisions), Rationale, Research / Reference Backlog, Would change if

### Community 306 - "action_catalog.rs"
Cohesion: 0.18
Nodes (13): PostApprovalHandler, handle_draft_approval_callback(), handle_plan_approval_callback(), resolve_approved_plan(), resolve_post_approval_handler(), handoff_complete(), run(), kernel_notify_grant() (+5 more)
...
### Community 371 - "Value"
Cohesion: 0.47
Nodes (4): docker_driver_args_are_correct_and_secret_free(), DockerDriver, String, Vec
...
## Knowledge Gaps
- **2216 isolated node(s):** `autoresearch.sh script`, `TelegramReplyPayload`, `ReadThreadPayload`, `ArtifactNominatePayload`, `ArtifactProposePayload` (+2211 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **1075 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `AppState` connect `openspine-decision-log.md` to `lib.rs`, `D-005 — Private-data shell must be contained`, `event.rs`, `sandbox.rs`, `.default`, `Design: Authority composition`, `config.rs`, `Requirements`, `create_approved_draft`, `properties`, `Design: Digest-bound draft approval`, `check-file-sizes.sh`, `content.d.ts`, `ADDED Requirements`, `Tasks: Implement artifact lifecycle slice`, `Requirements`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `handle_owner_update()` connect `config.rs` to `decisions.md`, `Tasks: Implement digest-bound draft approval`, `banner`, `openspine-decision-log.md`, `telegram.rs`, `Error`, `client.rs`, `properties`, `policy.rs`, `Proposal: Define core runtime schemas`, `action_catalog.rs`, `action.rs`, `Lifecycle`, `ADDED Requirements`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `digest_of()` connect `telegram.rs` to `D-005 — Private-data shell must be contained`, `sandbox.rs`, `artifact_loader.rs`, `client.rs`, `Reflection & product surface`, `Requirements`, `Proposal: Define core runtime schemas`, `content.d.ts`, `ADDED Requirements`, `ApprovalRecord`, `ActionId`, `D-047 — Task tokens are hashed at rest; expired grants are swept`, `OpenSpine Agent-OS Design Log`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Are the 89 inferred relationships involving `handle_owner_update()` (e.g. with `handle_draft_approval_callback()` and `email_preview_lane()`) actually correct?**
  _`handle_owner_update()` has 89 INFERRED edges - model-reasoned connections that need verification._
- **Are the 84 inferred relationships involving `owner_update()` (e.g. with `root_pipeline_shell_does_not_report_worker_result()` and `draft_command_composes_email_preview_grant_whose_pending_ref_is_derived_message()`) actually correct?**
  _`owner_update()` has 84 INFERRED edges - model-reasoned connections that need verification._
- **Are the 77 inferred relationships involving `test_state()` (e.g. with `email_counterparty_resolves_to_bound_identity_when_address_is_bound()` and `email_counterparty_stays_unresolved_when_address_is_unbound()`) actually correct?**
  _`test_state()` has 77 INFERRED edges - model-reasoned connections that need verification._
- **Are the 67 inferred relationships involving `test_state_with_telegram()` (e.g. with `checkpoint_load_error_fails_closed_without_replay()` and `worker_result_consumer_relays_through_parent_gated_reply()`) actually correct?**
  _`test_state_with_telegram()` has 67 INFERRED edges - model-reasoned connections that need verification._
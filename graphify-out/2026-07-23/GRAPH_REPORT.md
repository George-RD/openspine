# Graph Report - implement-overlay-export-restore  (2026-07-23)

## Corpus Check
- 618 files · ~495,521 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8746 nodes · 13400 edges · 1682 communities (604 shown, 1078 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1727 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f0af8436`
...
1. `test_state()` - 109 edges
2. `handle_owner_update()` - 100 edges
3. `AppState` - 98 edges
4. `owner_update()` - 88 edges
5. `test_state_with_telegram()` - 80 edges
6. `TaskGrant` - 68 edges
7. `ControlError` - 65 edges
8. `digest_of_bytes()` - 65 edges
9. `BundleError` - 59 edges
10. `ActionId` - 59 edges
...
## Import Cycles
- 1-file cycle: `crates/openspine-kernel/src/overlay_export_restore/control/fs.rs -> crates/openspine-kernel/src/overlay_export_restore/control/fs.rs`
...
## Communities (1682 total, 1078 thin omitted)

### Community 0 - "README.md"
Cohesion: 0.08
Nodes (25): P, ensure_schema(), filter_within_scope(), class_digest(), Store, storage(), Store, AdvisorObjection (+17 more)
...
Cohesion: 0.17
Nodes (22): OverlayControl, Option, Result, Vec, ControlError, String, check_continuity_alignment(), ensure_data_root_dir() (+14 more)
...
### Community 4 - ".default"
Cohesion: 0.09
Nodes (34): approval_required_is_ok_not_err(), counterparty_denial_preserves_only_canonical_deferral(), deny_decision_is_ok_not_err(), generate_sends_bearer_auth(), generate_sends_untrusted_context_in_body(), get_task_deserializes_selection_tokens(), get_task_sends_bearer_auth(), submit_action_sends_bearer_auth() (+26 more)

### Community 5 - "GmailConnector"
Cohesion: 0.29
Nodes (19): dependency_fingerprint(), accepted_digest_tamper_invalidates(), base_namespace_is_not_treated_as_learned(), dangling_learned_route_is_orphaned_and_excluded(), erased(), exclude_erased_covers_registered_kinds_and_exact_version_model_swaps(), insert_agent(), insert_pack() (+11 more)
...
Cohesion: 0.10
Nodes (39): test_state(), dispatch_task_timer_event(), mediate_and_dispatch_action(), bind_email_identity(), email_counterparty_resolves_to_bound_identity_when_address_is_bound(), email_counterparty_stays_unresolved_when_address_is_unbound(), minimal_grant(), mint_topup_grant() (+31 more)

### Community 8 - "mod.rs"
Cohesion: 0.27
Nodes (16): email_build_envelope(), email_grant_binding(), email_route_guard(), EventInputs, owner_build_envelope(), owner_grant_binding(), owner_route_guard(), ArtifactRef (+8 more)

### Community 9 - "telegram.rs"
Cohesion: 0.08
Nodes (33): AtomicUsize, CounterpartyKeyError, CounterpartyKeyRing, CounterpartyKeyRing, Option, Path, Result, Ulid (+25 more)
...
Cohesion: 0.06
Nodes (45): canonical_json(), digest_matches_hash(), genesis_digest(), Briefcase, adding_thread_binding_without_resealing_invalidates_mac(), caveat_reorder_or_remove_invalidates_mac(), child_derives_from_parent_tip_without_root_key(), effective_egress_class_intersects_every_caveat() (+37 more)
...
Cohesion: 0.13
Nodes (14): ConversationClaimGuard, ConversationClaimGuard<'a>, Drop, Result, Self, Store, Ulid, identity_addressing_serializes_one_message_per_conversation() (+6 more)
...
Cohesion: 0.05
Nodes (70): append_overlay_finalization_audits(), bind_clock_and_finalize_overlay(), bind_kernel_listener(), build_provider_pool(), Cli, commit_post_bind_clock(), finalize_overlay_after_bind(), grant_hmac_key() (+62 more)
...
Cohesion: 0.27
Nodes (10): artifact_ref(), briefcase(), commission(), key(), restart_caps_hold_under_flaky_connector(), ArtifactRef, Result, Store (+2 more)

### Community 30 - "ArtifactRef"
Cohesion: 0.18
Nodes (33): cleanup_install(), continuity_path(), exists(), inspect_install(), install_or_recover(), InstallState, io(), load_continuity() (+25 more)

### Community 31 - "ADDED Requirements"
Cohesion: 0.18
Nodes (3): connector_failure_batches_and_is_audited(), counter_persistence_failure_is_durably_batched_as_resource(), immediate_failure_cannot_enter_digest_lane()

### Community 32 - "Requirements"
Cohesion: 0.11
Nodes (12): action_request_consume_is_single_use(), action_request_round_trips_by_id(), approval_round_trips_by_action_request_id(), find_task_grant_by_token_rejects_the_raw_hash_value(), most_recent_approval_wins_when_multiple_exist_for_one_request(), opening_a_pre_existing_db_without_the_used_column_is_migrated_in_place(), persisted_grant_json_contains_no_task_token(), sample_action_request() (+4 more)
...
Cohesion: 0.11
Nodes (26): aead_associated_data_scope_tamper_fails_decrypt(), clear_upgrade_pending_sync_failure_retains_marker_for_retry(), concurrent_marker_recovery_and_missing_marker_clear_are_idempotent(), existing_blob_retry_durability_resyncs(), format2_post_rename_sync_failure_recovers_once_without_syncing_steady_state_reads(), format2_recovered_blob_reads_and_migrates_to_format3(), put_scoped_after_erase_rejects_forever(), bit_flipped_ciphertext_fails_aead() (+18 more)
...
Cohesion: 0.15
Nodes (37): CounterpartyEraseError, erase_counterparty(), ErasureReport, finish_local_erasure(), cleanup_retry_returns_terminal_identities_with_zero_new_changes(), erasing_keyless_scope_twice_audits_once_and_keeps_chain_valid(), erasure_report_contains_exact_invalidated_identities_and_d012_target_refs(), identical_plaintext_erasure_only_flags_the_producing_counterparty() (+29 more)

### Community 44 - "ADDED Requirements"
Cohesion: 0.22
Nodes (26): apply_terminal_erasure_delta(), BundleError, copy_from_open(), enumerate_data_root(), hash_open(), open_dir_nofollow(), open_parent_fd(), openat_file() (+18 more)

### Community 45 - "digest.rs"
Cohesion: 0.21
Nodes (25): active_v2_survives_stale_approved_v1_recovery(), approved_dangling_recovery_quarantines_and_requests_reconfirm(), commit_before_publish_crash_republishes_exact_active_ref(), fixture(), insert_active_proposal(), insert_approved_proposal(), insert_proposal(), learned_row() (+17 more)

### Community 46 - "Digest"
Cohesion: 0.24
Nodes (25): atomic_rename_noreplace(), Cleanup, create_dir(), create_temp_dir(), ensure_absent(), io_err(), is_eloop(), mutation_or_io() (+17 more)

### Community 48 - "ADDED Requirements"
Cohesion: 0.27
Nodes (26): publish_bundle(), apply_terminal_erasure_delta_removes_key_and_pending_alias(), continuity_id_is_hmac_bound_and_validated(), fixed_permissions_are_applied(), invalid_manifest_hmac_is_rejected(), key(), ledger(), master_key_bytes_are_not_written_into_bundle() (+18 more)
...
Cohesion: 0.28
Nodes (17): handle_worker_commission(), handle_worker_failed(), handle_worker_report_result(), ArtifactRef, HandlerFuture, Option, String, Value (+9 more)

### Community 53 - "Requirements"
Cohesion: 0.11
Nodes (27): cmd_freeform(), cmd_overlay_bundle(), cmd_propose(), cmd_setup(), cmd_status(), Option, Result, String (+19 more)
...
Cohesion: 0.08
Nodes (62): production_composed_owner_shell_grant_stages_with_other_actions(), handle_owner_update(), Result, owner_update(), seed_owner_history(), digest_of(), draft_command_composes_email_preview_grant_whose_pending_ref_is_derived_message(), draft_command_for_a_missing_thread_mints_no_grant() (+54 more)
...
Cohesion: 0.09
Nodes (67): artifact_ref(), email_event(), email_reply_drafter_agent(), email_route(), empty_session_policy(), global_policy(), main_assistant_agent(), owner_control_basic_pack() (+59 more)
...
Cohesion: 0.18
Nodes (26): empty_session_policy(), counterparty_cannot_select_owner_route_persona(), owner_bound_number_selects_route_persona(), persona(), resolve_persona(), route(), route_context_mismatch_cannot_front_persona(), artifact_ref() (+18 more)

### Community 74 - ".put"
Cohesion: 0.22
Nodes (16): all_slice_categories_are_owner_scoped(), anchored_slice_includes_not_yet_due_focal_task_and_honors_limit_one(), insert_task_rejects_prepopulated_timer_ids(), master_slice_is_bounded_and_excludes_task_detail(), master_slice_is_owner_scoped(), ref_of(), schedule_rolls_back_after_timer_insert_failure(), scheduling_rejects_mismatched_or_terminal_task() (+8 more)
...
Cohesion: 0.25
Nodes (21): BundleNamePayload, foreign_principal_is_rejected(), handle_overlay_export(), handle_overlay_restore(), invoked_action_must_match_handler(), malformed_and_unknown_payload_fields_fail(), mint_grant(), non_root_parent_or_chain_is_rejected() (+13 more)
...
Cohesion: 0.15
Nodes (34): test_state_with_gmail(), lyra_ui_preview_sends_telegram_reply_to_grant_bound_chat(), lyra_ui_preview_truncates_long_body_to_utf16_limit(), truncated_preview_carries_no_approval_button_and_persists_no_action_request(), email_read_selected_thread_rejects_expired_token(), email_read_selected_thread_rejects_foreign_grant(), email_read_selected_thread_rejects_malformed_payload(), email_read_selected_thread_rejects_second_use() (+26 more)
...
Cohesion: 0.22
Nodes (16): bundle_name_validation_and_path_derivation(), control_and_state_files_use_restrictive_modes(), enforces_one_pending_operation_and_transitions(), forge_mac(), forged_marker_and_ledger_are_rejected(), grant(), interrupted_update_recovers_last_complete_state(), merges_bundle_baseline_and_rejects_missing_or_regressed_continuity() (+8 more)

### Community 91 - "Tasks: Implement artifact lifecycle slice"
Cohesion: 0.09
Nodes (37): deny_limit_exceeded(), GenerateRequestBody, GenerateResponseBody, post_model_generate(), template_id_for_agent(), a_spoofed_closing_marker_in_the_content_does_not_escape_the_boundary(), build_prompt(), build_prompt_carries_system_preamble_and_conversation_through() (+29 more)

### Community 92 - "Agent-OS change sequence (2026-07-07, AD canon)"
Cohesion: 0.12
Nodes (19): acquire(), digest_hex(), OperationView, OverlayOperations, pending_from(), Option, Path, Result (+11 more)
...
Cohesion: 0.23
Nodes (6): sample_skill(), Skill, skill_round_trips_through_json(), skill_wire_shape_rejects_authority_fields(), SkillProvenance, SkillVisibility
...
Cohesion: 0.06
Nodes (75): recent_promotion_decisions_for_test(), Store, String, Vec, PromotionDenial, SkillRow, dispatch_skill_context(), skill_context_rejects_unknown_grant_purpose() (+67 more)
...
Cohesion: 0.19
Nodes (18): BundleRequestMetadata, BundleManifest, decode_hex_32(), hex(), hex_nibble(), ManifestBody, read_manifest(), Option (+10 more)
...
Cohesion: 0.17
Nodes (28): persona_overlay_dir(), repair_persona_file(), ArtifactRef, ArtifactStore, Digest, Path, PathBuf, PersonaElement (+20 more)

### Community 107 - "OpenSpine"
Cohesion: 0.10
Nodes (25): CounterpartyKeyRing, ArtifactStore, ArtifactStoreError, fsync_dir(), hex_encode(), ArtifactStore, ArtifactRef, E (+17 more)
...
Cohesion: 0.19
Nodes (26): fresh_host_restore_rejects_without_continuity(), invalid_bundle_causes_no_mutation(), invalid_hmac_bundle_causes_no_mutation(), merged_ledger_hardening_applies_all_merged_ids(), copy_dir(), export_retry_is_idempotent_across_restart(), finalize_ok(), grant() (+18 more)

### Community 112 - "Design: Gate action API"
Cohesion: 0.23
Nodes (19): BundleEntry, Metadata, same_state(), copy_entries(), copy_from_open(), enum_dir_fd(), enumerate_data_root(), hash_open() (+11 more)
...
Cohesion: 0.18
Nodes (13): load_base_registry(), load_registry(), parse_proposal(), canonical_catalog_covers_all_fixture_action_ids(), generic_overlay_loader_excludes_persona_and_base_loader_rejects_fixture(), kind_table_excludes_personas(), kind_table_excludes_templates(), kind_table_round_trips_all_seven_kinds() (+5 more)
...
Cohesion: 0.14
Nodes (27): content_diff_summary(), artifact_ref(), checkpoint_last_acked(), checkpoint_load_error_fails_closed_without_replay(), commission_and_record(), parent_grant(), ArtifactRef, Briefcase (+19 more)
...
Cohesion: 0.19
Nodes (22): handle_artifact_nominate(), handle_artifact_propose(), handle_artifact_revoke(), handle_lyra_preview(), handle_plan_propose(), handle_read_selected_thread(), handle_setup_workflow_start(), handle_skill_context() (+14 more)
...
Cohesion: 0.14
Nodes (21): SkillAttribution, truncate_for_telegram(), truncate_with_notice(), ActionRequestBody, ActionResponseBody, cleanup_pre_effect_reservations(), dispatch_lyra_preview(), dispatch_read_selected_thread() (+13 more)
...
Cohesion: 0.30
Nodes (16): child_cannot_widen_parent_action(), child_cannot_widen_parent_expiry(), commission_spec(), direct_worker_egress_impossible(), mint_task_token(), mint_worker_grant(), minted_worker_has_empty_output_channels_despite_parent(), MintError (+8 more)
...
Cohesion: 0.10
Nodes (25): PostApprovalFuture, PostApprovalHandler, emit_preflight_failure(), reinstate_artifact(), finalize_nomination(), NominationAssertion, handle_draft_approval_callback(), kernel_notify_grant() (+17 more)
...
Cohesion: 0.15
Nodes (26): gate(), bound_parameter_allows_when_request_matches(), bound_parameter_conflict_is_caveat_widening(), bound_parameter_denies_when_request_mismatched(), bound_parameter_denies_when_request_missing(), explicit_shell_deny_precedes_uncovered_egress_class(), kernel_origin_cannot_bypass_rated_egress_class(), KernelTrustedRated (+18 more)

### Community 179 - "D-019 — Implement minimal slice first, not full agent OS"
Cohesion: 0.10
Nodes (14): dependency_wake_requires_all_dependencies_and_unblocks_task(), ref_of(), provenance_round_trips_with_tag(), ref_of(), slice_round_trips_and_rejects_unknown_fields(), Task, task_rejects_plaintext_title_and_provenance_references(), task_rejects_unsupported_schema_version() (+6 more)

### Community 180 - "why-openspine.md"
Cohesion: 0.24
Nodes (12): BuildEnvelopeFn, LaneSpec, scheduled_internal_lane(), GrantBindingFn, PreflightFn, RouteGuardFn, complete_task_and_wake(), dispatch_task_wake() (+4 more)

### Community 181 - "Q: Trace the full runtime call path for a single incoming Telegram message from an authorized owner, all the way through to a TaskGrant being persisted in the kernel's SQLite store. List the modules/files involved, in call order, and identify the 2-3 modules that are most structurally central to this flow."
Cohesion: 0.24
Nodes (25): cleanup_temp_at(), is_allowed_platform_redirect(), o_cloexec(), o_creat(), o_directory(), o_nofollow(), open_dir_nofollow(), open_or_create_control_dir_relative() (+17 more)
...
Cohesion: 0.36
Nodes (13): email_preflight(), owner_preflight(), PreflightFailure, PreflightSnapshot, Box, Future, Option, Output (+5 more)

### Community 185 - "Implementation notes"
Cohesion: 0.17
Nodes (11): Option, Ulid, Vec, Store, round_trips_through_serde(), sample_token(), SelectionScope, SelectionToken (+3 more)
...
Cohesion: 0.27
Nodes (10): ensure_schema(), is_unique_constraint_violation(), persist_promotion_decision_conn(), Connection, Digest, Error, Result, Transaction (+2 more)
...
Cohesion: 0.33
Nodes (8): long_detail_is_bounded_in_summary_and_full_via_ref(), batch_failure(), encrypt_digest_detail(), FailureClass, notify_immediate_failure(), record_callback_ack(), record_connector_outcome(), record_connector_outcome_or_batch()
...
Cohesion: 0.16
Nodes (32): classified_empty_output_channel_denial(), commission(), commission_is_receipt_idempotent(), commission_receipt_binding_rejects_different_parent_or_request(), commissioning_persists_briefcase_without_board_row(), gate_request(), minimal_briefcase(), narrowed_gate_worker() (+24 more)
...
Cohesion: 0.11
Nodes (15): BundleName, valid_transition(), OverlayControl, File, Mutex, Option, Path, PathBuf (+7 more)
...
Cohesion: 0.15
Nodes (12): Consequences, Consequences, D-089 — Reasoning-tier routing resolves the active provider per call, D-108 — Commissioned workers must be effectively able to report, Decision, Decision, Decision Index, Lyra PRD Companion — Decisions Log (+4 more)

### Community 284 - "Proposal: Refactor kernel registries"
Cohesion: 0.17
Nodes (15): post_webhook(), Arc, HeaderMap, Json, Option, Path, Result, State (+7 more)

### Community 285 - "Approach"
Cohesion: 0.44
Nodes (9): apply_terminal_erasure_delta(), expected_entries_after_delta(), normalize_erased_ids(), remove_if_present(), Path, Result, String, Vec (+1 more)
...
Cohesion: 0.33
Nodes (10): dispatch_artifact_nominate(), Option, Result, Value, approve_callback(), learned_route(), nomination_owner_tap_persists_nominated_status_and_audit(), nomination_rejects_persona_kind_before_authority_path() (+2 more)
...
### Community 318 - "Vec"
Cohesion: 0.10
Nodes (32): AppState, bounded_preview(), mint_reconfirm_grant(), Arc, ArtifactStore, Digest, Duration, HashMap (+24 more)
...
### Community 331 - "State"
Cohesion: 0.42
Nodes (10): key(), ledger(), publish_bundle_serializes_and_authenticates_full_request_metadata(), request(), PathBuf, TempDir, Vec, snapshot_layout() (+2 more)

### Community 332 - "StatusCode"
Cohesion: 0.08
Nodes (21): canonical_catalog(), counterparty_classification_is_kernel_owned_and_fails_closed(), handler_registry_requires_explicit_classification(), id(), overlay_export_restore_are_non_delegable_with_no_egress(), test_catalog_effect_paths_are_fully_enumerated_and_classified(), worker_actions_declare_no_egress_and_no_output_channel(), ArtifactNominatePayload (+13 more)

### Community 333 - "String"
Cohesion: 0.12
Nodes (11): Error, PathBuf, Ok, RequestError, CanonicalValue, CanonicalValue<'a>, HasherWriter<'a>, candidate_error_is_invalid_token() (+3 more)
...
### Community 365 - "Json"
Cohesion: 0.29
Nodes (3): PersistedConsumerState, Store, WorkerRelayClaim
...
Cohesion: 0.28
Nodes (7): find_kind_spec(), is_proposable_kind(), overlay_subdir_for_kind(), replace_keyed(), HashMap, Option, T

### Community 421 - "ArtifactId"
Cohesion: 0.18
Nodes (16): briefcase(), get_task(), get_task_emits_empty_output_channels_for_worker_grant(), TaskLimitsBody, TaskViewBody, worker_grant(), record_worker_commissioned(), record_worker_failed() (+8 more)

### Community 422 - "CapabilityPack"
Cohesion: 0.25
Nodes (8): Change Log, Consequences, D-122 — Restart-bound overlay snapshots with external erasure continuity, Decision, Open Decision Questions — CLOSED (see linked decisions), Rationale, Research / Reference Backlog, Would change if
...
### Community 451 - "Error"
Cohesion: 0.25
Nodes (14): ArtifactKindSpec, ArtifactLoadError, load_admitted_personas(), load_registry_into(), load_registry_without_personas(), load_yaml_dir(), Error, F (+6 more)
...
Cohesion: 0.33
Nodes (5): Deviations, Discovered edge cases, Implementation Notes — implement-overlay-export-restore, Questions for review, Session summary
...
Cohesion: 0.10
Nodes (22): egress_declarations(), id(), Vec, ActionCatalog, ActionEgressDeclaration, ActionId, EffectPath, Display (+14 more)
...
### Community 595 - "Ulid"
Cohesion: 0.39
Nodes (5): commissioned_worker_reports_and_master_relays_through_real_shell(), parent_briefcase(), parent_grant_for_commission(), root_pipeline_shell_does_not_report_worker_result(), worker_shell_binary()
...
Cohesion: 0.81
Nodes (6): atomic_write(), cleanup_temp(), remove_durable(), Path, Result, sync_dir()
...
### Community 790 - "worker_failed_consumer.rs"
Cohesion: 0.67
...
Cohesion: 0.17
Nodes (22): artifact_identity_pairs(), artifact_version(), ArtifactRegistry, ArtifactSource, exclude_identity_pairs(), exclude_unbacked_persona_versions(), merge_registry(), overlay_filename() (+14 more)

### Community 888 - "Result"
Cohesion: 0.60
Nodes (3): PendingScheduleCtx, consult_standing_rule_gate(), StandingRuleGateOutcome

## Knowledge Gaps
- **2429 isolated node(s):** `autoresearch.sh script`, `TelegramReplyPayload`, `ReadThreadPayload`, `ArtifactProposePayload`, `ReadThreadPayload` (+2424 more)
...
- **Why does `AppState` connect `Vec` to `D-005 — Private-data shell must be contained`, `handle_owner_update`, `D-022 — Agent-owned inbox is distinct from owner mailbox access`, `.default`, `artifact_loader.rs`, `config.rs`, `mod.rs`, `add_column_if_missing`, `ProposedArtifact`, `client.rs`, `ApprovalRecord`, `Option`, `Proposal: Refactor kernel registries`, `D-027 — Multi-provider model gateway with per-provider auth mode`, `Requirements`, `Approach`, `ADDED Requirements`, `Change quiz`, `ConnectorRegistry`, `StatusCode`, `properties`, `GmailConnector`, `Result`, `Proposal: Backfill implemented capability specs`, `Tasks: Implement artifact lifecycle slice`, `Tasks: Implement digest-bound draft approval`, `Design: Harden approval and budgets`, `D-001 — Lyra is a runtime/substrate, not a single agent`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `digest_of_bytes()` connect `Failure surfacing & operations` to `handle_owner_update`, `.default`, `GmailConnector`, `standing_rule_timer.rs`, `.put`, `content.d.ts`, `D-045 — WYSIWYS: a truncated preview refuses an approval button rather than splitting the message`, `D-027 — Multi-provider model gateway with per-provider auth mode`, `ADDED Requirements`, `D-028 — Canonical artifact format is YAML+serde; digests are `sha256:` over canonical JSON`, `digest.rs`, `Approach`, `ConnectorRegistry`, `README.md`, `Proposal: Implement selected-thread email preview slice`, `AuditEvent`, `openspine-decision-log.md`, `OpenSpine`, `HeaderMap`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `test_state()` connect `config.rs` to `Tasks: Define OpenSpine development process`, `ConnectorRegistry`, `D-027 — Multi-provider model gateway with per-provider auth mode`, `standing_rule_timer.rs`, `Ulid`, `ProposedArtifact`, `client.rs`, `properties`, `content.d.ts`, `Proposal: Define core runtime schemas`, `action.rs`, `Proposal: Backfill implemented capability specs`, `SKILL.md`, `Lifecycle`, `Reference hunt`, `Vec`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Are the 106 inferred relationships involving `test_state()` (e.g. with `foreign_principal_is_rejected()` and `invoked_action_must_match_handler()`) actually correct?**
  _`test_state()` has 106 INFERRED edges - model-reasoned connections that need verification._
- **Are the 91 inferred relationships involving `handle_owner_update()` (e.g. with `production_composed_owner_shell_grant_stages_with_other_actions()` and `email_preview_lane()`) actually correct?**
  _`handle_owner_update()` has 91 INFERRED edges - model-reasoned connections that need verification._
- **Are the 86 inferred relationships involving `owner_update()` (e.g. with `production_composed_owner_shell_grant_stages_with_other_actions()` and `draft_command_composes_email_preview_grant_whose_pending_ref_is_derived_message()`) actually correct?**
  _`owner_update()` has 86 INFERRED edges - model-reasoned connections that need verification._
- **Are the 76 inferred relationships involving `test_state_with_telegram()` (e.g. with `checkpoint_load_error_fails_closed_without_replay()` and `worker_result_consumer_relays_through_parent_gated_reply()`) actually correct?**
  _`test_state_with_telegram()` has 76 INFERRED edges - model-reasoned connections that need verification._
...
| Responsibility receipt | `api/actions.rs:699-752` scoped effective-Allow response/effect assembly | `scoped_allow_returns_responsibility_receipt` via kernel action API |

# Spec: Audit and artifact store

## Purpose

Give every effectful decision a tamper-evident audit trail, and store
every private payload as an encrypted, content-addressed blob referenced
only by digest — never as plaintext in logs, audit rows, or the wire
(D-012, D-025, D-028).
